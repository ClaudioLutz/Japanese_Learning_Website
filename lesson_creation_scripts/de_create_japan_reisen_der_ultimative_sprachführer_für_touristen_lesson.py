...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Japan Reisen: Der ultimative Sprachführer für Touristen\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Japan Reisen: Der ultimative Sprachführer für Touristen"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Mach dich bereit für dein Japan-Abenteuer! Diese Lektion vermittelt dir die wichtigsten Sätze und Vokabeln für Flughafen, Hotel, Sightseeing und mehr, damit du dich sicher und höflich verständigen kannst."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Ankunft am Flughafen (Kūkō de no tōchaku - 空港での到着)",
        "keywords": "Flughafen, 空港, Ankunft, 到着, Passkontrolle, 入国審査, Gepäck, 荷物, Zoll, 税関, Bahnhof, 駅, Bus, バス, Limousine Bus, リムジンバス",
        "image_concept": "Ein touristischer Charakter im niedlichen Anime-Stil mit Rucksack und Koffer steht in einer hellen, sauberen und modernen Flughafen-Ankunftshalle. Der Charakter schaut sich neugierig und voller Vorfreude um. Im Hintergrund sind durch große Fenster die Silhouetten von Flugzeugen zu sehen. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In dieser Lektion lernen die Studierenden, wie sie sich nach der Ankunft in Japan am Flughafen zurechtfinden. Dies umfasst wichtige Sätze für die Einreisekontrolle, die Gepäckabholung und den Kauf von Tickets für den Weitertransport in die Stadt."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Check-in im Hotel (Hoteru de no chekku-in - ホテルでのチェックイン)",
        "keywords": "Hotel, ホテル, Ryokan, 旅館, Rezeption, 受付, Check-in, チェックイン, Reservierung, 予約, Schlüssel, 鍵, Zimmer, 部屋, Frühstück, 朝食, Wi-Fi, ワイファイ",
        "image_concept": "Ein freundlicher Hotelangestellter im Manga-Stil in einer schicken Uniform verbeugt sich leicht vor einem glücklichen Touristen-Charakter über einen sauberen Rezeptionstresen. Der Tourist hält einen Reisepass in der Hand. Die Lobby im Hintergrund ist minimalistisch und elegant. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen, wie man in einem Hotel oder einem traditionellen Ryokan eincheckt. Sie üben, eine Reservierung zu bestätigen, nach dem WLAN-Passwort zu fragen und Informationen über das Frühstück und die Zimmerausstattung zu erhalten."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Unterwegs: Transportmittel (Kōtsū-kikan - 交通機関)",
        "keywords": "Bahnhof, 駅, Zug, 電車, U-Bahn, 地下鉄, Shinkansen, 新幹線, Ticket, 切符, Fahrkartenschalter, みどりの窓口, Bahnsteig, ホーム, Nächster Halt, 次の駅",
        "image_concept": "Zwei junge Anime-Touristen, ein Junge und ein Mädchen, betrachten eine große, stilisierte und bunte (aber unleserliche) Streckenkarte in einem hellen, futuristischen Bahnhof. Im Hintergrund ist ein eleganter Shinkansen-Schnellzug durch ein Fenster zu sehen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf die Nutzung öffentlicher Verkehrsmittel. Die Studierenden lernen, wie man Fahrkarten für Züge und Busse kauft, den richtigen Bahnsteig findet und nach dem Weg zum gewünschten Ziel fragt."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Sightseeing und Attraktionen (Kankō - 観光)",
        "keywords": "Sightseeing, 観光, Tempel, お寺, Schrein, 神社, Eintrittskarte, 入場券, Foto, 写真, Geöffnet, 開いています, Geschlossen, 閉まっています, Broschüre, パンフレット",
        "image_concept": "Ein Anime-Tourist mit einer Kamera um den Hals blickt ehrfürchtig zu einem wunderschönen, stilisierten japanischen Tempel mit einer Pagode auf. Sanft fallende Kirschblütenblätter umgeben die Szene. Die Atmosphäre ist friedlich und respektvoll. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen nützliche Sätze für den Besuch von Sehenswürdigkeiten. Dies beinhaltet das Fragen nach Öffnungszeiten, Eintrittspreisen und ob das Fotografieren erlaubt ist, sowie das Bitten um eine Karte oder Broschüre."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Essen gehen im Restaurant (Resutoran de - レストランで)",
        "keywords": "Restaurant, レストラン, Izakaya, 居酒屋, Speisekarte, メニュー, Bestellen, 注文する, Empfehlung, おすすめ, Rechnung, お会計, Lecker, おいしい, Prost, 乾杯",
        "image_concept": "Eine Gruppe fröhlicher Anime-Charaktere sitzt an einem niedrigen Tisch in einem gemütlichen, traditionellen Izakaya. Sie erheben ihre Gläser zu einem Toast (Kanpai). Auf dem Tisch stehen verschiedene stilisierte, köstlich aussehende japanische Gerichte. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernen die Studierenden alles Notwendige für einen Restaurantbesuch: einen Tisch reservieren, die Speisekarte anfordern, Essen und Getränke bestellen, nach der Empfehlung des Hauses fragen und um die Rechnung bitten."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Einkaufen und Souvenirs (Kaimono - 買い物)",
        "keywords": "Einkaufen, 買い物, Geschäft, 店, Souvenir, お土産, Wie viel kostet das?, いくらですか, Steuerfrei, 免税, Tüte, 袋, Kreditkarte, クレジットカード, Quittung, レシート",
        "image_concept": "Ein Anime-Charakter steht in einem bunten Geschäft und hält lächelnd eine niedliche Maneki-neko (Winkekatze) in den Händen. Die Regale im Hintergrund sind mit farbenfrohen, aber undeutlichen japanischen Souvenirs gefüllt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Lektion behandelt das Thema Einkaufen. Die Studierenden üben, nach Preisen zu fragen, sich über steuerfreies Einkaufen zu informieren, nach einer Tüte zu fragen und mit Kreditkarte oder Bargeld zu bezahlen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Höflichkeit und um Hilfe bitten (Onegai & Sumimasen - お願い & すみません)",
        "keywords": "Entschuldigung, すみません, Bitte, お願いします, Danke, ありがとうございます, Ich verstehe nicht, わかりません, Hilfe, 助けて, Wo ist...?, 〜はどこですか, Toilette, トイレ",
        "image_concept": "Ein etwas verloren aussehender Anime-Tourist verbeugt sich höflich und fragt einen freundlich lächelnden japanischen Polizisten nach dem Weg. Der Polizist zeigt hilfsbereit eine Richtung entlang einer stilisierten, sauberen Stadtstraße. Die Stimmung ist hilfsbereit und beruhigend. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese abschließende Seite fasst die wichtigsten Höflichkeitsfloskeln zusammen. Die Studierenden lernen die vielfältigen Anwendungsmöglichkeiten von \"Sumimasen\" (Entschuldigung/Aufmerksamkeit erregen) und wie man höflich um Hilfe bittet, wenn man sich verlaufen hat oder etwas nicht versteht."
    }
]
