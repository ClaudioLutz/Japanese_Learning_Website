...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Fortgeschrittene Japanische Grammatik: Kausativ, Passiv und Konditionalformen meistern\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Fortgeschrittene Japanische Grammatik: Kausativ, Passiv und Konditionalformen meistern"
LESSON_DIFFICULTY = "Fortgeschritten"
LESSON_DESCRIPTION = "Vertiefe dein Verständnis der japanischen Sprache, indem du komplexe Satzstrukturen wie die Passiv-, Kausativ- und diverse Konditionalformen lernst. Diese Lektion befähigt dich, nuancierte und anspruchsvolle Gedanken präzise auszudrücken und die japanische Kommunikation auf einem höheren Niveau zu meistern."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Einführung: Komplexe Strukturen verstehen (Joron - 序論)",
        "keywords": "Grammatikübersicht, Satzstruktur, Partikel, Verbkonjugation, Wiederholung, N-Niveau, 文法 (bunpō), 復習 (fukushū)",
        "image_concept": "Eine freundliche japanische Lehrerin im Anime-Stil steht neben einer leeren Tafel. Sie hält einen Zeigestab und lächelt ermutigend in die Kamera, bereit, die Lektion zu beginnen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite bietet eine kurze Wiederholung grundlegender Verbkonjugationen, die für das Verständnis der fortgeschrittenen Grammatikpunkte notwendig sind. Sie stellt die drei Hauptthemen der Lektion vor: Passiv (Ukemi), Kausativ (Shieki) und Konditionalformen (Jōkenkei), und erklärt deren Bedeutung für eine differenzierte Ausdrucksweise."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die Passivform: Betroffenheit und Höflichkeit (Ukemi - 受け身)",
        "keywords": "Passiv, Ukemi, 受け身, Verbkonjugation, leiden, betroffen sein, Höflichkeit, Keigo, 敬語, られる (rareru), される (sareru)",
        "image_concept": "Ein niedlicher Anime-Charakter wird von einem plötzlichen Regenschauer überrascht und sieht betrübt aus. Ein anderer Charakter kommt und hält schützend einen Regenschirm über ihn. Die Szene verdeutlicht, wie man von einer äußeren Handlung betroffen ist. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne, die Passivform für alle Verbgruppen zu bilden und anzuwenden. Wir behandeln die beiden Hauptanwendungen: das 'Leidenspassiv' (z.B. 'Mir wurde der Regen ins Gesicht geweht') und das höfliche Passiv, das oft in der Keigo-Sprache verwendet wird (z.B. 'Der Firmenchef ist angekommen')."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Die Kausativform: Veranlassen und Erlauben (Shieki - 使役)",
        "keywords": "Kausativ, Shieki, 使役, lassen, veranlassen, zwingen, erlauben, させる (saseru), せる (seru), Partikel を/に",
        "image_concept": "Eine fürsorgliche Mutter im Anime-Stil erlaubt ihrem kleinen Kind, ihr beim Backen zu helfen, indem es vorsichtig Mehl in eine Schüssel schüttet. Die Szene strahlt Wärme und die Erlaubnis zur Teilnahme aus. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernst du die Bildung der Kausativform, um auszudrücken, dass man jemanden etwas tun lässt oder dazu veranlasst. Ein zentraler Punkt ist die korrekte Verwendung der Partikel を und に, um zwischen 'erlauben' und 'zwingen/anweisen' zu unterscheiden."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Die Kausativ-Passiv-Form: Gezwungen werden (Shieki Ukemi - 使役受け身)",
        "keywords": "Kausativ-Passiv, Shieki Ukemi, 使役受け身, gezwungen werden,させられる (saserareru), komplexe Verben, Zwang",
        "image_concept": "Ein Anime-Schüler mit einem komisch gequälten Gesichtsausdruck wird von seinem strengen Lehrer dazu gebracht, einen riesigen Stapel Bücher zu tragen. Der Fokus liegt auf dem Gefühl des Schülers, zu etwas gezwungen zu werden. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite widmet sich der anspruchsvollsten Konjugation: der Kausativ-Passiv-Form. Du lernst, wie man sie bildet und verwendet, um auszudrücken, dass man gegen seinen Willen zu einer Handlung gezwungen wurde, z.B. 'Ich wurde gezwungen, Überstunden zu machen'."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Konditionalformen Teil 1: Logik und Hypothese (~to und ~ba - ~と & ~ば)",
        "keywords": "Konditional, Bedingung, Jōkenkei, 条件形, と (to), ば (ba), natürliche Konsequenz, Hypothese, wenn/dann",
        "image_concept": "Eine Anime-Figur steht an einer Weggabelung im Wald. Der eine Weg führt zu einer sonnigen Lichtung, der andere in einen dunkleren Teil des Waldes. Die Figur kratzt sich nachdenklich am Kopf und überlegt, welchen Weg sie nehmen soll, was die hypothetische ~ba-Bedingung darstellt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Wir beginnen die Untersuchung der vier 'Wenn-Dann'-Formen mit ~と und ~ば. Du lernst, dass ~と für natürliche, unausweichliche Konsequenzen verwendet wird (Wenn man den Knopf drückt, geht das Licht an) und ~ば für hypothetische Bedingungen (Wenn ich Geld hätte, würde ich reisen)."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Konditionalformen Teil 2: Kontext und Annahme (~tara und ~nara - ~たら & ~なら)",
        "keywords": "Konditional, Bedingung, Jōkenkei, 条件形, たら (tara), なら (nara), zeitliche Abfolge, Annahme, Ratschlag",
        "image_concept": "Zwei Freundinnen im Anime-Stil sitzen in einem Café. Eine hält einen Reiseführer für Hokkaido. Die andere stellt sich daraufhin mit leuchtenden Augen vor, wie sie im Schnee von Hokkaido spielt. Dies illustriert die auf einer Annahme basierende ~nara-Form. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt die flexibelsten und gebräuchlichsten Konditionalformen ~たら und ~なら. Du lernst, wie ~たら eine abgeschlossene Handlung als Bedingung setzt (Wenn du in Japan ankommst, ruf mich an) und wie ~なら auf eine zuvor erwähnte Annahme eingeht (Wenn du nach Tokio fährst, dann solltest du den Skytree besuchen)."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Anwendung in der Praxis: Komplexe Dialoge (Jissen Ōyō - 実践応用)",
        "keywords": "Anwendungsbeispiele, Konversation, Rollenspiel, Nuancen, Höflichkeit, Geschäftssituation, Alltagsgespräch, まとめ (matome)",
        "image_concept": "Eine vielfältige Gruppe von jungen Leuten (im Anime-Stil) sitzt an einem Tisch in einem modernen japanischen Büro und führt eine angeregte Diskussion. Einer präsentiert eine Idee, die anderen hören aufmerksam zu und reagieren. Die Szene zeigt die Anwendung komplexer Sprache in einem professionellen Umfeld. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss wenden wir das Gelernte in realistischen Dialogen an. Anhand von Beispielen aus dem Geschäfts- und Alltagsleben analysieren wir, wie Kausativ-, Passiv- und Konditionalformen kombiniert werden, um authentische und nuancierte japanische Sätze zu bilden und zu verstehen."
    }
]
