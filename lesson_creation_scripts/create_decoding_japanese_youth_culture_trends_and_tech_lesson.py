#!/usr/bin/env python3
"""
This script creates a comprehensive Decoding Japanese Youth Culture: Trends and Tech lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Decoding Japanese Youth Culture: Trends and Tech"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Dive into the vibrant world of Japanese youth culture, exploring current trends, technology, slang, and social media.  From fashion and music to online communities and gaming, this lesson unlocks the secrets of contemporary Japan."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Fashion Forward - 流行のファッション (Ryūkō no Fasshon)",
        "keywords": "fashion, trends, street style, Harajuku, Shibuya, kawaii, brands",
        "image_concept": "A group of stylishly dressed young people in Harajuku, showcasing a mix of trendy Japanese street styles.  Include elements like colorful hair, unique accessories, and layered clothing. Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Learn vocabulary related to clothing and accessories, discuss popular fashion trends among Japanese youth, and explore the unique street styles of Harajuku and Shibuya."
    },
    {
        "page_number": 3,
        "title": "Music Mania - 音楽シーン (Ongaku Shīn)",
        "keywords": "J-Pop, J-Rock, idols, concerts, music streaming, karaoke, bands",
        "image_concept": "A vibrant concert scene with energetic performers on stage and a cheering crowd.  The style should be cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Explore popular music genres in Japan, learn about famous artists and bands, and discuss the role of music in youth culture, including karaoke and concerts."
    },
    {
        "page_number": 4,
        "title": "Digital Life - デジタルライフ (Dejitaru Raifu)",
        "keywords": "smartphones, internet, social media, apps, online shopping, technology",
        "image_concept": "A group of friends using their smartphones in a cafe, engaged in different online activities. Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Examine the role of technology in the lives of Japanese youth, including smartphone usage, social media platforms, online shopping, and popular apps."
    },
    {
        "page_number": 5,
        "title": "Gaming Galaxy - ゲームの世界 (Gēmu no Sekai)",
        "keywords": "video games, esports, mobile games, console gaming, online gaming, anime, manga",
        "image_concept": "Friends playing video games together, with controllers and screens visible but no specific game titles shown. Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Dive into the world of Japanese gaming, including popular video games, esports, mobile gaming, and the influence of anime and manga on game development."
    },
    {
        "page_number": 6,
        "title": "Anime & Manga Magic - アニメと漫画の魔法 (Anime to Manga no Mahō)",
        "keywords": "anime, manga, cosplay, conventions, characters, storytelling, animation",
        "image_concept": "A group of friends dressed in cosplay at an anime convention, posing for a photo. Cute manga/anime art style with clean lines and cultural authenticity.  No specific characters should be depicted.",
        "content_focus": "Explore the impact of anime and manga on Japanese youth culture, discussing popular series, cosplay, conventions, and the art of storytelling in these mediums."
    },
    {
        "page_number": 7,
        "title": "Slang Squad - 若者言葉 (Wakamono Kotoba)",
        "keywords": "slang, abbreviations, internet slang, youth language, colloquialisms, expressions",
        "image_concept": "A group of friends chatting and laughing, symbolizing casual communication and the use of slang. Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Learn common slang words and abbreviations used by Japanese youth, understand the evolution of language through internet slang, and practice using these expressions in context."
    },
    {
        "page_number": 8,
        "title": "Influencer Impact - インフルエンサーの影響 (Infuruensā no Eikyō)",
        "keywords": "influencers, social media marketing, YouTubers, trends, online personalities, celebrities",
        "image_concept": "A stylized representation of social media feeds and online content, suggesting the influence of online personalities. Cute manga/anime art style with clean lines and cultural authenticity. No specific people or platforms should be depicted.",
        "content_focus": "Discuss the role of influencers in shaping trends and consumer behavior among Japanese youth, examine the impact of social media marketing, and learn about popular Japanese YouTubers and online personalities."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Decoding Japanese Youth Culture: Trends and Tech - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Decoding Japanese Youth Culture: Trends and Tech - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about japanese youth culture and modern trends, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "youth culture, trends, technology, slang, social media, fashion, music, gaming, anime, manga, influencers, kawaii, internet, smartphones, Z世代 (Z sedai)"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Decoding Japanese Youth Culture: Trends and Tech",
        ...
        conclusion_topic = "Conclusion for Decoding Japanese Youth Culture: Trends and Tech lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "youth culture, trends, technology, slang, social media, fashion, music, gaming, anime, manga, influencers, kawaii, internet, smartphones, Z世代 (Z sedai), cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Decoding Japanese Youth Culture: Trends and Tech - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Decoding Japanese Youth Culture: Trends and Tech - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of decoding japanese youth culture: trends and tech",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
