...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Abenteuer in Japans Natur: Wandern, Campen & mehr\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Abenteuer in Japans Natur: Wandern, Campen & mehr"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Entdecke die atemberaubende Natur Japans! Lerne wichtige Vokabeln und Redewendungen für dein nächstes Abenteuer, vom Wandern in den Bergen bis zum Campen am See, und tauche in die japanische Outdoor-Kultur ein."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen der Natur (Shizen no Kiso - 自然の基礎)",
        "keywords": "Berg (yama), Fluss (kawa), Wald (mori), See (mizuumi), Meer (umi), Himmel (sora), Natur (shizen), Stein (ishi)",
        "image_concept": "Eine weitläufige Landschaftsansicht im niedlichen Manga/Anime-Stil. Im Vordergrund ein klarer See (mizuumi), aus dem ein Fluss (kawa) fließt. Im Hintergrund erheben sich majestätische Berge (yama) unter einem blauen Himmel (sora). Am Ufer stehen einige Bäume, die einen kleinen Wald (mori) andeuten. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite lernen die Studierenden die grundlegenden Vokabeln zur Beschreibung von Naturlandschaften in Japan, die als Basis für alle weiteren Themen dienen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Auf zum Wandern! (Haikingu ni Ikou! - ハイキングに行こう！)",
        "keywords": "Wandern (haikingu), Bergsteigen (tozan), Wanderweg (tozandō), Gipfel (sanchō), Rucksack (ryukku), wandern (aruku), Aussicht (keshiki)",
        "image_concept": "Zwei fröhliche Charaktere im kawaii-Anime-Stil (ein Junge und ein Mädchen) mit Rucksäcken (ryukku), die auf einem gut erkennbaren Wanderweg (tozandō) einen Berg hinaufsteigen. Sie lächeln und deuten auf den Gipfel (sanchō) in der Ferne. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier werden Vokabular und Verben speziell für das Thema Wandern vorgestellt. Die Studierenden lernen, über die Aktivität selbst, die Ausrüstung und wichtige Orte auf dem Berg zu sprechen."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Lass uns Campen gehen (Kyanpu shiyou - キャンプしよう)",
        "keywords": "Camping (kyanpu), Zelt (tento), Schlafsack (nebukuro), Lagerfeuer (takibi), Campingplatz (kyanpujō), kochen (ryōri suru)",
        "image_concept": "Eine gemütliche Nachtszene auf einem Campingplatz (kyanpujō) im niedlichen Manga/Anime-Stil. Ein farbenfrohes Zelt (tento) leuchtet von innen. Daneben sitzt ein Charakter warm eingepackt an einem kleinen, sicheren Lagerfeuer (takibi) und blickt in den Sternenhimmel. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf das Vokabular rund ums Campen, von der Ausrüstung wie Zelten und Schlafsäcken bis hin zu Aktivitäten wie dem Machen eines Lagerfeuers."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Tiere und Pflanzen (Dōbutsu to Shokubutsu - 動物と植物)",
        "keywords": "Bär (kuma), Hirsch (shika), Affe (saru), Vogel (tori), Baum (ki), Blume (hana), Blätter (ha), Insekt (mushi)",
        "image_concept": "Eine idyllische Waldszene im kawaii-Anime-Stil. Ein japanischer Makake (saru) sitzt neugierig auf dem Ast eines Baumes (ki). Unten im bunten Laub (ha) und zwischen Blumen (hana) schaut ein freundlicher Hirsch (shika) hervor. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden erweitern ihren Wortschatz, indem sie die Namen von Tieren und Pflanzen lernen, denen man in der japanischen Natur häufig begegnen kann."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Wichtige Redewendungen & Sicherheit (Jūyōna Hyōgen & Anzen - 重要な表現と安全)",
        "keywords": "Wetter (tenki), Karte (chizu), gefährlich (abunai), Hilfe! (tasukete!), Wo ist...? (...wa doko desu ka?), müde (tsukareta)",
        "image_concept": "Ein Anime-Charakter steht an einer Weggabelung und schaut auf eine große, entfaltete Landkarte (chizu) mit symbolischen, nicht-textlichen Markierungen (Berge, Flüsse). Der Charakter hat einen leicht verwirrten, aber entschlossenen Gesichtsausdruck. Die Sonne scheint, um gutes Wetter (tenki) anzudeuten. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite vermittelt praktische und überlebenswichtige Sätze. Die Studierenden lernen, nach dem Weg zu fragen, das Wetter zu kommentieren und im Notfall um Hilfe zu rufen."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Kultur: Waldbaden & Onsen (Bunka: Shinrin-yoku & Onsen - 文化: 森林浴と温泉)",
        "keywords": "Waldbaden (shinrin-yoku), heiße Quelle (onsen), entspannen (rirakkusu suru), Bad (ofuro), Handtuch (taoru), Natur genießen (shizen o tanoshimu)",
        "image_concept": "Eine zweiteilige Bildkomposition im niedlichen Manga/Anime-Stil. Auf der linken Seite sitzt ein Charakter mit geschlossenen Augen friedlich unter einem großen, alten Baum und atmet tief ein (shinrin-yoku). Auf der rechten Seite entspannt derselbe Charakter in einer natürlichen heißen Quelle (onsen) aus Steinen, aus der Dampf aufsteigt. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier wird der kulturelle Kontext vertieft. Die Studierenden lernen das Konzept des 'Shinrin-yoku' (Waldbaden) und die Tradition, nach einer Wanderung in einem 'Onsen' (heiße Quelle) zu entspannen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Einen Ausflug planen (Ryokō no Keikaku - 旅行の計画)",
        "keywords": "Plan (keikaku), Reservierung (yoyaku), Wettervorhersage (tenki yohō), Zug (densha), Auto (kuruma), Unterkunft (shukuhaku), wohin gehen? (doko ni iku?)",
        "image_concept": "Zwei Anime-Freunde sitzen auf einem Tatami-Boden und beugen sich über eine große, stilisierte Landkarte von Japan (ohne jeglichen Text). Sie deuten aufgeregt auf verschiedene Regionen. Neben der Karte stehen kleine Spielzeugfiguren eines Zuges (densha) und eines Autos (kuruma), um die Planung der Reise zu symbolisieren. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss lernen die Studierenden Vokabeln und Phrasen, um einen kompletten Ausflug in die Natur zu planen, von der Wahl des Ziels über die Buchung bis zur Diskussion der Transportmittel."
    }
]
