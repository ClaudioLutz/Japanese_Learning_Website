...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive The Flow of Giving: Mastering Ageru, Kureru, & Morau lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "The Flow of Giving: Mastering Ageru, Kureru, & Morau"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Unlock the secrets of Japanese social dynamics by mastering the essential verbs of giving and receiving. This lesson will guide you from simple gift exchange to the nuanced art of offering and accepting favors, a cornerstone of Japanese communication."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "1. 外への流れ：あげる (Soto e no Nagare: Ageru)",
        "keywords": "ageru, あげる, giving, giver, receiver, particle に, particle は, particle を",
        "image_concept": "A cute manga-style character (let's call her Yuki) is smiling and handing a neatly wrapped bento box with both hands to her friend. The perspective is neutral, showing both characters clearly. The background is a simple park setting. The style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Learn the basic verb 'ageru' for when the speaker (or someone in the speaker's group) gives an item or favor to someone else (an outsider). This section focuses on the outward flow of action, establishing the core Giver/Receiver relationship."
    },
    {
        "page_number": 3,
        "title": "2. 内への流れ：くれる (Uchi e no Nagare: Kureru)",
        "keywords": "kureru, くれる, giving to me, in-group, uchi, perspective shift, gratitude",
        "image_concept": "A male manga-style character is smiling kindly and holding out a single, beautiful flower towards the viewer. The perspective is first-person, so the viewer feels like they are the one about to receive the flower. The background is slightly blurred, focusing on the character and the act of giving. The style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Understand 'kureru', the verb used when someone from an out-group gives something to the speaker or a member of the speaker's in-group ('uchi'). This page highlights the crucial perspective shift and the implied sense of receiving a kind gesture."
    },
    {
        "page_number": 4,
        "title": "3. 受け取る行為：もらう (Uketoru Kōi: Morau)",
        "keywords": "morau, もらう, receiving, receiver's perspective, particle に, particle から, active reception",
        "image_concept": "The same manga-style character, Yuki, is shown from the side, bowing her head slightly in gratitude as she accepts a book from an older, kind-looking woman who could be her teacher. Yuki is holding the book carefully with both hands. The focus is on Yuki's action of receiving. The style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Master 'morau', which focuses on the act of receiving from the receiver's point of view. Learn the difference between 'kureru' (someone gave me) and 'morau' (I received from someone), and when to use particles 'ni' and 'kara'."
    },
    {
        "page_number": 5,
        "title": "4. 三つの視点：比較 (Mittsu no Shiten: Hikaku)",
        "keywords": "comparison, chart, perspective, sentence structure, point of view, summary",
        "image_concept": "A three-panel, vertical manga strip without dialogue bubbles. Panel 1 (Top): A boy gives a girl a scarf in a winter scene. The shot is neutral. Panel 2 (Middle): Same scene, but zoomed in slightly on the boy's smiling face as he extends the scarf, with subtle motion lines indicating his action of giving. Panel 3 (Bottom): Same scene, but zoomed in on the girl's happy, grateful face as she accepts the scarf, holding it close. The style is cute manga/anime with clean lines. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Consolidate your understanding by comparing 'ageru', 'kureru', and 'morau' side-by-side. This page will use the same event described from three different perspectives to solidify the core difference in viewpoint for each verb."
    },
    {
        "page_number": 6,
        "title": "5. 行為の贈り物：〜てあげる (~te ageru)",
        "keywords": "te-form, favors, helping others, verb combination, doing for others",
        "image_concept": "In a cozy room, one manga character is sitting on the floor, looking frustrated with a pile of origami paper. Another character is kneeling beside them, smiling and expertly folding a paper crane to show them how. The focus is on the act of helping. The style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Expand from physical objects to actions. Learn how to combine the te-form of a verb with 'ageru' to express doing a favor for someone else. This is a common and essential pattern for showing kindness and initiative."
    },
    {
        "page_number": 7,
        "title": "6. 恩恵を受ける：〜てくれる & 〜てもらう (~te kureru & ~te morau)",
        "keywords": "te-kureru, te-morau, receiving favors, nuance, gratitude, request",
        "image_concept": "A manga character is holding an umbrella over another character who forgot theirs, as they walk together in the rain. The character being sheltered is looking at the one holding the umbrella with an expression of deep gratitude and slight surprise. The scene conveys a feeling of unexpected kindness. The style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Master the nuanced art of talking about receiving favors. Differentiate between '~te kureru' (emphasizing the giver's kindness towards you) and '~te morau' (emphasizing that you received the benefit of the action, often implying a request)."
    },
    {
        "page_number": 8,
        "title": "7. 文化と敬語：文脈が全て (Bunka to Keigo: Bunmyaku ga Subete)",
        "keywords": "cultural context, uchi-soto, politeness, keigo, 敬語, omiyage, sashiageru, itadaku, kudasaru",
        "image_concept": "A formal office setting. A young employee, just returned from a trip, is bowing respectfully while presenting a large, beautifully wrapped box (omiyage) to their boss, who is accepting it with a pleasant smile. Other coworkers are in the background, looking on happily. The scene conveys respect and workplace harmony. The style is cute manga/anime with clean lines. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Explore the deep cultural context behind giving and receiving in Japan. Understand how 'uchi-soto' rules dictate verb choice and learn about related customs like 'omiyage'. This page will also introduce the existence of formal 'keigo' equivalents ('sashiageru', 'itadaku', 'kudasaru') as the next step in your learning."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing The Flow of Giving: Mastering Ageru, Kureru, & Morau - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="The Flow of Giving: Mastering Ageru, Kureru, & Morau - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about the grammar of giving and receiving (ageru, kureru, morau), the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "ageru, kureru, morau, giving and receiving, Japanese grammar, verb conjugation, te-form, favors, uchi-soto, Japanese culture, gift giving, politeness, keigo, particle ni, particle kara"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to The Flow of Giving: Mastering Ageru, Kureru, & Morau",
        ...
        conclusion_topic = "Conclusion for The Flow of Giving: Mastering Ageru, Kureru, & Morau lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "ageru, kureru, morau, giving and receiving, Japanese grammar, verb conjugation, te-form, favors, uchi-soto, Japanese culture, gift giving, politeness, keigo, particle ni, particle kara, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="The Flow of Giving: Mastering Ageru, Kureru, & Morau - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="The Flow of Giving: Mastering Ageru, Kureru, & Morau - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of the flow of giving: mastering ageru, kureru, & morau",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
