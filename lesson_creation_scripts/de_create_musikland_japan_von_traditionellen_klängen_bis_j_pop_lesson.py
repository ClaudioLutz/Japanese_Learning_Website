...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Musikland Japan: Von traditionellen Klängen bis J-Pop\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Musikland Japan: Von traditionellen Klängen bis J-Pop"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Tauche ein in die vielfältige Musikwelt Japans! In dieser Lektion lernst du Vokabular für Musikgenres und Instrumente, von der traditionellen Koto bis zur E-Gitarre, und erfährst, wie du über deine Lieblingskünstler und Konzerte sprechen kannst."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen der Musik (Ongaku no Kihon - 音楽の基本)",
        "keywords": "Musik (音楽), hören (聞く), Lied (歌), Genre (ジャンル), Melodie (メロディー), Rhythmus (リズム)",
        "image_concept": "Ein junger Mann und eine junge Frau sitzen auf einer Parkbank, teilen sich Kopfhörer und hören lächelnd Musik von einem Smartphone. Die Szene ist sonnig und fröhlich. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Einführung in grundlegende Vokabeln rund um Musik. Die Studierenden lernen, wie man sagt \"Ich höre Musik\" und wie man nach dem Lieblingsgenre fragt."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Traditionelle Japanische Instrumente (Wagakki - 和楽器)",
        "keywords": "traditionelles Instrument (和楽器), Koto (琴), Shamisen (三味線), Shakuhachi (尺八), Taiko (太鼓), Biwa (琵琶)",
        "image_concept": "Eine elegante Frau in einem schlichten Kimono spielt anmutig eine Koto in einem traditionellen japanischen Raum mit Tatami-Matten und Shoji-Schiebetüren. Eine Shakuhachi-Flöte und ein Shamisen lehnen an der Wand. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Vorstellung der wichtigsten traditionellen japanischen Instrumente (Wagakki). Die Studierenden lernen die Namen und das Aussehen dieser Instrumente kennen und verstehen ihre kulturelle Bedeutung."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Moderne & Westliche Instrumente (Gendai no Gakki - 現代の楽器)",
        "keywords": "Gitarre (ギター), E-Gitarre (エレキギター), Bass (ベース), Schlagzeug (ドラム), Klavier (ピアノ), Keyboard (キーボード)",
        "image_concept": "Eine energiegeladene High-School-Band probt in einem Musikraum. Ein Junge spielt E-Gitarre, ein Mädchen spielt Bass, ein anderer Junge sitzt am Schlagzeug. Alle tragen japanische Schuluniformen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Vokabeln für moderne und westliche Instrumente, die in Japan sehr populär sind, insbesondere in J-Pop- und Rockbands. Die Studierenden lernen, die Instrumente in einer Band zu benennen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Japanische Musikgenres (Nihon no Ongaku Janru - 日本の音楽ジャンル)",
        "keywords": "J-Pop (ジェイポップ), Rock (ロック), Enka (演歌), Anime-Song (アニソン), traditionelle Musik (邦楽), Gagaku (雅楽)",
        "image_concept": "Eine Collage-artige Szene, die verschiedene Genres repräsentiert: In einer Ecke tanzt ein Idol auf einer bunten Bühne (J-Pop), in einer anderen Ecke singt ein älterer Mann in Anzug in ein Retro-Mikrofon (Enka), und im Hintergrund sieht man die Silhouette eines Anime-Helden. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Ein Überblick über verschiedene japanische Musikgenres, von traditioneller Hofmusik (Gagaku) über den sentimentalen Enka bis hin zum weltberühmten J-Pop und Anime-Songs, inklusive kurzer Hörbeispiele (imaginär)."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Die Menschen hinter der Musik (Ongaku ni Kakawaru Hitobito - 音楽に関わる人々)",
        "keywords": "Sänger/in (歌手), Musiker/in (音楽家), Band (バンド), Idol (アイドル), Komponist/in (作曲家), Texter/in (作詞家)",
        "image_concept": "Eine Gruppe von Musikern posiert zusammen für ein Gruppenfoto in einem Aufnahmestudio: ein Idol in einem glitzernden Kostüm, ein cooler Rocksänger mit Lederjacke und eine klassische Komponistin am Flügel. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erlernen der Bezeichnungen für die verschiedenen Akteure in der Musikwelt, vom Sänger bis zum Komponisten. Dies hilft den Studierenden, spezifischer über ihre Lieblingskünstler zu sprechen."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Musikerlebnisse: Konzert & Karaoke (Raibu to Karaoke - ライブとカラオケ)",
        "keywords": "Konzert (コンサート), Live-House (ライブハウス), Ticket (チケット), Karaoke (カラオケ), singen (歌う), Fan (ファン)",
        "image_concept": "Zwei Szenen nebeneinander durch eine weiche Trennlinie geteilt: Links eine Gruppe von Fans bei einem J-Pop-Konzert, die begeistert Leuchtstäbe schwenken. Rechts eine Gruppe von Freunden in einem privaten Karaoke-Raum, die fröhlich singen und Tamburine spielen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Vokabular für das Erleben von Musik, sei es bei einem großen Konzert, in einem intimen 'Live House' oder bei einer lustigen Karaoke-Session mit Freunden. Kultureller Kontext zu Karaoke und Live Houses wird gegeben."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Über Musik sprechen (Ongaku ni tsuite Hanasu - 音楽について話す)",
        "keywords": "Lieblings- (好きな), empfehlen (おすすめ), welches (どの), beeindruckend (感動的), eingängig (キャッチー), Songtext (歌詞)",
        "image_concept": "Zwei Freunde sitzen in einem Café. Einer zeigt auf seinem Tablet auf eine Musik-App, während der andere mit einem nachdenklichen und beeindruckten Gesichtsausdruck zuhört. Auf dem Tisch stehen Kaffee und Kuchen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zusammenfassung und Anwendung. Die Studierenden üben, Sätze zu bilden, um ihre musikalischen Vorlieben auszudrücken, Musik zu empfehlen und ihre Eindrücke von einem Lied oder Konzert zu beschreiben."
    }
]
