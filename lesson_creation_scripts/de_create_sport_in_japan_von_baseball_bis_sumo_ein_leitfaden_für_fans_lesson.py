...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Sport in Japan: Von Baseball bis Sumo – Ein Leitfaden für Fans\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Sport in Japan: Von Baseball bis Sumo – Ein Leitfaden für Fans"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Erlebe die aufregende Welt des japanischen Sports! Lerne essentielles Vokabular, kraftvolle Anfeuerungsrufe und die kulturellen Besonderheiten, um Sportereignisse wie ein Einheimischer zu genießen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundwortschatz Sport (Supōtsu no Kihon Tango - スポーツの基本単語)",
        "keywords": "Sport, スポーツ, Spiel, 試合, Mannschaft, チーム, Spieler, 選手, Stadion, スタジアム, Arena, アリーナ, Fan, ファン",
        "image_concept": "Eine bunte Collage verschiedener Sportgeräte im niedlichen Manga/Anime-Stil. Ein Baseball, ein Fußball und ein Sumo-Gürtel (Mawashi) liegen nebeneinander auf einem stilisierten grünen Rasen. Helle Farben, klare Linien, kawaii-Ästhetik. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite lernen die Studierenden die grundlegenden Vokabeln, um über Sport im Allgemeinen zu sprechen. Dies beinhaltet Wörter für Sportarten, Orte und beteiligte Personen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Populäre Sportarten: Baseball & Fußball (Ninki no Supōtsu: Yakyū to Sakkā - 人気のスポーツ: 野球とサッカー)",
        "keywords": "Baseball, 野球, Fußball, サッカー, Homerun, ホームラン, Tor, ゴール, Pitcher, ピッチャー, Stürmer, フォワード, Hanshin Tigers, 阪神タイガース",
        "image_concept": "Zwei Freunde, ein Junge und ein Mädchen, im niedlichen Manga/Anime-Stil, sitzen auf einer Tribüne. Der Junge trägt eine Baseballkappe und schwenkt einen kleinen Schläger, das Mädchen trägt einen Fußballschal. Sie schauen aufgeregt nach vorne. Helle Farben, fröhliche Atmosphäre. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Fokus auf die beiden beliebtesten Zuschauersportarten Japans. Die Studierenden lernen spezifisches Vokabular für Baseball und Fußball sowie die Namen einiger berühmter japanischer Teams."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Traditioneller Sport: Die Welt des Sumo (Dentō Supōtsu: Sumō no Sekai - 伝統スポーツ: 相撲の世界)",
        "keywords": "Sumo, 相撲, Ringer, 力士 (Rikishi), Ring, 土俵 (Dohyō), Großmeister, 横綱 (Yokozuna), Turnier, 場所 (Basho), Kimarite, 決まり手",
        "image_concept": "Zwei Sumo-Ringer in niedlicher, karikierter Chibi/Manga-Form stehen sich im traditionellen Ring (Dohyō) gegenüber. Ein Schiedsrichter (Gyōji) in zeremonieller Kleidung steht daneben. Der Hintergrund zeigt das Publikum als unscharfe, bunte Masse. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Einblicke in den traditionellen Nationalsport Sumo. Die Lernenden entdecken die einzigartige Terminologie, die Ränge der Ringer und die besondere Atmosphäre eines Sumo-Turniers."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Tickets kaufen und Plätze finden (Chiketto no Kōnyū to Zaseki - チケットの購入と座席)",
        "keywords": "Ticket, チケット, reservierter Platz, 指定席 (Shiteiseki), nicht reservierter Platz, 自由席 (Jiyūseki), wie viel kostet es?, いくらですか, Eingang, 入口 (Iriguchi), Platznummer, 座席番号 (Zaseki Bangō)",
        "image_concept": "Eine freundliche Ticketverkäuferin im Manga-Stil hinter einem Schalter, die einem jungen Touristen ein Ticket überreicht. Beide lächeln. Im Hintergrund ist ein schematischer Sitzplan ohne lesbaren Text zu sehen. Niedlicher Stil, helle Farben. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Praktische Anwendung: Wie man in Japan nach Tickets für ein Sportereignis fragt, verschiedene Arten von Sitzplätzen versteht und seinen Platz im Stadion oder in der Arena findet."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Anfeuern wie ein Profi! (Ōen Shiyō! - 応援しよう！)",
        "keywords": "Anfeuern, 応援 (Ōen), Gib dein Bestes!, 頑張れ (Ganbare), Los!, 行け (Ike), Super!, すごい, Mach weiter!, その調子 (Sono Chōshi), Megaphon, メガホン",
        "image_concept": "Eine Gruppe von drei jungen Fans im Manga-Stil, die enthusiastisch jubeln. Eine Person hält zwei kleine bunte Plastik-Megaphone (typisch für japanisches Baseball-Cheering) zusammen. Alle haben fröhliche, aufgeregte Gesichtsausdrücke. Dynamische Posen. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Das Herzstück der Fankultur. Die Studierenden lernen die wichtigsten und am häufigsten verwendeten Anfeuerungsrufe und Phrasen, um ihre Lieblingsmannschaft oder ihren Lieblingsspieler zu unterstützen."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Spezifische Fangesänge und Rituale (Ōenka to Oyakusoku - 応援歌とお約束)",
        "keywords": "Fangesang, 応援歌 (Ōenka), Handtuch schwenken, タオルを振る, Jet-Ballons, ジェット風船, siebter Inning, 7回 (nana-kai), Spieler-Chant, 選手コール",
        "image_concept": "Ein Baseballstadion bei Sonnenuntergang im niedlichen Anime-Stil. Hunderte von bunten, länglichen 'Jet-Ballons' steigen von der Tribüne in den Himmel. Die Fans sind als kleine, jubelnde Silhouetten dargestellt. Magische, farbenfrohe Atmosphäre. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Vertiefung der Fankultur. Diese Seite erklärt spezifische Rituale wie das Singen von Teamhymnen (Ōenka) und das Aufsteigenlassen von Jet-Ballons beim Baseball, um ein authentisches Fan-Erlebnis zu schaffen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Stadion-Etikette und Verpflegung (Sutajiamu no Manā to Tabemono - スタジアムのマナーと食べ物)",
        "keywords": "Stadion-Bento, スタジアム弁当, Bier, ビール, Müll, ゴミ, aufräumen, 片付ける, Respekt, 尊敬, gute Manieren, マナー",
        "image_concept": "Ein junges Paar im Anime-Stil sitzt auf der Tribüne und isst fröhlich aus Bento-Boxen. Ein 'Urigo', ein Mädchen mit einem kleinen Bierfass auf dem Rücken, lächelt im Hintergrund. Neben dem Paar steht ein kleiner, ordentlich verschnürter Müllbeutel. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Wichtige kulturelle Aspekte für einen reibungslosen Stadionbesuch. Die Lernenden erfahren, was man im Stadion isst und trinkt (Bento, Bierverkäufer) und lernen die japanische Etikette, wie z.B. seinen eigenen Müll wieder mitzunehmen."
    }
]
