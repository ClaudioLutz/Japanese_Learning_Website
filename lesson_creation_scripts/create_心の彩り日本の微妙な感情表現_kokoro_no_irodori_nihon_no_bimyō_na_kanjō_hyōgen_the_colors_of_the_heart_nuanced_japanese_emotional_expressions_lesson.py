...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive 心の彩り：日本の微妙な感情表現 (Kokoro no Irodori: Nihon no Bimyō na Kanjō Hyōgen) - The Colors of the Heart: Nuanced Japanese Emotional Expressions lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "心の彩り：日本の微妙な感情表現 (Kokoro no Irodori: Nihon no Bimyō na Kanjō Hyōgen) - The Colors of the Heart: Nuanced Japanese Emotional Expressions"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Expand your emotional vocabulary beyond the basics of 'happy' and 'sad'. This lesson explores the subtle and nuanced feelings often expressed in Japanese, helping you to communicate more precisely and understand cultural context on a deeper level."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Page 1 - 基本から応用へ (Kihon kara Ōyō e) - From Basic to Applied",
        "keywords": "感情 (kanjō), 気持ち (kimochi), 基本 (kihon), 応用 (ōyō), 空気を読む (kūki o yomu)",
        "image_concept": "A cute manga-style character stands looking thoughtfully at a collection of floating, transparent spheres. Inside three of the spheres are simple emotion faces: a smile, a frown, a neutral face. The character is reaching for a much larger, more complex sphere that contains a beautiful, swirling nebula of different colors, representing nuanced feelings. The style is clean and symbolic.",
        "content_focus": "This page introduces the concept of nuanced emotions, contrasting them with basic feelings like 嬉しい (happy) and 悲しい (sad). It explains the cultural importance of understanding subtle feelings in Japan, centered around the idea of 'reading the air' (空気を読む)."
    },
    {
        "page_number": 3,
        "title": "Page 2 - ポジティブな心の機微 (Pojitibu na Kokoro no Kibi) - Positive Nuances",
        "keywords": "ほっとする (hotto suru), わくわくする (wakuwaku suru), すっきりする (sukkiri suru), 感激する (kangeki suru), 癒やされる (iyasaseru)",
        "image_concept": "In a cozy, sunlit room, a cute anime-style character is curled up on a soft armchair, holding a warm mug of tea and smiling with their eyes closed. A cat is sleeping peacefully on their lap. The overall atmosphere is one of profound relief and contentment (ほっとする/癒やされる).",
        "content_focus": "Learn vocabulary for different types of positive feelings beyond simple happiness. This includes the feeling of relief (ほっとする), excited anticipation (わくわくする), feeling refreshed (すっきりする), and being deeply moved or soothed (癒やされる)."
    },
    {
        "page_number": 4,
        "title": "Page 3 - ネガティブな心の機微 (Negatibu na Kokoro no Kibi) - Negative Nuances",
        "keywords": "切ない (setsunai), 悔しい (kuyashii), 虚しい (munashii), しょんぼり (shonbori), やるせない (yarusenai)",
        "image_concept": "A manga-style character sits alone on a train, looking out the window at a rainy city landscape. Their reflection in the window shows a melancholic, but not crying, expression. The mood is quiet, introspective, and captures the bittersweet feeling of 切ない.",
        "content_focus": "Explore complex negative emotions. This page differentiates between the bittersweet pain or poignancy (切ない), the frustration of regret (悔しい), the feeling of emptiness or futility (虚しい), and the helpless, miserable feeling of やるせない."
    },
    {
        "page_number": 5,
        "title": "Page 4 - 対人関係の感情 (Taijin Kankei no Kanjō) - Interpersonal Feelings",
        "keywords": "気まずい (kimazui), 申し訳ない (mōshiwakenai), 憧れる (akogareru), 遠慮する (enryo suru), 甘える (amaeru)",
        "image_concept": "Two cute anime characters are standing in a hallway, having just bumped into each other and dropped their books. They are both avoiding eye contact and have a slight blush, one scratching the back of their head. The body language clearly communicates a moment of awkwardness (気まずい).",
        "content_focus": "Focus on feelings that arise in social interactions. Students will learn the difference between general embarrassment and social awkwardness (気まずい), the deep sense of being sorry (申し訳ない), and the cultural concepts of holding back (遠慮する) and depending on others' goodwill (甘える)."
    },
    {
        "page_number": 6,
        "title": "Page 5 - 擬態語で表す気持ち (Gitaigo de Arawasu Kimochi) - Feelings via Onomatopoeia",
        "keywords": "もやもやする (moyamoya suru), そわそわする (sowasowa suru), いらいらする (iraira suru), どきどきする (dokidoki suru), ぼーっとする (bōtto suru)",
        "image_concept": "A manga character is sitting at a desk, trying to study but unable to concentrate. Around their head are visual representations of their feelings: soft, cloudy, grey swirls for もやもや, and small, anxious zig-zag lines for そわそわ. Their expression is one of mild distress and confusion.",
        "content_focus": "Master Japanese mimetic words (gitaigo) that describe internal states. This page covers the vague, unsettled feeling of もやもや, the nervous fidgeting of そわそわ, the sharp irritation of いらいら, and the heart-pounding of どきどき (for excitement or fear)."
    },
    {
        "page_number": 7,
        "title": "Page 6 - 物思いにふける感情 (Mono omoi ni fukeru Kanjō) - Reflective Feelings",
        "keywords": "懐かしい (natsukashii), しみじみ (shimi-jimi), もののあはれ (mono no aware), 恋しい (koishii), 感慨深い (kangaibukai)",
        "image_concept": "An anime character in their late teens or early twenties is standing on a hill overlooking their old hometown at sunset. They have a gentle, faraway look in their eyes and a soft smile, evoking a deep sense of nostalgia (懐かしい) and reflection (感慨深い).",
        "content_focus": "Discover deep, reflective emotions tied to Japanese aesthetics. This includes the warm feeling of nostalgia (懐かしい), the quiet, profound realization of しみじみ, and an introduction to もののあはれ – the gentle sadness and awareness of the transience of things."
    },
    {
        "page_number": 8,
        "title": "Page 7 - 文脈での使い方 (Bunmyaku de no Tsukaikata) - Application in Context",
        "keywords": "〜気がする (~ki ga suru), 〜てたまらない (~te tamaranai), 〜ように感じる (~yō ni kanjiru), 表情 (hyōjō), 状況 (jōkyō)",
        "image_concept": "A split-panel manga-style image. On the top panel, a character sees a friend off at a bus station, waving with a complex expression. On the bottom panel, the character is walking home alone, looking down with a clear expression of loneliness and missing their friend (寂しくてたまらない). This shows the context and the resulting internal feeling.",
        "content_focus": "Put everything together by learning grammatical structures to express these nuanced feelings. Practice using patterns like 〜気がする (I have a feeling that...) and 〜てたまらない (I can't help but feel...). Students will analyze short scenarios to choose the most appropriate emotional word for the context."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing 心の彩り：日本の微妙な感情表現 (Kokoro no Irodori: Nihon no Bimyō na Kanjō Hyōgen) - The Colors of the Heart: Nuanced Japanese Emotional Expressions - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="心の彩り：日本の微妙な感情表現 (Kokoro no Irodori: Nihon no Bimyō na Kanjō Hyōgen) - The Colors of the Heart: Nuanced Japanese Emotional Expressions - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about expressing nuanced emotions and feelings, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "感情 (kanjō), 気持ち (kimochi), 切ない (setsunai), 懐かしい (natsukashii), もやもやする (moyamoya suru), ほっとする (hotto suru), 擬態語 (gitaigo), 空気を読む (kūki o yomu), 微妙 (bimyō), 感覚 (kankaku), 心 (kokoro), ニュアンス (nyuansu), 表現 (hyōgen)"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to 心の彩り：日本の微妙な感情表現 (Kokoro no Irodori: Nihon no Bimyō na Kanjō Hyōgen) - The Colors of the Heart: Nuanced Japanese Emotional Expressions",
        ...
        conclusion_topic = "Conclusion for 心の彩り：日本の微妙な感情表現 (Kokoro no Irodori: Nihon no Bimyō na Kanjō Hyōgen) - The Colors of the Heart: Nuanced Japanese Emotional Expressions lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "感情 (kanjō), 気持ち (kimochi), 切ない (setsunai), 懐かしい (natsukashii), もやもやする (moyamoya suru), ほっとする (hotto suru), 擬態語 (gitaigo), 空気を読む (kūki o yomu), 微妙 (bimyō), 感覚 (kankaku), 心 (kokoro), ニュアンス (nyuansu), 表現 (hyōgen), cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="心の彩り：日本の微妙な感情表現 (Kokoro no Irodori: Nihon no Bimyō na Kanjō Hyōgen) - The Colors of the Heart: Nuanced Japanese Emotional Expressions - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="心の彩り：日本の微妙な感情表現 (Kokoro no Irodori: Nihon no Bimyō na Kanjō Hyōgen) - The Colors of the Heart: Nuanced Japanese Emotional Expressions - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of 心の彩り：日本の微妙な感情表現 (kokoro no irodori: nihon no bimyō na kanjō hyōgen) - the colors of the heart: nuanced japanese emotional expressions",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
