...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Demystifying Japanese Particles: The Roles of は, が, を, and に lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Demystifying Japanese Particles: The Roles of は, が, を, and に"
LESSON_DIFFICULTY = "Beginner"
LESSON_DESCRIPTION = "Unlock the core of Japanese sentence structure by mastering the four most essential particles. This lesson provides a clear, step-by-step guide to understanding は (wa), が (ga), を (o), and に (ni), transforming confusing sentences into clear expressions."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Page 1 - はじめに：助詞とは？ (Hajime ni: Joshi to wa?)",
        "keywords": "助詞, joshi, particles, introduction, foundation, sentence structure, glue",
        "image_concept": "A cute anime-style character, looking thoughtful, as they fit colorful, glowing puzzle pieces together to form a beautiful Japanese landscape (like Mt. Fuji with cherry blossoms). The puzzle pieces represent words and particles, visually showing how they connect to create a complete picture. The style is soft and inviting.",
        "content_focus": "Introduction to the concept of particles (助詞, joshi) as the 'glue' that holds Japanese sentences together. Students will learn why particles are crucial for defining the roles of words in a sentence."
    },
    {
        "page_number": 3,
        "title": "Page 2 - トピックの「は」 (Toppiku no 'wa')",
        "keywords": "は, wa, topic marker, context, 'as for', introduction, general statement",
        "image_concept": "A friendly anime-style girl stands in a clean, modern kitchen. She is gesturing towards a bowl of ramen on the counter with a welcoming expression. The focus is on her introducing the ramen as the topic. The background is slightly blurred to emphasize the character and the bowl.",
        "content_focus": "Deep dive into は (wa), the topic marker. Students will learn how to use は to introduce a topic or to provide context for the rest of the sentence, often translated as 'as for...' or 'speaking of...'."
    },
    {
        "page_number": 4,
        "title": "Page 3 - 主語の「が」 (Shugo no 'ga')",
        "keywords": "が, ga, subject marker, identifier, specific, new information, question",
        "image_concept": "A scene in a cozy living room. A slice of cake with a bite taken out of it sits on a small table. A few feet away, a small, cute calico cat is sitting and licking its lips, with a tiny dab of whipped cream on its nose. The image clearly identifies the cat as the one who ate the cake.",
        "content_focus": "Focus on が (ga), the subject marker. Students will learn that が identifies a specific subject, often providing new information or answering an implicit or explicit 'who' or 'what' question."
    },
    {
        "page_number": 5,
        "title": "Page 4 - 「は」VS「が」対決 (Wa VS Ga Taiketsu)",
        "keywords": "は vs が, wa vs ga, comparison, contrast, nuance, context, specific vs general",
        "image_concept": "A dynamic split-screen image. On the left side, under a soft, general light, an anime-style zoologist is calmly gesturing towards an elephant, illustrating a general fact ('Elephants have long noses'). On the right side, the scene is more dramatic, with a spotlight on a specific, unique pink elephant, as the character points at it with a surprised expression ('THAT elephant is pink!').",
        "content_focus": "A direct comparison between は (wa) and が (ga). This page clarifies the confusion between the two by using contrastive examples, highlighting how は makes general statements while が pinpoints specific subjects."
    },
    {
        "page_number": 6,
        "title": "Page 5 - 目的語の「を」 (Mokutekigo no 'o')",
        "keywords": "を, o, wo, object marker, direct object, action, verb",
        "image_concept": "An overhead shot of a person sitting at a traditional Japanese low table (chabudai) on a tatami mat. The person, dressed in simple, modern casual wear, is in the middle of an action: using both hands to lift a traditional Japanese teacup (yunomi) to their mouth to drink from it. The focus is on the action connecting the person and the teacup.",
        "content_focus": "Explanation of the direct object marker を (o). Students will learn how to use を to mark the noun that receives the action of a verb, such as in 'I drink tea' or 'I read a book'."
    },
    {
        "page_number": 7,
        "title": "Page 6 - 多機能の「に」 (Takinō no 'ni')",
        "keywords": "に, ni, location, destination, time, indirect object, multi-function",
        "image_concept": "A cheerful anime-style student standing on a clean, modern Japanese train platform. With one hand, she points towards a large, simple clock on the wall (indicating time). With the other hand, she points down the track where a sleek shinkansen (bullet train) is arriving (indicating destination). Her feet are planted firmly on the platform (indicating location of existence).",
        "content_focus": "Exploring the versatile particle に (ni). Students will learn its three primary beginner functions: indicating a specific point in time (e.g., at 3 o'clock), a destination of movement (e.g., go TO Tokyo), and the location of existence (e.g., I am IN Tokyo)."
    },
    {
        "page_number": 8,
        "title": "Page 7 - 全部使ってみよう！ (Zenbu Tsukatte Miyō!)",
        "keywords": "synthesis, application, real-world scenario, full sentence, combination",
        "image_concept": "A vibrant and detailed scene at a Japanese park on a sunny afternoon. A young man (Taro) is sitting on a bench reading a book (本を読みます). A friendly dog (犬が) is joyfully chasing a ball nearby. In the background, a woman (Mikaさん) is at an ice cream cart (アイスクリーム屋にいます). The scene is framed by cherry blossom trees, creating a full context where 'Taro is the topic,' 'the dog is the specific subject doing an action,' 'the book is the object,' and 'the cart is a location'.",
        "content_focus": "A culminating page that combines all four particles (は, が, を, に) into complex, natural sentences. Students will analyze a complete scene to see how the particles work together to create a detailed narrative."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Demystifying Japanese Particles: The Roles of は, が, を, and に - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about core grammar: demystifying japanese particles, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "Japanese particles, joshi, は, が, を, に, wa, ga, o, ni, Japanese grammar, sentence structure, topic marker, subject marker, object marker, Japanese basics, grammar fundamentals, 格助詞"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Demystifying Japanese Particles: The Roles of は, が, を, and に",
        ...
        conclusion_topic = "Conclusion for Demystifying Japanese Particles: The Roles of は, が, を, and に lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "Japanese particles, joshi, は, が, を, に, wa, ga, o, ni, Japanese grammar, sentence structure, topic marker, subject marker, object marker, Japanese basics, grammar fundamentals, 格助詞, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Demystifying Japanese Particles: The Roles of は, が, を, and に - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Demystifying Japanese Particles: The Roles of は, が, を, and に - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of demystifying japanese particles: the roles of は, が, を, and に",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
