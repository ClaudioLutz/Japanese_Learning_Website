...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Notfall-Japanisch: Sicher und vorbereitet in jeder Situation\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Notfall-Japanisch: Sicher und vorbereitet in jeder Situation"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Lerne lebenswichtige japanische Sätze für Notfälle. Diese Lektion bereitet dich darauf vor, in unvorhergesehenen Situationen wie Naturkatastrophen oder Unfällen sicher zu bleiben und effektiv um Hilfe zu bitten."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Hilfe! Die wichtigsten Notrufe (Tasukete! - 助けて！)",
        "keywords": "Hilfe, Notruf, Feuer, Dieb, Gefahr, Tasukete, Kaji, Dorobō, Abunai",
        "image_concept": "Ein niedlicher Anime-Charakter im Chibi-Stil (z.B. ein Tanuki oder ein junges Mädchen) mit einem besorgten Gesichtsausdruck. Der Charakter zeigt mit einer Hand auf etwas außerhalb des Bildes, während die andere Hand zum Mund geführt ist, als ob er/sie gerade laut ruft. Die Szene ist einfach und der Fokus liegt auf der dringenden Geste. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite lernen die Studierenden die grundlegendsten und wichtigsten Ausrufe, um in unmittelbarer Gefahr auf sich aufmerksam zu machen. Der Fokus liegt auf kurzen, leicht zu merkenden Phrasen für Situationen wie Feuer, Diebstahl oder allgemeine Notfälle."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Polizei, Feuerwehr & Krankenwagen (Keisatsu, Shōbō & Kyūkyū - 警察、消防、救急)",
        "keywords": "Polizei, Feuerwehr, Krankenwagen, Notrufnummer, 110, 119, Keisatsu, Shōbōsha, Kyūkyūsha, yonde kudasai",
        "image_concept": "Drei personifizierte, niedliche Rettungsfahrzeuge im Kawaii-Stil nebeneinander. Links ein japanisches Polizeiauto (schwarz-weiß mit rotem Licht), in der Mitte ein rotes japanisches Feuerwehrauto und rechts ein weißer japanischer Krankenwagen. Alle Fahrzeuge haben freundliche Gesichter. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernen die Studierenden, die spezifischen Rettungsdienste zu benennen und anzufordern. Es werden die Vokabeln für Polizei, Feuerwehr und Krankenwagen sowie die einfache Grammatikstruktur '... o yonde kudasai' (Bitte rufen Sie ...) gelehrt."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Verhalten bei Erdbeben (Jishin no toki - 地震の時)",
        "keywords": "Erdbeben, Erschütterung, sicher, gefährlich, unter dem Tisch, Evakuierungsort, Jishin, Yure, Anzen, Abunai, Hinanjo",
        "image_concept": "Eine Anime-Familie (Vater, Mutter, Kind) im kawaii Stil, die während eines Erdbebens unter einem stabilen Holztisch Schutz sucht. Sie demonstrieren die 'Duck, Cover, and Hold'-Haltung. Der Raum ist ein japanisches Wohnzimmer. Leichte Bewegungslinien deuten die Erschütterung an, aber die Charaktere sehen ruhig und vorbereitet aus. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf das Thema Erdbeben, eine in Japan relevante Naturkatastrophe. Die Studierenden lernen Vokabular zur Beschreibung einer Erschütterung und die wichtigsten Handlungsanweisungen, wie z.B. Schutz unter einem Tisch zu suchen und nach dem Evakuierungsort zu fragen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Taifune und andere Naturkatastrophen (Taifū to hoka no shizen saigai - 台風と他の自然災害)",
        "keywords": "Taifun, starker Regen, starker Wind, Überschwemmung, Tsunami, Warnung, Taifū, Ōame, Kyōfū, Kōzui, Chūihō",
        "image_concept": "Ein niedlicher Charakter in einem gelben Regenmantel steht sicher im Inneren eines Hauses und schaut aus dem Fenster. Draußen ist stilisiertes, stürmisches Wetter mit wirbelndem Wind und starken Regentropfen zu sehen. Der Kontrast zwischen der sicheren, gemütlichen Innenseite und dem Unwetter draußen wird betont. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erweiterung des Themas Naturkatastrophen auf Taifune, Überschwemmungen und Tsunami-Warnungen. Die Studierenden lernen, Wetterwarnungen zu verstehen und grundlegende Fragen zur aktuellen Lage zu stellen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Unfälle und Verletzungen (Jiko to Kega - 事故と怪我)",
        "keywords": "Verletzung, Schmerz, Arzt, Krankenhaus, Apotheke, Medikamente, Kega, Itai, Isha, Byōin, Kusuri",
        "image_concept": "Ein niedlicher Anime-Charakter sitzt auf einer Parkbank und hat ein buntes Pflaster auf dem Knie. Ein anderer freundlicher Charakter reicht ihm eine kleine Erste-Hilfe-Box. Die Szene ist harmlos und betont die gegenseitige Hilfe bei kleinen Verletzungen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt persönliche Notfälle wie Unfälle und Verletzungen. Die Studierenden lernen, Schmerzen zu äußern, nach einem Arzt oder Krankenhaus zu fragen und grundlegende Bedürfnisse in einer Apotheke zu kommunizieren."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Verloren und gefunden (Michi ni mayoimashita - 道に迷いました)",
        "keywords": "verloren, Bahnhof, Hotel, Adresse, Polizeiwache, verloren und gefunden, Michi ni mayou, Eki, Hoteru, Jūsho, Kōban, Wasuremono",
        "image_concept": "Ein Anime-Tourist mit Rucksack und einer Karte in der Hand steht an einer Kreuzung in einer japanischen Stadt und schaut verwirrt drein. Im Hintergrund sind stilisierte Gebäude zu sehen, eine Mischung aus traditionell und modern. Der Fokus liegt auf dem Gesichtsausdruck der Verwirrung und des Suchens. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Ein häufiges Problem für Reisende: sich zu verlaufen oder etwas zu verlieren. Hier lernen die Studierenden, wie man sagt, dass man sich verirrt hat, wie man nach dem Weg fragt und wie man bei einer Polizeiwache (Kōban) nach verlorenen Gegenständen fragt."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Prävention und nützliche Fragen (Bōsai to yakudatsu shitsumon - 防災と役立つ質問)",
        "keywords": "Prävention, Notfall-Kit, sicher, Evakuierungsort, ist es in Ordnung?, Bōsai, Hijō-bukuro, Anzen, Hinanjo, Daijōbu desu ka?",
        "image_concept": "Ein fröhlicher Anime-Charakter packt einen leuchtend gelben Notfallrucksack (japanisches 'bōsai'-Kit). Man sieht, wie eine Flasche Wasser, eine Taschenlampe und ein eingepackter Reisball (Onigiri) in den offenen Rucksack gelegt werden. Der Charakter sieht vorbereitet und zuversichtlich aus. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese abschließende Seite fasst das Gelernte zusammen und legt den Schwerpunkt auf Prävention (Bōsai). Die Studierenden lernen, nach der Sicherheit zu fragen ('Daijōbu desu ka?'), sich nach dem Notfall-Kit zu erkundigen und proaktiv Informationen über Sicherheitsmaßnahmen einzuholen."
    }
]
