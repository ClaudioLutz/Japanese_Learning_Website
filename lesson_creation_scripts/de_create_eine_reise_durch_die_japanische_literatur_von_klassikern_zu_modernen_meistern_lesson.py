...
LESSON_DESCRIPTION = "Tauche ein in die faszinierende Welt der japanischen Literatur, von den höfischen Romanen der Heian-Zeit bis zu den modernen Meisterwerken. Lerne wichtige Begriffe und entdecke berühmte Autoren und ihre unvergesslichen Werke."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen der japanischen Literatur (Bungaku no Kiso - 文学の基礎)",
        "keywords": "Literatur, 文学, bungaku, Genre, ジャンル, janru, Roman, 小説, shōsetsu, Gedicht, 詩, shi, Autor, 作家, sakka, Prosa, 散文, sanbun",
        "image_concept": "Ein freundlicher Anime-Charakter in der Rolle eines Bibliothekars steht vor einem großen, eleganten Holzregal, das mit japanisch gebundenen Büchern gefüllt ist. Der Charakter hält ein offenes Buch mit leeren Seiten in der Hand und lächelt den Betrachter einladend an. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen grundlegendes Vokabular, um über Literatur zu sprechen. Es werden die wichtigsten Genres wie Roman (shōsetsu), Gedicht (shi) und Essay (zuihitsu) vorgestellt und voneinander abgegrenzt."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die Klassiker der Heian-Zeit (Heian-jidai no Koten - 平安時代の古典)",
        "keywords": "Heian-Zeit, 平安時代, Heian-jidai, Genji Monogatari, 源氏物語, Murasaki Shikibu, 紫式部, Kopfkissenbuch, 枕草子, Makura no Sōshi, Hofkultur, 宮廷文化, kyūtei bunka",
        "image_concept": "Eine elegante Anime-Hofdame im Stil der Heian-Zeit (jūnihitoe-Gewand) sitzt an einem niedrigen Schreibtisch und hält einen Schreibpinsel. Sie blickt nachdenklich aus einem offenen Fenster in einen Garten mit blühenden Kirschblüten. Vor ihr liegt eine leere Schriftrolle. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf die goldene Ära der klassischen japanischen Literatur. Die Studierenden lernen das 'Genji Monogatari', oft als der erste Roman der Welt bezeichnet, und die bedeutende Rolle von Hofdamen wie Murasaki Shikibu und Sei Shōnagon kennen."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Die Kunst der kurzen Form: Haiku & Tanka (Tanshi no Geijutsu: Haiku to Tanka - 短詩の芸術：俳句と短歌)",
        "keywords": "Haiku, 俳句, Tanka, 短歌, Kigo, 季語, Jahreszeitenwort, Matsuo Bashō, 松尾芭蕉, 5-7-5, Ästhetik, 美学, bigaku",
        ...
        "content_focus": "Hier lernen die Studierenden die berühmtesten japanischen Gedichtformen kennen. Die Struktur von Haiku (5-7-5 Silben) und Tanka (5-7-5-7-7 Silben) wird erklärt, ebenso wie das wichtige Konzept des 'kigo' (Jahreszeitenwort) am Beispiel von Matsuo Bashō."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Aufbruch in die Moderne: Die Meiji-Literatur (Kindai e no Tobira: Meiji Bungaku - 近代への扉：明治文学)",
        "keywords": "Meiji-Zeit, 明治時代, Meiji-jidai, Natsume Sōseki, 夏目漱石, Mori Ōgai, 森鷗外, Ich-Roman, 私小説, shishōsetsu, Verwestlichung, 西洋化, seiyōka",
        "image_concept": "Ein Anime-Charakter in typischer Meiji-Kleidung (eine Mischung aus Kimono und westlichen Elementen wie Stiefeln oder Hut) steht auf einer alten Holzbrücke. Im Hintergrund fährt eine Dampflokomotive vorbei, die den Übergang zur Moderne symbolisiert. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt den literarischen Wandel während der Meiji-Restauration. Die Studierenden entdecken, wie der Einfluss des Westens neue literarische Formen wie den 'Ich-Roman' (Shishōsetsu) hervorbrachte und lernen wegweisende Autoren wie Natsume Sōseki kennen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Nachkriegs- und Gegenwartsliteratur (Sengo to Gendai no Bungaku - 戦後と現代の文学)",
        "keywords": "Nachkriegszeit, 戦後, sengo, Gegenwartsliteratur, 現代文学, gendai bungaku, Murakami Haruki, 村上春樹, Mishima Yukio, 三島由紀夫, magischer Realismus",
        "image_concept": "Ein moderner Anime-Charakter sitzt in einem stilvollen Café in Tokio und liest ein dickes Buch mit neutralem Einband. Durch das große Fenster hinter ihm sieht man eine surreale Straßenszene, z. B. Katzen, die auf zwei Beinen gehen, was auf den magischen Realismus anspielt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden erhalten einen Einblick in die Themen und Stile der japanischen Literatur nach dem Zweiten Weltkrieg bis heute. Der Fokus liegt auf international bekannten Autoren wie Yukio Mishima und dem Phänomen Haruki Murakami mit seinem einzigartigen Stil."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Japanische Literaturnobelpreisträger (Nihon no Nōberu Bungakushō Jushōsha - 日本のノーベル文学賞受賞者)",
        "keywords": "Nobelpreis, ノーベル賞, Nōberu-shō, Kawabata Yasunari, 川端康成, Ōe Kenzaburō, 大江健三郎, Ishiguro Kazuo, 石黒一雄, Auszeichnung, 受賞, jushō",
        "image_concept": "Drei verschiedene, niedliche Anime-Charaktere, die die Nobelpreisträger repräsentieren, stehen elegant gekleidet auf einer Bühne. Jeder von ihnen hält stolz eine goldene Medaille in der Hand (ohne jegliche Gravur). Der Hintergrund ist festlich mit Vorhängen und gedämpftem Licht. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite würdigt die japanischen Autoren, die mit dem Nobelpreis für Literatur ausgezeichnet wurden. Die Studierenden lernen die Namen von Kawabata Yasunari, Ōe Kenzaburō und dem britisch-japanischen Autor Kazuo Ishiguro sowie die Bedeutung dieser höchsten literarischen Ehre kennen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Von Literatur zu Manga & Anime (Bungaku kara Manga Anime e - 文学から漫画・アニメへ)",
        "keywords": "Adaption, 翻案, hon'an, Light Novel, ライトノベル, raito noberu, Vorlage, 原作, gensaku, Popkultur, ポップカルチャー, Bungo Stray Dogs, 文豪ストレイドッグス",
        "image_concept": "Zwei Anime-Teenager sitzen nebeneinander auf dem Boden. Ein Charakter liest ein alt aussehendes, gebundenes Buch, der andere ein modernes Manga-Heft (beide Cover sind leer). Über ihren Köpfen befinden sich zwei Gedankenblasen: Eine zeigt einen Samurai, die andere eine Heldin im Anime-Stil, um die Verbindung zwischen klassischer Erzählung und modernem Medium zu visualisieren. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss wird die Brücke zur modernen Popkultur geschlagen. Die Studierenden erfahren, wie klassische literarische Werke und sogar die Autoren selbst als Inspiration und Vorlage (gensaku) für beliebte Manga, Light Novels und Anime dienen."
    }
]
