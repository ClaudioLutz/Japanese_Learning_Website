...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Zeitreise durch Japan: Ausdrücke für Geschichte und Kulturerbe\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Zeitreise durch Japan: Ausdrücke für Geschichte und Kulturerbe"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Entdecke die faszinierende Vergangenheit Japans! In dieser Lektion lernst du wichtige Vokabeln und Ausdrücke, um über historische Epochen, berühmte Wahrzeichen und das reiche Kulturerbe Japans zu sprechen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundbegriffe der Geschichte (Rekishi no Kihon Yōgo - 歴史の基本用語)",
        "keywords": "Geschichte, 歴史, Kultur, 文化, Tradition, 伝統, Epoche, 時代, Land, 国",
        "image_concept": "Ein niedlicher Tanuki-Charakter im Anime-Stil sitzt unter einem Kirschblütenbaum und liest neugierig in einer sehr alten, großen Schriftrolle, die auf seinem Schoß liegt. Die Schriftrolle selbst ist leer. Der Hintergrund ist ein einfacher, heller Himmel. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite lernen die Studenten die grundlegendsten Vokabeln, um über Geschichte und Kultur zu sprechen. Dies bildet die Basis für das Verständnis der folgenden, spezifischeren Themen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Wichtige Geschichtsepochen (Shuyō na Jidai - 主要な時代)",
        "keywords": "Edo-Zeit, 江戸時代, Meiji-Zeit, 明治時代, Heian-Zeit, 平安時代, Sengoku-Zeit, 戦国時代, Periode",
        "image_concept": "Eine chronologische Darstellung im Manga-Stil. Ein niedlicher Anime-Charakter geht auf einem Pfad von links nach rechts. Der Hintergrund hinter ihm verändert sich fließend, um verschiedene Epochen darzustellen: links eine Szene mit Hofadligen im Heian-Stil, in der Mitte eine Samurai-Festung der Sengoku-Zeit und rechts eine belebte Straße mit Holzhäusern aus der Edo-Zeit. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studenten lernen die Namen und die ungefähre zeitliche Einordnung der bekanntesten japanischen Geschichtsepochen. Der Fokus liegt auf den Perioden, die die japanische Kultur maßgeblich geprägt haben."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Historische Persönlichkeiten (Rekishi-jō no Jinbutsu - 歴史上の人物)",
        "keywords": "Samurai, 侍, Shōgun, 将軍, Kaiser, 天皇, Ninja, 忍者, Krieger, 武士",
        "image_concept": "Eine Gruppe von vier niedlichen Chibi-Charakteren, die historische Figuren repräsentieren, posieren freundlich zusammen. Ein tapferer Samurai mit einem Holzschwert, ein würdevoller Shōgun mit einem Fächer, ein gelassener Kaiser in traditioneller Hofkleidung und ein schelmischer Ninja, der hinter den anderen hervorlugt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier werden die Vokabeln für zentrale Figuren der japanischen Geschichte vorgestellt. Die Studenten lernen, diese wichtigen sozialen Rollen zu benennen und zu verstehen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Burgen, Tempel und Schreine (Shiro, Tera, Jinja - 城、寺、神社)",
        "keywords": "Burg, 城, Tempel, 寺, Schrein, 神社, Pagode, 塔, Torii, 鳥居",
        "image_concept": "Eine dreigeteilte Szene. Links steht eine majestätische japanische Burg auf einem Hügel. In der Mitte ist ein ruhiger buddhistischer Tempel mit einer fünfstöckigen Pagode abgebildet. Rechts sieht man den Eingang zu einem Shinto-Schrein mit einem ikonischen, leuchtend roten Torii-Tor. Ein niedliches Anime-Mädchen in moderner Kleidung schaut sich jeden Ort an. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studenten lernen, die drei wichtigsten Arten historischer Bauten zu unterscheiden und zu benennen: Burgen (Machtzentren), Tempel (buddhistisch) und Schreine (shintoistisch)."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Kulturerbe und UNESCO (Bunkaisan to Yunesuko - 文化遺産とユネスコ)",
        "keywords": "Kulturgut, 文化財, Nationalschatz, 国宝, Weltkulturerbe, 世界遺産, wichtig, 重要",
        "image_concept": "Ein niedlicher Hirsch-Charakter (in Anlehnung an Nara) steht stolz vor einer vereinfachten, aber erkennbaren Darstellung des Goldenen Pavillons (Kinkaku-ji). Der Hirsch trägt eine goldene Medaille um den Hals, auf der eine stilisierte Weltkugel eingraviert ist. Der Hintergrund ist ein ruhiger See, der den Pavillon spiegelt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite führt Begriffe ein, die den Wert und die Klassifizierung von historischen Stätten und Objekten beschreiben, einschließlich der international bekannten UNESCO-Welterbestätten."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Historische Ereignisse und Konzepte (Rekishi-teki na Dekigoto to Gainen - 歴史的な出来事と概念)",
        "keywords": "Landesabschließung, 鎖国, Meiji-Restauration, 明治維新, Restauration, 維新, Ereignis, 出来事",
        "image_concept": "Eine symbolische Darstellung von 'Sakoku'. Auf der linken Seite steht ein niedlicher Chibi-Samurai vor einem großen, geschlossenen Holztor, das Japan symbolisiert. Auf der rechten Seite schaut ein niedlicher Anime-Charakter in westlicher Kleidung des 19. Jahrhunderts neugierig über eine Mauer in Richtung des Tores. Die Szene ist hell und nicht bedrohlich. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studenten lernen Vokabeln für abstraktere Konzepte und spezifische historische Wendepunkte, wie die selbstgewählte Isolation Japans (Sakoku) und die darauffolgende Modernisierung (Meiji-Restauration)."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Über Geschichte sprechen (Rekishi ni tsuite Hanasu - 歴史について話す)",
        "keywords": "sich interessieren für, に興味がある, berühmt, 有名, besichtigen, 見学する, empfehlen, おすすめ",
        "image_concept": "Zwei niedliche Anime-Charaktere, ein europäisch aussehender Tourist mit Rucksack und eine japanische Freundin im Kimono, stehen in einem schönen japanischen Garten. Der Tourist zeigt begeistert auf eine Burg in der Ferne, während die japanische Freundin lächelt und mit einer offenen Geste etwas erklärt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss lernen die Studenten praktische Satzmuster und Verben, um ihr Interesse an Geschichte auszudrücken, nach Empfehlungen zu fragen und historische Orte zu beschreiben."
    }
]
