...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Japanische Popkultur & Unterhaltung: Sprich wie ein Fan\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Japanische Popkultur & Unterhaltung: Sprich wie ein Fan"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Tauche tief in die Welt von Anime, Manga und J-Pop ein! Lerne, wie du deine Lieblingsserien beschreiben, Empfehlungen aussprechen und fließend über japanische Stars und Unterhaltung sprechen kannst."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Genres und Medienformen (Janru to Media - ジャンルとメディア)",
        "keywords": "Anime アニメ, Manga 漫画, Light Novel ライトノベル, Videospiel テレビゲーム, J-Pop, Shōnen 少年, Shōjo 少女, Seinen 青年, Josei 女性",
        "image_concept": "Ein gemütliches Zimmer im niedlichen Manga/Anime-Stil. Auf einem Regal stehen mehrere Manga-Bände nebeneinander. Auf einem Schreibtisch steht ein Fernseher, auf dem eine actionreiche, aber generische Anime-Szene läuft. Daneben liegen ein Videospiel-Controller und Kopfhörer. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die grundlegenden Vokabeln, um verschiedene Arten japanischer Unterhaltungsmedien wie Anime, Manga, Light Novels und Musikgenres zu identifizieren und zu benennen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Vorlieben ausdrücken (Suki na Mono o Tsutaeru - 好きなものを伝える)",
        "keywords": "mögen 好き, lieben 大好き, Lieblings- 一番好きな, nicht mögen 嫌い, interessant 面白い, süß かわいい, cool かっこいい",
        "image_concept": "Ein jugendlicher Charakter im niedlichen Manga/Anime-Stil, der begeistert auf ein Poster an seiner Wand blickt. Das Poster zeigt die Silhouette eines coolen, heldenhaften Charakters. Der jugendliche Charakter hat Herzen in den Augen und eine verträumte, glückliche Miene. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen, ihre Vorlieben und Abneigungen auszudrücken. Sie üben Sätze wie „Ich mag [Anime-Name]“ (「[Anime-Name]」が好きです) und „Mein Lieblingscharakter ist...“ (一番好きなキャラは…です)."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Eindrücke und Bewertungen (Kansō to Hyōka - 感想と評価)",
        "keywords": "interessant 面白い, langweilig つまらない, traurig 悲しい, bewegend 感動的, lustig おかしい, gruselig 怖い, die Handlung ストーリー, die Zeichnung 絵",
        "image_concept": "Zwei Freunde im niedlichen Manga/Anime-Stil sitzen auf einem Sofa vor einem Fernseher. Der Fernseher selbst ist nicht im Fokus und der Bildschirm ist leer. Ein Freund lacht Tränen, während der andere sich mit einem Taschentuch eine Träne aus dem Auge wischt, was auf eine emotional intensive Szene hindeutet. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen Adjektive und Ausdrücke, um ihre Meinung über ein Werk zu äußern. Sie lernen, über die Handlung, die Charaktere und die Atmosphäre zu sprechen und eine einfache Bewertung abzugeben."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Idole und Synchronsprecher (Aidoru to Seiyū - アイドルと声優)",
        "keywords": "Idol アイドル, Synchronsprecher 声優, Fan ファン, Lieblingsmitglied 推し (Oshi), Konzert ライブ, Debüt デビュー, gutaussehend イケメン, süße Stimme かわいい声",
        "image_concept": "Eine zweigeteilte Szene im niedlichen Manga/Anime-Stil. Auf der linken Seite eine hell erleuchtete Konzertbühne, auf der die Silhouetten einer Pop-Idol-Gruppe in dynamischen Posen tanzen. Auf der rechten Seite ein Synchronsprecher in einem Aufnahmestudio, der mit Kopfhörern vor einem Mikrofon steht und leidenschaftlich spricht. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite widmet sich den wichtigen kulturellen Phänomenen der Idols und Seiyū (Synchronsprecher). Die Studierenden lernen spezifisches Vokabular und das kulturelle Konzept des „Oshi“ (推し), des favorisierten Idols oder Charakters."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Empfehlungen geben und erfragen (Osusume o Suru/Kiku - おすすめをする・聞く)",
        "keywords": "empfehlen おすすめ, hast du gesehen? 見たことある？, unbedingt ansehen ぜひ見て, was empfiehlst du? おすすめは何？, nächstes Mal 今度",
        "image_concept": "Zwei Charaktere im niedlichen Manga/Anime-Stil stehen sich gegenüber. Ein Charakter hält dem anderen begeistert sein Smartphone hin. Der Bildschirm des Smartphones zeigt ein generisches App-Layout ohne Text oder erkennbare Marken. Der andere Charakter schaut neugierig und interessiert auf das Handy. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen, wie man nach Empfehlungen fragt und selbst welche gibt. Sie üben Konversationsphrasen wie „Was empfiehlst du?“ (おすすめは何ですか？) und „Du solltest dir unbedingt [Film] ansehen“ (ぜひ[映画]を見てください)."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Über Filme und Dramen sprechen (Eiga to Dorama - 映画とドラマ)",
        "keywords": "Film 映画, Drama/Serie ドラマ, Schauspieler 俳優, Schauspielerin 女優, Regisseur 監督, Hauptrolle 主演, Spezialeffekte 特撮 (Tokusatsu)",
        "image_concept": "Mehrere Charaktere im niedlichen Manga/Anime-Stil sitzen in Kinosesseln und schauen auf eine leere, leuchtende Kinoleinwand. Sie tragen 3D-Brillen und halten Popcorn und Getränke in den Händen. Ihre Gesichter zeigen Vorfreude und Spannung. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Der Fokus erweitert sich auf Realverfilmungen. Die Studierenden lernen Vokabular, um über Kinofilme und TV-Serien (Dorama) zu sprechen, einschließlich der Bezeichnungen für Schauspieler, Regisseure und Hauptrollen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Fankultur und Events (Fan Bunka to Ibento - ファン文化とイベント)",
        "keywords": "Otaku オタク, Fan-Artikel グッズ (Goods), Convention コミケ (Comiket), Cosplay コスプレ, Doujinshi 同人誌, Event イベント, limitierte Auflage 限定品",
        "image_concept": "Eine lebhafte Szene in einer großen Halle, die an eine Convention erinnert. Im Vordergrund steht ein Charakter in einem aufwendigen, aber generischen Cosplay-Kostüm. Ein anderer Charakter hält stolz eine Tasche voller Merchandise (kleine Plüschtiere, Schlüsselanhänger ohne erkennbare Gesichter oder Symbole). Im Hintergrund sind unscharfe Stände und andere Besucher zu sehen. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden tauchen in die Welt der japanischen Fankultur ein. Sie lernen Begriffe wie „Otaku“, „Goods“ (Fan-Artikel) und „Cosplay“ und verstehen die Bedeutung von Fan-Events wie der Comiket."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        # Find category
        category = LessonCategory.query.filter_by(name="Popkultur & Modernes Japan").first()
        if not category:
            print(f"[WARNING] Category 'Popkultur & Modernes Japan' not found. Defaulting to 'Sprachgrundlagen'.")
