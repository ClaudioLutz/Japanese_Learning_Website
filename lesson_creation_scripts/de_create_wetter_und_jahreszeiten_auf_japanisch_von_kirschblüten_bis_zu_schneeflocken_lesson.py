...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Wetter und Jahreszeiten auf Japanisch: Von Kirschblüten bis zu Schneeflocken\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Wetter und Jahreszeiten auf Japanisch: Von Kirschblüten bis zu Schneeflocken"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Lerne, wie du das Wetter in Japan beschreibst und über die vier ausgeprägten Jahreszeiten sprichst. Von alltäglichen Gesprächen bis hin zu saisonalen Besonderheiten – diese Lektion macht dich fit für den Smalltalk über das Wetter und vertieft dein kulturelles Verständnis."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundwortschatz zum Wetter (Tenki no Kihon Tango - 天気の基本単語)",
        "keywords": "sonnig, hare, 晴れ, wolkig, kumori, 曇り, regnerisch, ame, 雨, Schnee, yuki, 雪, windig, kaze, 風, Wetter, tenki, 天気",
        "image_concept": "Eine Sammlung von niedlichen Wetter-Ikonen im Kawaii-Stil. Eine lächelnde Sonne, eine schüchterne Wolke, ein weinender Regentropfen, eine fröhliche Schneeflocke und ein pustender Windgeist. Alle Symbole sind klar voneinander getrennt und haben ausdrucksstarke Gesichter. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die grundlegenden japanischen Wörter zur Beschreibung des Wetters. Dies umfasst Substantive und Zustände wie Sonne, Wolken, Regen und Wind, um eine solide Vokabelbasis zu schaffen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die vier Jahreszeiten (Shiki - 四季)",
        "keywords": "Jahreszeiten, kisetsu, 季節, Frühling, haru, 春, Sommer, natsu, 夏, Herbst, aki, 秋, Winter, fuyu, 冬",
        "image_concept": "Ein schöner Kreis, der in vier Viertel unterteilt ist und die vier Jahreszeiten Japans darstellt. Das Frühlingsviertel zeigt blühende Kirschblütenbäume (Sakura). Das Sommerviertel zeigt einen üppig grünen Bambuswald und einen Strand. Das Herbstviertel leuchtet in den Farben roter und oranger Ahornblätter. Das Winterviertel zeigt eine schneebedeckte Landschaft mit einem traditionellen japanischen Haus. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Einführung in die Namen der vier Jahreszeiten auf Japanisch. Die Studierenden lernen, jede Jahreszeit zu benennen und mit ihren typischen visuellen Merkmalen in Japan zu verbinden."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Nach dem Wetter fragen (Tenki o Kiku - 天気を聞く)",
        "keywords": "Wie ist das Wetter?, tenki wa dou desu ka, 天気はどうですか, heute, kyou, 今日, es ist sonnig, hare desu, 晴れです, Wettervorhersage, tenki yohou, 天気予報",
        "image_concept": "Zwei sympathische Anime-Charaktere, ein Junge und ein Mädchen in moderner Kleidung, stehen im Freien. Der Junge zeigt mit einer fragenden Geste zum Himmel. Das Mädchen schaut nach oben zu einer strahlenden Sonne und antwortet mit einem Lächeln. Die Szene vermittelt eine freundliche Gesprächssituation. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die grundlegende Frage- und Antwortstruktur, um über das aktuelle Wetter zu sprechen. Dies beinhaltet die Frage „Wie ist das Wetter heute?“ und einfache Antworten wie „Heute ist es sonnig.“."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Temperatur und Empfindungen (Kion to Kankaku - 気温と感覚)",
        "keywords": "heiß, atsui, 暑い, kalt, samui, 寒い, kühl, suzushii, 涼しい, warm, atatakai, 暖かい, schwül, mushiatsui, 蒸し暑い, Temperatur, kion, 気温",
        "image_concept": "Vier verschiedene Kawaii-Charaktere in einer Reihe, die unterschiedliche Temperaturempfindungen zeigen. Der erste schwitzt stark und fächelt sich mit einem Fächer unter der heißen Sonne. Der zweite zittert und ist in einen dicken Schal und eine Mütze gehüllt. Der dritte sitzt entspannt unter einem Baum und genießt eine kühle Brise. Der vierte sieht unglücklich und klebrig aus, umgeben von einer feuchten, drückenden Atmosphäre. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erweiterung des Vokabulars um Adjektive zur Beschreibung von Temperatur und persönlichem Empfinden. Die Studierenden lernen die wichtigen Unterschiede zwischen 'atsui' (heißes Wetter) und 'samui' (kaltes Wetter) sowie nuanciertere Begriffe wie 'suzushii' (angenehm kühl) und 'mushiatsui' (schwül)."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Besondere Wetterphänomene: Regenzeit & Taifun (Tokubetsu na Tenki: Tsuyu to Taifuu - 特別な天気: 梅雨と台風)",
        "keywords": "Regenzeit, tsuyu, 梅雨, Taifun, taifuu, 台風, starker Regen, ooame, 大雨, starker Wind, kyoufuu, 強風, Regenschirm, kasa, 傘",
        "image_concept": "Eine zweigeteilte Szene. Auf der linken Seite steht ein Charakter in einem durchsichtigen Regenmantel mit einem bunten Regenschirm unter starkem, strömendem Regen, der die Regenzeit (Tsuyu) darstellt. Auf der rechten Seite eine stilisierte, dramatische Darstellung eines Taifuns mit wirbelnden Wolken und Wind über dem Meer, der sich einer kleinen japanischen Insel nähert. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen spezifische japanische Wetterereignisse kennen: die Regenzeit (Tsuyu) im Frühsommer und die Taifun-Saison. Sie lernen das relevante Vokabular, um diese Phänomene zu beschreiben und ihre kulturelle Bedeutung zu verstehen."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Saisonalen Aktivitäten und Feste (Kisetsu no Ibento - 季節のイベント)",
        "keywords": "Kirschblütenschau, hanami, 花見, Herbstlaubschau, momijigari, 紅葉狩り, Sommerfest, natsu matsuri, 夏祭り, Schneefest, yuki matsuri, 雪まつり, Feuerwerk, hanabi, 花火",
        "image_concept": "Eine fröhliche Collage aus vier kleinen Szenen, die saisonale Aktivitäten zeigen. Oben links: Charaktere, die unter blühenden Kirschbäumen picknicken (Hanami). Oben rechts: Ein Charakter in einem Yukata schaut zu einem bunten Feuerwerk am Nachthimmel (Matsuri/Hanabi). Unten links: Ein Charakter fotografiert leuchtend rote Ahornblätter in einem Park (Momijigari). Unten rechts: Charaktere bauen einen niedlichen Schneemann neben einer Schneelaterne (Yuki Matsuri). Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Verbindung von Sprache und Kultur durch die Vorstellung von Aktivitäten, die eng mit den Jahreszeiten verbunden sind. Die Studierenden lernen Wörter für berühmte saisonale Ereignisse wie Hanami im Frühling, Sommerfeste, Momijigari im Herbst und Schneefeste im Winter."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Über das Klima sprechen (Kikou ni Tsuite Hanasu - 気候について話す)",
        "keywords": "Klima, kikou, 気候, Region, chihou, 地方, Hokkaido, 北海道, Okinawa, 沖縄, Wettervorhersage, tenki yohou, 天気予報, Grad, do, 度",
        "image_concept": "Eine niedliche und vereinfachte Karte des japanischen Archipels. Ein freundlicher Anime-Wetterfrosch-Charakter mit einem Zeigestab deutet auf verschiedene Regionen. Über Hokkaido schwebt eine Schneeflocke. Über der Region Tokio schwebt eine Wolke mit Regentropfen. Über Okinawa strahlt eine große, helle Sonne. Dies visualisiert die klimatischen Unterschiede im Land. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zusammenfassung und Erweiterung des Gelernten, um über das Klima im Allgemeinen zu sprechen. Die Studierenden lernen, wie man regionale Klimaunterschiede in Japan beschreibt (z.B. das kalte Hokkaido im Vergleich zum subtropischen Okinawa) und wie man eine Wettervorhersage besser versteht."
    }
]
