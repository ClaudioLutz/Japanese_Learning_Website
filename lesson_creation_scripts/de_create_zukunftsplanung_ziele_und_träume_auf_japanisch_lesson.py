...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Zukunftsplanung: Ziele und Träume auf Japanisch\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Zukunftsplanung: Ziele und Träume auf Japanisch"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Lerne, wie du deine Träume, Pläne und Wünsche fließend auf Japanisch ausdrücken kannst. Von der Studienwahl bis zu beruflichen Zielen – diese Lektion gibt dir die Werkzeuge an die Hand, um überzeugend über deine Zukunft zu sprechen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Einfache Wünsche: Was möchtest du tun? - 〜たいです (tai desu)",
        "keywords": "Wunsch, wollen, 〜たい (tai), 〜たくない (takunai), reisen, essen, sehen, したい (shitai)",
        "image_concept": "Eine fröhliche junge Person sitzt an einem Schreibtisch und träumt vor sich hin. Über ihrem Kopf sind drei kleine, stilisierte Traumblasen zu sehen: eine mit dem Berg Fuji, eine mit einer Schale Ramen und eine mit einem Shinkansen-Zug. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In dieser Einführung lernst du die 〜たい (tai)-Form, um auszudrücken, was du tun möchtest. Wir behandeln die Konjugation für Verben und üben, einfache Sätze über persönliche Wünsche zu bilden, wie z.B. „Ich möchte nach Japan reisen“."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Feste Absichten: Was hast du vor? - 〜つもりです (tsumori desu)",
        "keywords": "Absicht, Plan, 〜つもりです (tsumori desu), Zukunft, vorhaben, sparen, studieren, 計画 (keikaku)",
        "image_concept": "Eine entschlossen aussehende Person steht vor einer großen Weltkarte an der Wand. Sie hält einen Stift in der Hand und hat gerade einen Kreis um Japan gezeichnet. Neben der Karte steht ein Sparschwein. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernst du die Grammatikform 〜つもりです (tsumori desu), um feste Pläne und Absichten auszudrücken. Du wirst den Unterschied zwischen einem einfachen Wunsch (〜たい) und einer konkreten Absicht (〜つもり) verstehen und lernen, über deine Zukunftspläne zu sprechen."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Vorsätze und Entschlüsse - 〜ようと思います (yō to omoimasu)",
        "keywords": "Vorsatz, Entschluss, Volitionalform, 〜ようと思う (yō to omou), versuchen, anfangen, beschließen, 決心 (kesshin)",
        "image_concept": "Eine Figur liest ein Buch über Japan. Plötzlich hat sie einen 'Aha-Moment', eine leuchtende Glühbirne erscheint über ihrem Kopf. Ihr Gesichtsausdruck ist inspiriert und motiviert, als hätte sie gerade einen wichtigen Entschluss gefasst. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt die Volitionalform + と思います (to omoimasu), um einen Entschluss oder einen etwas weniger festen Vorsatz auszudrücken. Dies ist nützlich, um über Pläne zu sprechen, die man gerade fasst, oder über persönliche Neujahrsvorsätze."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Große Träume und Lebensziele - 夢と目標 (yume to mokuhyō)",
        "keywords": "Traum, Ziel, Beruf, werden, 夢 (yume), 目標 (mokuhyō), 将来の夢 (shōrai no yume), 医者 (isha), 先生 (sensei)",
        "image_concept": "Eine Person blickt nachdenklich in einen wunderschönen Nachthimmel voller Sterne. Einige Sternbilder haben die Form von beruflichen Symbolen angenommen: ein Stethoskop, ein Pinsel und eine Filmkamera. Die Stimmung ist hoffnungsvoll und inspirierend. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Jetzt geht es um die großen Lebensträume. Du lernst das Vokabular für Träume (夢, yume) und Ziele (目標, mokuhyō) und wie man Sätze formuliert wie „Mein Traum ist es, ... zu werden.“ Wir stellen Vokabeln für verschiedene Berufe und Lebensziele vor."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Eine Veränderung beschreiben: „Werden“ - 〜になります (ni narimasu)",
        "keywords": "werden, 〜になる (ni naru), 〜くなります (ku naru), Beruf, Zustand, Veränderung, Arzt werden, Lehrer werden",
        "image_concept": "Ein geteiltes Bild: Auf der linken Seite sitzt ein junger Student an einem Schreibtisch und lernt fleißig, umgeben von Büchern. Auf der rechten Seite ist dieselbe Person, nun etwas älter und selbstbewusst lächelnd, in professioneller Kleidung (z.B. Arztkittel oder Anzug) in einem modernen Büro. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Um auszudrücken, dass man etwas wird (z.B. einen Beruf ergreift), braucht man die Grammatik 〜になります (ni narimasu). Auf dieser Seite lernst du, wie man diese Form mit Substantiven und Adjektiven verwendet, um Veränderungen und das Erreichen von Zielen zu beschreiben."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Hoffnung für die Zukunft ausdrücken - 希望と将来 (kibō to shōrai)",
        "keywords": "Hoffnung, Zukunft, hoffen, Aussicht, 希望 (kibō), 将来 (shōrai), 〜といいですね (to ii desu ne), 期待 (kitai)",
        "image_concept": "Eine Figur steht an einer Weggabelung. Ein Weg führt zu einer traditionellen japanischen Tempelanlage, ein anderer zu einer hypermodernen Stadtkulisse mit Wolkenkratzern und der dritte in eine ruhige, ländliche Landschaft. Die Person schaut nachdenklich, aber optimistisch in die Ferne. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier vertiefen wir dein Vokabular mit Wörtern wie 希望 (kibō, Hoffnung) und 将来 (shōrai, Zukunft). Du lernst fortgeschrittenere und formellere Ausdrücke, um über deine Hoffnungen und Erwartungen für die Zukunft zu sprechen und anderen viel Glück zu wünschen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Kultureller Einblick: Karrierewege in Japan - 進路と就活 (shinro to shūkatsu)",
        "keywords": "Karriereweg, Jobsuche, 進路 (shinro), 就活 (shūkatsu), Lebensplanung, Arbeitskultur, リクルートスーツ (rikurūto sūtsu)",
        "image_concept": "Eine Gruppe von drei jungen Hochschulabsolventen (zwei Männer, eine Frau) in typischen schwarzen oder dunkelblauen Jobsuche-Anzügen (リクルートスーツ, rikurūto sūtsu). Sie stehen zusammen, lächeln sich gegenseitig ermutigend zu und blicken zuversichtlich nach vorne, im Hintergrund eine moderne Skyline. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite bietet einen kulturellen Einblick in die Zukunftsplanung in Japan. Wir erklären die Bedeutung von 進路 (shinro, Bildungs-/Karriereweg) in der Schule und den einzigartigen, hochstrukturierten Prozess der Jobsuche für Universitätsabsolventen, bekannt als 就活 (shūkatsu)."
    }
]
