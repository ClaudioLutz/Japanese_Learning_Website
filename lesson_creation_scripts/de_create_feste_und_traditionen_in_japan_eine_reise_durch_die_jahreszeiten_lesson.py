...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Feste und Traditionen in Japan: Eine Reise durch die Jahreszeiten\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Feste und Traditionen in Japan: Eine Reise durch die Jahreszeiten"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Entdecke die farbenfrohe Welt der japanischen Feste! Lerne wichtiges Vokabular und kulturelle Hintergründe zu berühmten Ereignissen wie der Kirschblütenschau (Hanami), dem Sternenfest (Tanabata) und dem Ahnenfest (Obon). Mach dich bereit, Japan von seiner festlichsten Seite kennenzulernen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Einführung in japanische Feste (Matsuri no Shōkai - 祭りの紹介)",
        "keywords": "Matsuri, 祭り, Fest, Feier, Schrein, Jinja, 神社, Tempel, O-tera, お寺, Ursprung, Herkunft",
        "image_concept": "Eine lebhafte Szene bei Dämmerung, die eine vielfältige Gruppe von Menschen zeigt, die auf ein großes, beleuchtetes Torii-Tor eines Schreins zugehen. Einige Personen tragen traditionelle Yukata, andere moderne Kleidung. Im Hintergrund sind angedeutete, bunte Festivalstände (Yatai) ohne erkennbare Details oder Schrift zu sehen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite lernen die Studierenden die grundlegende Bedeutung des Begriffs 'Matsuri' kennen. Es wird der Unterschied zwischen gemeinschaftlichen, shintoistischen Festen und ruhigeren, buddhistischen Traditionen erklärt. Zudem werden allgemeine Vokabeln eingeführt, die für fast alle Feste relevant sind."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Der Frühling: Die Kirschblütenschau (Haru: Hanami - 春: 花見)",
        "keywords": "Hanami, 花見, Kirschblüte, Sakura, 桜, Picknick, Kouen, 公園, Bento, 弁当, blühen, saku, 咲く",
        "image_concept": "Eine fröhliche Gruppe von Freunden im Anime-Stil, die auf einer blauen Decke unter einem prächtig blühenden Kirschbaum sitzen. Eine Person hält eine geöffnete, detailreiche Bento-Box hoch (ohne Schrift), eine andere gießt Tee ein. Strahlender Sonnenschein und eine heitere Atmosphäre. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier konzentrieren wir uns auf das berühmteste Frühlingsereignis: Hanami. Die Lernenden eignen sich Vokabular rund um das Betrachten der Kirschblüten, das Picknicken im Park und die typischen Speisen (Bento) an. Kulturell wird die Vergänglichkeit als zentrales Thema beleuchtet."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Der Sommer: Das Sternenfest (Natsu: Tanabata - 夏: 七夕)",
        "keywords": "Tanabata, 七夕, Wunsch, Negai, 願い, Wunschzettel, Tanzaku, 短冊, Bambus, Sasa, 笹, Milchstraße, Amanogawa, 天の川",
        "image_concept": "Zwei niedliche Hauptfiguren im Anime-Stil, die Orihime (im Kimono) und Hikoboshi (einfache Kleidung) darstellen. Sie stehen an den Ufern eines stilisierten, glitzernden Flusses (die Milchstraße) und strecken die Hände nacheinander aus. Im Vordergrund ein Bambusast mit vielen bunten Papierstreifen. Sternenklarer Nachthimmel. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt die romantische Legende von Tanabata. Die Studierenden lernen, wie man Wünsche formuliert und Vokabeln, die mit den Traditionen verbunden sind, wie das Aufhängen von Wunschzetteln (Tanzaku) an Bambusäste."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Sommerhöhepunkt: Ahnenfest und Feuerwerk (Natsu: Obon to Hanabi - 夏: お盆と花火)",
        "keywords": "Obon, お盆, Ahnen, Gosenzo-sama, ご先祖様, Bon-Tanz, Bon Odori, 盆踊り, Laterne, Chōchin, 提灯, Feuerwerk, Hanabi, 花火",
        "image_concept": "Eine warme Abend-Szene. Eine Gruppe von Menschen in bunten Yukata tanzt fröhlich im Kreis (Bon Odori) um einen hölzernen Turm (Yagura), auf dem Musiker sitzen. Überall hängen leuchtende, runde Papierlaternen. Am Himmel explodiert ein großes, farbenfrohes Feuerwerk. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Ein tieferer Einblick in die Sommerfeste. Die Lernenden verstehen die kulturelle Bedeutung von Obon, dem Fest zur Ehrung der Ahnen. Vokabeln umfassen den Bon-Tanz und die verschiedenen Arten von Laternen. Außerdem wird das Thema Feuerwerk (Hanabi) als fester Bestandteil des japanischen Sommers behandelt."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Der Herbst: Mondschau und Herbstlaub (Aki: Tsukimi to Momijigari - 秋: 月見と紅葉狩り)",
        "keywords": "Tsukimi, 月見, Mond betrachten, Vollmond, Mangetsu, 満月, Reiskloß, Dango, 団子, Herbstlaub, Momiji, 紅葉",
        "image_concept": "Eine ruhige Nachtszene, von einer traditionellen japanischen Veranda aus gesehen. Auf einem kleinen Holztisch steht ein Teller mit einer Pyramide aus weißen Dango (Reisklößen) und eine Vase mit Pampasgras. Durch die offene Schiebetür blickt man auf einen großen, leuchtenden Vollmond am klaren Nachthimmel. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite stellt die ruhigeren Herbsttraditionen vor. Die Studierenden lernen Vokabeln für Tsukimi (Mondschau), einschließlich der typischen Opfergaben wie Dango und Susuki-Gras. Als Ergänzung wird Momijigari (Betrachtung des Herbstlaubs) als herbstliches Pendant zu Hanami eingeführt."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Winter und Neujahr (Fuyu: Oshōgatsu - 冬: お正月)",
        "keywords": "Oshōgatsu, お正月, Neujahr, erster Schreinbesuch, Hatsumōde, 初詣, Reiskuchen, Mochi, 餅, Glücksbringer, Omamori, お守り",
        "image_concept": "Eine fröhliche Winterszene vor einem großen Shinto-Schrein mit leicht schneebedecktem Dach. Eine Familie im Anime-Stil, gekleidet in warme Wintermäntel und Schals, wirft Münzen in die Opferbox. Im Hintergrund kaufen andere Leute kleine, bunte Stoffamulette (Omamori) an einem Schalter. Sanfter Schneefall. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Fokus auf den wichtigsten Feiertag in Japan: Neujahr. Die Lernenden behandeln Vokabular für zentrale Bräuche wie den ersten Schrein- oder Tempelbesuch des Jahres (Hatsumōde), das Essen von Mochi und den Kauf von Glücksbringern."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Auf dem Festival: Kleidung und Essen (Matsuri de: Yukata to Yatai - 祭りで: 浴衣と屋台)",
        "keywords": "Yukata, 浴衣, Holzsandalen, Geta, 下駄, Essensstand, Yatai, 屋台, Takoyaki, Yakisoba, Kakigōri, Goldfischfangen, Kingyo-sukui, 金魚すくい",
        "image_concept": "Eine Nahaufnahme einer Figur im niedlichen Anime-Stil, die einen farbenfrohen Yukata trägt und glücklich Yakisoba aus einer Pappschale isst. Im unscharfen Hintergrund sind die bunten Lichter und Formen anderer Essensstände und Spielläden zu erkennen, z.B. ein Stand mit geschabtem Eis (Kakigōri) und einer mit Masken. Lebhafte Nachtszene. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Eine praktische Anwendungsseite. Hier werden Vokabeln für die typische Festivalkleidung (Yukata, Geta) und das vielfältige Essen der Straßenstände (Yatai) wie Takoyaki und Yakisoba vertieft. Auch typische Spiele wie das Goldfischfangen werden vorgestellt, um die Lernenden sprachlich auf einen echten Festivalbesuch vorzubereiten."
    }
]
