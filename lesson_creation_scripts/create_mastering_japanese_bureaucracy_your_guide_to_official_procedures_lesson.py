...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Mastering Japanese Bureaucracy: Your Guide to Official Procedures lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Mastering Japanese Bureaucracy: Your Guide to Official Procedures"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Navigate Japanese city halls, immigration offices, and other official settings with confidence. This lesson provides essential vocabulary, phrases, and cultural insights for handling paperwork and procedures like a pro."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Page 1: Key Locations - 主要な場所 (Shuyou na Basho)",
        "keywords": "市役所 (shiyakusho), 区役所 (kuyakusho), 入国管理局 (nyuukoku kanrikyoku), 窓口 (madoguchi), 〜はどこですか？ (~ wa doko desu ka?)",
        "image_concept": "A cheerful foreign student standing outside a modern, clean Japanese municipal building, looking up at it with a curious and optimistic expression. The building is a blend of glass and concrete with minimalist design. No text or signs are visible on the building. The style is cute manga/anime with clean lines and bright, welcoming colors.",
        "content_focus": "Students will learn the names of key government buildings like City Hall, Ward Office, and the Immigration Bureau. They will also learn basic phrases for asking for directions to the correct service window ('madoguchi')."
    },
    {
        "page_number": 3,
        "title": "Page 2: The Vocabulary of Paperwork - 書類の基本単語 (Shorui no Kihon Tango)",
        "keywords": "書類 (shorui), 申請書 (shinseisho), 証明書 (shoumeisho), フォーム (foomu), 記入する (kinyuu suru), 提出する (teishutsu suru)",
        "image_concept": "A person sits at a clean wooden desk with a neat stack of papers. The papers are blank, containing only lines and boxes to indicate they are forms. The person is holding a pen, looking thoughtfully at the top form. The scene has a calm, focused atmosphere. Cute manga/anime art style with authentic details like a Japanese-style pen.",
        "content_focus": "This page introduces essential nouns for different types of documents and the key verbs associated with them, such as 'to fill out' and 'to submit'. This builds the foundational vocabulary for handling any official form."
    },
    {
        "page_number": 4,
        "title": "Page 3: At the Service Window - 窓口での会話 (Madoguchi de no Kaiwa)",
        "keywords": "〜について伺いたいのですが (~ni tsuite ukagaitai no desu ga), お願いします (onegaishimasu), 担当者 (tantousha), 少々お待ちください (shoushou omachi kudasai)",
        "image_concept": "A view from behind a student who is speaking to a friendly, uniformed female official across a counter. The official is smiling and gesturing helpfully towards a brochure (with no text, just colored shapes). The background shows a clean, organized office environment with other counters blurred out. Cute anime style with attention to the professional yet helpful demeanor of the official.",
        "content_focus": "Students will learn polite phrases for initiating a conversation at a service window, stating their purpose, and interacting with the staff. The focus is on using polite language ('keigo') appropriate for official settings."
    },
    {
        "page_number": 5,
        "title": "Page 4: Filling Out the Forms - 申請書の記入 (Shinseisho no Kinyuu)",
        "keywords": "氏名 (shimei), 住所 (juusho), 生年月日 (seinengappi), 職業 (shokugyou), ここには何を書けばいいですか？ (koko ni wa nani o kakeba ii desu ka?)",
        "image_concept": "A close-up shot over a person's shoulder, showing their hands carefully filling out a form with a pen. The form itself has boxes and lines but is completely free of any text or characters. The focus is on the action of writing and the detail of the hands and pen. The art style is clean manga, emphasizing precision and care.",
        "content_focus": "This page breaks down the common fields on Japanese forms (name, address, DOB, occupation) and provides the crucial question, 'What should I write here?'. It empowers students to ask for clarification confidently."
    },
    {
        "page_number": 6,
        "title": "Page 5: Submitting and Confirming - 提出と確認 (Teishutsu to Kakunin)",
        "keywords": "これで全部ですか？ (kore de zenbu desu ka?), 不備はありますか？ (fubi wa arimasu ka?), 次はどうすればいいですか？ (tsugi wa dou sureba ii desu ka?), 確認します (kakunin shimasu)",
        "image_concept": "A pair of hands sliding a small stack of documents across a counter to another pair of hands (the official's). The official's hands are accepting the papers. The shot is tight on the hands and papers, conveying the moment of transaction. The background is a simple, neutral office color. Cute manga/anime style with expressive hand gestures.",
        "content_focus": "Students will learn phrases for submitting their completed paperwork and asking for confirmation. This includes asking if anything is missing, if there are any errors, and what the next step in the process is."
    },
    {
        "page_number": 7,
        "title": "Page 6: Case Study: Visa & Residence Card - ケーススタディ：ビザと在留カード (Keesu Sutadi: Biza to Zairyuu Kaado)",
        "keywords": "在留カード (zairyuu kaado), 更新 (koushin), 変更 (henkou), 許可 (kyoka), 交付 (koufu)",
        "image_concept": "A happy character looking at a new, blank plastic card (representing a residence card) they hold in their hand. In the background, an official gives a polite, congratulatory nod. The setting is clearly an immigration office but without any signs. The character's expression is one of relief and happiness. Cute manga style.",
        "content_focus": "This page applies the learned language to the specific, high-stakes scenario of visa and residence card procedures. It introduces specialized vocabulary for renewal, change of status, and receiving permission/issuance."
    },
    {
        "page_number": 8,
        "title": "Page 7: Cultural Tips & The Hanko Seal - 文化的なヒントと印鑑 (Bunkateki na Hinto to Inkan)",
        "keywords": "印鑑 (inkan), 判子 (hanko), 朱肉 (shuniku), 持参する (jisan suru), 丁寧語 (teineigo)",
        "image_concept": "A close-up, still-life image of a traditional Japanese personal seal ('hanko') next to a red ink pad ('shuniku'). The hanko has a simple, abstract geometric pattern on its stamping face (no letters or kanji). The items are placed on a piece of traditional Japanese paper ('washi'). The style is clean, artistic, and culturally authentic manga/anime art.",
        "content_focus": "This page covers crucial cultural context, explaining the function of the personal seal ('inkan' or 'hanko'), the importance of bringing all required items, and the expectation of using polite language throughout the interaction."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Mastering Japanese Bureaucracy: Your Guide to Official Procedures - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Mastering Japanese Bureaucracy: Your Guide to Official Procedures - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about navigating japanese bureaucracy and official procedures, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "市役所, 区役所, 手続き, 書類, 申請書, 記入する, 提出する, 在留カード, ビザ, 住民票, 印鑑, 保険証, 窓口, 職員, 確認"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Mastering Japanese Bureaucracy: Your Guide to Official Procedures",
        ...
        conclusion_topic = "Conclusion for Mastering Japanese Bureaucracy: Your Guide to Official Procedures lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "市役所, 区役所, 手続き, 書類, 申請書, 記入する, 提出する, 在留カード, ビザ, 住民票, 印鑑, 保険証, 窓口, 職員, 確認, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Mastering Japanese Bureaucracy: Your Guide to Official Procedures - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Mastering Japanese Bureaucracy: Your Guide to Official Procedures - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of mastering japanese bureaucracy: your guide to official procedures",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
