...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Einkaufen in Japan: Vokabeln, Phrasen & Etikette\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Einkaufen in Japan: Vokabeln, Phrasen & Etikette"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Meistere deinen nächsten Einkaufsbummel in Japan! Lerne unverzichtbare Vokabeln, wichtige Phrasen für den Kauf und die kulturelle Etikette, um wie ein Einheimischer selbstbewusst einzukaufen und die besten Souvenirs zu finden."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Das Betreten eines Geschäfts (Mise ni Hairu - 店に入る)",
        "keywords": "Irasshaimase, いらっしゃいませ, Willkommen, Geschäft, Mise, 店, Verkäufer, Ten'in, 店員, Begrüßung, Aisatsu",
        "image_concept": "Ein freundlicher Verkäufer in einer Uniform mit Schürze steht am Eingang eines hellen, sauberen japanischen Geschäfts (z.B. eine Bäckerei oder ein Süßwarenladen) und verbeugt sich leicht mit einem einladenden Lächeln. Ein kawaii Lern-Charakter (ein junger Tourist mit Rucksack) betritt gerade den Laden. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die typische Begrüßung 'Irasshaimase' in japanischen Geschäften zu verstehen und wie man darauf reagiert (oder auch nicht). Es werden grundlegende Vokabeln für verschiedene Geschäftsarten wie 'Konbini' (Convenience Store) und 'Depāto' (Kaufhaus) eingeführt."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Nach Produkten fragen (Shōhin o Sagasu - 商品を探す)",
        "keywords": "... wa doko desu ka?, ...はどこですか？, suchen, sagasu, 探す, Produkt, shōhin, 商品, Etage, kai, 階, Verkaufsbereich, uriba, 売り場",
        "image_concept": "Der Lern-Charakter schaut in einem großen, bunten Kaufhaus etwas verloren drein. Eine hilfsbereite Verkäuferin in einer eleganten Kaufhausuniform zeigt mit einem freundlichen Lächeln in eine Richtung, um den Weg zu weisen. Die Regale im Hintergrund sind mit unspezifischen, bunten Waren gefüllt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf die Frage nach dem Standort von Produkten. Die Studierenden lernen die Satzstruktur '___ wa doko desu ka?' (Wo ist ___?) und Vokabeln, um sich in einem größeren Geschäft oder Kaufhaus zurechtzufinden, z.B. nach Etagen oder spezifischen Abteilungen zu fragen."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Was kostet das? (Ikura desu ka? - いくらですか？)",
        "keywords": "Ikura desu ka, いくらですか, wie viel, Preis, nedan,値段, dies, kore, これ, das, sore, それ, Yen, en, 円",
        "image_concept": "Der Lern-Charakter hält einen niedlichen Gegenstand (z.B. eine Maneki-neko Winkekatze) in der Hand und schaut fragend auf den (leeren) Preiszettel. Der Verkäufer hinter dem Tresen lächelt und zeigt mit seinen Fingern eine Zahl an, um den Preis nonverbal zu kommunizieren. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier wird die wichtigste Frage beim Einkaufen gelehrt: 'Kore wa ikura desu ka?' (Was kostet das?). Die Studierenden üben die Demonstrativpronomen 'kore', 'sore', 'are' zum Zeigen auf Gegenstände und erhalten eine Einführung in das Zählen von japanischem Yen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Die Kaufentscheidung (Kore o Kudasai - これをください)",
        "keywords": "Kore o kudasai, これをください, bitte geben Sie mir, Größe, saizu, サイズ, Farbe, iro, 色, ein Stück, hitotsu, 一つ",
        "image_concept": "Der Lern-Charakter steht an der Kasse und überreicht dem Kassierer ein gefaltetes T-Shirt mit einem coolen, aber generischen Design. Beide Charaktere lächeln, was eine erfolgreiche und positive Transaktion signalisiert. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die entscheidende Phrase 'Kore o kudasai' (Ich nehme das, bitte). Zusätzlich werden nützliche Vokabeln zur Spezifizierung des Kaufs eingeführt, wie z.B. die Frage nach verschiedenen Größen oder Farben eines Artikels."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Bezahlen an der Kasse (Okaikei - お会計)",
        "keywords": "Kasse, okaikei, お会計, Bargeld, genkin, 現金, Kreditkarte, kurejitto kādo, クレジットカード, Geldablage, torē, トレー, Quittung, reshīto, レシート",
        "image_concept": "Eine Nahaufnahme einer Kassensituation. Die Hand des Lern-Charakters legt japanische Yen-Münzen und -Scheine auf eine kleine, typische Geldablage (torē). Die Hand des Kassierers wartet daneben, um das Geld von der Ablage zu nehmen, ohne direkten Handkontakt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt den Bezahlvorgang. Die Studierenden lernen Phrasen wie 'Okaikei onegaishimasu' (Die Rechnung, bitte) und die Vokabeln für Bar- und Kartenzahlung. Ein wichtiger kultureller Fokus liegt auf der korrekten Verwendung der Geldablage ('torē')."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Besondere Wünsche & Service (Tokubetsu na Onegai - 特別なお願い)",
        "keywords": "Geschenkverpackung, rapppingu, ラッピング, Tüte, fukuro, 袋, Anprobe, shichaku, 試着, Gastfreundschaft, omotenashi, おもてなし",
        "image_concept": "Eine Verkäuferin verpackt mit großer Sorgfalt und Konzentration eine Schachtel in wunderschönes Geschenkpapier mit einem traditionellen Muster. Der Lern-Charakter schaut beeindruckt und glücklich zu. Im Hintergrund ist eine Theke mit verschiedenen Geschenkpapieren und Bändern zu sehen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernen die Studierenden fortgeschrittenere Phrasen für spezielle Wünsche. Dies umfasst die Bitte um eine Tüte, das Anprobieren von Kleidung ('shichaku shite mo ii desu ka?') und die Anfrage nach einer Geschenkverpackung, ein herausragendes Merkmal des japanischen Kundenservices ('omotenashi')."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Über den Preis verhandeln (Negiri Kōshō - 値切り交渉)",
        "keywords": "Verhandeln, kōshō, 交渉, Rabatt, waribiki, 割引, Flohmarkt, furī māketto, フリーマーケット, ein bisschen billiger, sukoshi makete, 少し負けて",
        "image_concept": "Eine lebhafte Szene auf einem japanischen Flohmarkt im Freien. Der Lern-Charakter und ein älterer, freundlicher Verkäufer an einem Stand mit Antiquitäten und Trödel feilschen mit einem Lächeln und Gesten. Die Atmosphäre ist entspannt und freundlich, nicht konfrontativ. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt das heikle Thema des Verhandelns. Die Studierenden lernen, wo Verhandeln eventuell möglich ist (z.B. auf Flohmärkten) und wo es absolut unüblich ist (in den meisten Geschäften und Kaufhäusern). Sie lernen die höfliche Phrase 'Sukoshi makete kuremasen ka?' (Könnten Sie es ein bisschen billiger machen?)."
    }
]
