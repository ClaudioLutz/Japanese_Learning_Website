...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Geschäftsjapanisch: Etikette und professionelle Sprache\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Geschäftsjapanisch: Etikette und professionelle Sprache"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Lerne die Grundlagen der japanischen Geschäftsetikette, von der korrekten Begrüßung bis hin zur Kommunikation in Meetings. Diese Lektion bereitet dich auf professionelle Interaktionen im japanischen Arbeitsumfeld vor und hilft dir, häufige Fallstricke zu vermeiden."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen: Begrüßung und Verbeugung (Kihon: Aisatsu to Ojigi - 基本: 挨拶とお辞儀)",
        "keywords": "Begrüßung, Aisatsu, Verbeugung, Ojigi, おはようございます, こんにちは, 失礼します, Respekt, eshaku, keirei, saikeirei",
        "image_concept": "Ein Geschäftsmann und eine Geschäftsfrau in formeller Kleidung stehen sich in einer modernen, hellen Büroloby gegenüber. Sie verbeugen sich respektvoll voreinander mit einem leichten Lächeln. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite lehrt die grundlegenden Begrüßungsformeln im Geschäftskontext für verschiedene Tageszeiten und die drei Hauptarten der Verbeugung (leicht, formell, sehr formell) und wann man sie anwendet."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Das Visitenkartenritual (Meishi Koukan - 名刺交換)",
        "keywords": "Visitenkarte, Meishi, Meishi Koukan, Austausch, Etikette, 両手 (ryoute), 受け取る (uketoru), 頂戴いたします (choudai itashimasu)",
        "image_concept": "Eine Nahaufnahme von zwei Paar Händen, die Visitenkarten über einem Besprechungstisch austauschen. Beide Personen halten die Karte des anderen mit beiden Händen an den Ecken. Die Visitenkarten selbst sind leer oder haben nur Platzhaltermuster. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne den detaillierten Ablauf des Austauschs von Visitenkarten (Meishi). Dies umfasst das korrekte Überreichen, das respektvolle Empfangen mit beiden Händen und die richtige Aufbewahrung während eines Meetings."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Einführung in Keigo: Die Sprache des Respekts (Keigo Nyuumon: Sonkei no Kotoba - 敬語入門: 尊敬の言葉)",
        "keywords": "Keigo, 敬語, Sonkeigo, 尊敬語, Kenjougo, 謙譲語, Teineigo, 丁寧語, Respektsprache, Bescheidenheitssprache",
        "image_concept": "Eine Szene, die Hierarchie darstellt. Ein freundlich aussehender Chef-Charakter steht auf einem kleinen, dezenten Podest. Zwei Mitarbeiter-Charaktere blicken respektvoll zu ihm auf. Visuelle, stilisierte Pfeile könnten den Fluss des Respekts andeuten. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt die drei Hauptkategorien der japanischen Höflichkeitssprache (Keigo): Sonkeigo (Respektsprache), Kenjougo (Bescheidenheitssprache) und Teineigo (höfliche Sprache). Du lernst, wann und für wen jede Form verwendet wird."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Im Büro: Tägliche Ausdrücke (Shokuba de: Mainichi no Hyougen - 職場で: 毎日の表現)",
        "keywords": "お疲れ様です (otsukaresama desu), ご苦労様です (gokurousama desu), お先に失礼します (osaki ni shitsurei shimasu), 承知しました (shouchi shimashita), 職場 (shokuba)",
        "image_concept": "Eine helle und freundliche Büroszene. Ein Mitarbeiter steht an der Tür und verabschiedet sich mit einer leichten Verbeugung. Seine Kollegen an den Schreibtischen winken ihm freundlich lächelnd zu. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernst du unverzichtbare Ausdrücke für den Büroalltag. Der Fokus liegt auf der korrekten Anwendung von Phrasen wie 'Otsukaresama desu' beim Kommen und Gehen und zur Anerkennung der Arbeit von Kollegen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Meetings und Termine: Wichtige Sätze (Kaigi to Apointo: Juuyou na Fureezu - 会議とアポイント: 重要なフレーズ)",
        "keywords": "Meeting, 会議 (kaigi), Termin, アポイント (apointo), よろしくお願いします (yoroshiku onegaishimasu), 恐れ入ります (osoreirimasu), 拝見します (haiken shimasu)",
        "image_concept": "Ein formeller Besprechungsraum. Mehrere Charaktere sitzen aufmerksam um einen großen Tisch. Ein Charakter steht und präsentiert, wobei er auf eine leere Projektionsfläche an der Wand zeigt. Alle hören konzentriert zu. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt die Sprache, die in Meetings und bei der Vereinbarung von Terminen benötigt wird. Du lernst, wie man ein Gespräch höflich beginnt, Zustimmung und Ablehnung ausdrückt und sich für die Zeit der anderen bedankt."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Anrufe und E-Mails: Professionelle Kommunikation (Denwa to Meeru: Senmontekina Komyunikeeshon - 電話とメール: 専門的なコミュニケーション)",
        "keywords": "Telefon, 電話 (denwa), E-Mail, メール (meeru), お世話になっております (osewa ni natte orimasu), 担当者 (tantousha), 件名 (kenmei), 折り返し電話します (orikaeshi denwa shimasu)",
        "image_concept": "Ein Charakter sitzt in einem Büroabteil an einem Schreibtisch und telefoniert professionell mit einem Headset. Er lächelt freundlich und hat einen Stift in der Hand, bereit für Notizen. Auf dem Monitor vor ihm ist eine leere E-Mail-Vorlage zu sehen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne die Standardformulierungen für geschäftliche Telefonate und E-Mails. Dies beinhaltet die wichtige Eröffnungsphrase 'Osewa ni natte orimasu', das Fragen nach dem zuständigen Ansprechpartner und die korrekte Telefonetikette."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Entschuldigen und Danken (Shazai to Kansha - 謝罪と感謝)",
        "keywords": "Entschuldigung, 申し訳ございません (moushiwake gozaimasen), すみません (sumimasen), Dankbarkeit, ありがとうございます (arigatou gozaimasu), 恐縮です (kyoushuku desu)",
        "image_concept": "Zwei Charaktere stehen sich in einem neutralen Büroflur gegenüber. Ein Charakter verbeugt sich tief und aufrichtig als Entschuldigung. Der andere Charakter hat eine Hand leicht erhoben in einer Geste des Verständnisses und der Akzeptanz. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt die Nuancen des Entschuldigens und Dankens im japanischen Geschäftsleben. Du lernst den Unterschied zwischen verschiedenen Entschuldigungsstufen und wie man aufrichtige Dankbarkeit professionell zum Ausdruck bringt."
    }
]
