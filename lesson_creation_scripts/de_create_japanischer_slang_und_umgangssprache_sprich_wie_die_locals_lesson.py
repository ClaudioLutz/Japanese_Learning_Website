...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Japanischer Slang und Umgangssprache: Sprich wie die Locals!\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Japanischer Slang und Umgangssprache: Sprich wie die Locals!"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Tauche ein in die Welt der japanischen Umgangssprache! Lerne die Ausdrücke, die du in Animes, Mangas und in Gesprächen mit jungen Japanern hörst, um deine Konversationen natürlicher und authentischer klingen zu lassen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen der Umgangssprache (Tameguchi - タメ口)",
        "keywords": "Tameguchi, タメ口, Partikel weglassen, informelle Sätze, lockere Sprache, Wörterbuchform, です/ます",
        "image_concept": "Zwei junge japanische Freunde, ein Junge und ein Mädchen, sitzen auf einer Parkbank und unterhalten sich angeregt und lachen. Die Szene ist hell und freundlich. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die grundlegendsten Regeln der informellen Sprache (Tameguchi), einschließlich des Weglassens von Partikeln wie は (wa) und を (o) und der Verwendung der Wörterbuchform anstelle der höflichen です/ます-Form."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Lässige Begrüßungen & Antworten (Kudaketa Aisatsu - くだけた挨拶)",
        "keywords": "Ossu, おっす, Yaho, ヤッホー, Un, うん, ja/nein informell, lockere Begrüßungen, Tschüss",
        "image_concept": "Ein energiegeladener japanischer Teenager-Junge mit stylishem Haar hebt die Hand zu einem lässigen Gruß (wie „Yo!“) in Richtung eines Freundes, der sich ihm nähert. Beide lächeln. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt informelle Begrüßungen und Verabschiedungen wie „Ossu!“ oder „Yaho!“ sowie alltägliche, lockere Antworten wie die Verwendung von „うん“ (un) anstelle von „はい“ (hai)."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Die Top 5 Slang-Wörter (Teiban Surangu - 定番スラング)",
        "keywords": "Yabai, やばい, Maji de, マジで, Sugoi, すごい, Ukeru, ウケる, Meccha, めっちゃ",
        "image_concept": "Eine Gruppe von drei japanischen High-School-Schülern (zwei Mädchen, ein Junge) schaut gemeinsam auf ein Smartphone. Ein Mädchen hat einen schockierten Gesichtsausdruck (für „maji de?!“), das andere lacht herzhaft (für „ukeru!“), während der Junge erstaunt ist. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen fünf der häufigsten und vielseitigsten japanischen Slang-Wörter wie やばい (yabai), マジで (maji de) und ウケる (ukeru) und verstehen deren unterschiedliche Bedeutungen je nach Kontext (z.B. positiv und negativ)."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Wortverkürzungen & Zusammensetzungen (Ryakugo - 略語)",
        "keywords": "Ryakugo, 略語, Wortverkürzung, Kimoi, キモい, Konbini, コンビニ, Sumaho, スマホ, Gikochinai, ぎこちない",
        "image_concept": "Ein japanischer Student in Freizeitkleidung zeigt aufgeregt auf einen hell erleuchteten Convenience Store (Konbini) bei Nacht und spricht dabei mit einem Freund. Der Laden ist stilisiert und hat keine lesbaren Schilder. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt das Konzept der Wortverkürzung (Ryakugo), ein häufiges Merkmal im japanischen Slang. Die Studierenden lernen Beispiele wie コンビニ (Konbini) für Convenience Store oder キモい (Kimoi) für 気持ち悪い (kimochi warui)."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Gefühle und Füllwörter (Aizuchi to Kandoushi - 相槌と感動詞)",
        "keywords": "Aizuchi, 相槌, Kandoushi, 感動詞, Füllwörter, emotionale Ausdrücke, へえ (hee), えーと (eeto), うざい (uzai), すげー (sugee)",
        "image_concept": "Ein Nahaufnahme-Porträt eines japanischen Anime-Mädchens mit großen, funkelnden Augen. Sie hat eine Hand an der Wange und einen erstaunten Gesichtsausdruck, als hätte sie gerade etwas Unglaubliches gehört (passend zu „Heeee!“). Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen, wie sie ihre Sprache durch den Einsatz von Füllwörtern (Aizuchi) wie へえ (hee) und emotionalen Ausrufen (Kandoushi) wie うざい (uzai) oder すげー (sugee) natürlicher und ausdrucksstärker gestalten können."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Jugendsprache & Internet-Slang (Wakamono Kotoba to Netto Surangu - 若者言葉とネットスラング)",
        "keywords": "Wakamono Kotoba, 若者言葉, Netto Surangu, ネットスラング, Kusa, 草, Pien, ぴえん, JK, 女子高生, Emoi, エモい",
        "image_concept": "Ein junger Japaner sitzt an seinem Schreibtisch vor einem Laptop, lächelt breit und macht mit einer Hand das Friedenszeichen. Der Laptop-Bildschirm ist leer oder zeigt ein generisches, abstraktes Muster. Der Fokus liegt auf der positiven Reaktion des Nutzers. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite taucht in die moderne Welt der Jugendsprache (Wakamono Kotoba) und des Internet-Slangs ein. Die Studierenden lernen trendige Begriffe wie 草 (kusa) für Lachen oder ぴえん (pien) für Traurigkeit."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Kontext ist alles: Wann man Slang NICHT benutzt (TPO - TPO)",
        "keywords": "TPO, Time Place Occasion, Uchi-Soto, 内外, Keigo, 敬語, formelle Situation, informelle Situation, Respekt",
        "image_concept": "Ein geteiltes Bild. Links verbeugt sich eine junge Person in Schuluniform respektvoll vor einer älteren Lehrerfigur in einer formellen Umgebung. Rechts gibt dieselbe junge Person einem gleichaltrigen Freund in einem Park ein High-Five. Dies visualisiert den Kontrast zwischen formellen und informellen Interaktionen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Eine entscheidende Lektion über den richtigen Kontext. Die Studierenden lernen das Konzept von TPO (Time, Place, Occasion) und uchi-soto (Innen-/Außengruppe), um zu verstehen, wann Umgangssprache angemessen ist (mit Freunden) und wann sie vermieden werden sollte (im Gespräch mit Älteren, Lehrern oder Vorgesetzten), im Gegensatz zur Höflichkeitssprache Keigo."
    }
]
