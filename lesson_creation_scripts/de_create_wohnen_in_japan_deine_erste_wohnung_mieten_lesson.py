...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Wohnen in Japan: Deine erste Wohnung mieten\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Wohnen in Japan: Deine erste Wohnung mieten"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Lerne alles, was du wissen musst, um deine Traumwohnung in Japan zu finden! Von der Wohnungssuche beim Makler über die Besonderheiten japanischer Wohnungen bis hin zu den Hausregeln im Alltag – diese Lektion macht dich fit für das Leben in den eigenen vier Wänden in Japan."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Die Wohnungssuche beginnt (Heya-sagashi - 部屋探し)",
        "keywords": "Immobilienmakler, fudousan'ya, Wohnung, apaato, Villa, manshon, suchen, sagasu, Mietvertrag, chintai keiyaku",
        "image_concept": "Ein freundlicher japanischer Immobilienmakler im Anzug sitzt an einem Schreibtisch gegenüber einem jungen, hoffnungsvollen ausländischen Studenten. Der Makler zeigt auf ein Tablet mit verschiedenen Wohnungsbildern. Der Hintergrund ist ein helles, sauberes Büro. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen das Vokabular, um mit einem Immobilienmakler (不動産屋 - fudousan'ya) über ihre Wünsche zu sprechen. Es werden die grundlegenden Begriffe für die Wohnungssuche und die verschiedenen Arten von Mietwohnungen in Japan vorgestellt."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Wohnungsanzeigen verstehen (Madori no Mikata - 間取りの見方)",
        "keywords": "Grundriss, madori, 1K, 1DK, 1LDK, Tatami-Größe, -jou, Bahnhofsnähe, eki-chika, Baujahr, chikunen",
        "image_concept": "Eine vereinfachte, farbige Draufsicht eines typischen 1LDK-Apartmentgrundrisses. Man erkennt klar einen kleinen Eingangsbereich, eine Küche, einen Ess-/Wohnbereich und ein separates Schlafzimmer. Alles ist im niedlichen Manga/Anime-Stil gezeichnet, mit Miniatur-Möbeln. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt, wie man japanische Wohnungsanzeigen und Grundrisse (間取り - madori) liest. Die Studierenden lernen die gängigen Abkürzungen wie L (Living), D (Dining) und K (Kitchen) und wie die Zimmergröße oft in Tatami-Matten (帖 - jou) angegeben wird."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Die anfänglichen Kosten (Shoki Hiyou - 初期費用)",
        "keywords": "Kaution, shikikin, Schlüsselgeld, reikin, Maklergebühr, chuukai tesuuryou, Miete im Voraus, mae-yachin, Bürge, hoshounin",
        "image_concept": "Eine Person schaut nachdenklich auf ein großes Sparschwein. Daneben liegen mehrere Stapel von stilisierten japanischen Yen-Münzen und -Scheinen, die die verschiedenen anfänglichen Kosten symbolisieren. Die Szene ist hoffnungsvoll, nicht deprimierend. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier werden die oft hohen Anfangskosten einer Wohnungsmiete in Japan aufgeschlüsselt. Die Studierenden verstehen den Unterschied zwischen der erstattungsfähigen Kaution (敷金 - shikikin) und dem nicht erstattungsfähigen 'Geschenkgeld' für den Vermieter (礼金 - reikin)."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Merkmale einer japanischen Wohnung (Nihon no Ie no Tokuchou - 日本の家の特徴)",
        "keywords": "Eingangsbereich, genkan, Tatami-Raum, washitsu, Schiebetür, fusuma, Bad, ofuro, Toilette, toire, Balkon, beranda",
        "image_concept": "Eine geteilte Szene. Links sieht man einen sauberen 'genkan' mit ordentlich aufgereihten Schuhen und Hausschuhen. Rechts ist ein typisch japanisches Badezimmer abgebildet, das den separaten Toilettenraum und den Waschraum mit einer tiefen Badewanne zeigt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden entdecken die kulturellen Besonderheiten einer japanischen Wohnung. Der Fokus liegt auf dem 'genkan' (玄関), wo man die Schuhe auszieht, dem separaten Raum für die Hightech-Toilette und dem Badezimmer mit einer tiefen Badewanne ('ofuro')."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Die Wohnung einrichten (Kagu o Sorou - 家具を揃える)",
        "keywords": "Möbel, kagu, Kühlschrank, reizouko, Waschmaschine, sentakuki, Klimaanlage, eakon, Futon, futon, Reiskocher, suihanki",
        "image_concept": "Ein gemütliches, aber kleines japanisches Zimmer wird eingerichtet. Eine Person rollt einen bunten Futon aus, während im Hintergrund ein kleiner Kühlschrank, ein Reiskocher auf einer Ablage und eine Waschmaschine auf dem Balkon zu sehen sind. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt das Vokabular für Möbel und Haushaltsgeräte. Es wird erklärt, dass japanische Wohnungen meist unmöbliert vermietet werden, aber oft mit einer Klimaanlage ausgestattet sind. Der Unterschied zwischen einem westlichen Bett und einem Futon wird thematisiert."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Hausregeln und Alltag (Seikatsu no Ruuru - 生活のルール)",
        "keywords": "Mülltrennung, gomi no bunbetsu, brennbarer Müll, moeru gomi, Lärm, souon, Nachbarn, otonari-san, Hausverwaltung, kanri-gaisha",
        "image_concept": "Eine Person steht vor einem sauberen Müllsammelplatz und sortiert sorgfältig Müll in verschiedene durchsichtige, farblich markierte Säcke (z.B. für Plastik, Dosen, brennbaren Müll). Die Szene ist ordentlich und respektvoll. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Das Leben in einer japanischen Hausgemeinschaft erfordert die Einhaltung von Regeln. Die Studierenden lernen die Wichtigkeit und die Grundlagen der komplizierten Mülltrennung (ゴミの分別) und die Etikette bezüglich Lärmbelästigung."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Nützliche Sätze für Mieter (Benri na Fureezu - 便利なフレーズ)",
        "keywords": "ist kaputt, kowaremashita, reparieren, shuuri suru, Wasserleck, mizumore, Schlüssel verloren, kagi o nakushimashita, Vertrag erneuern, keiyaku koushin",
        "image_concept": "Eine Person telefoniert mit einem leicht besorgten Gesichtsausdruck und zeigt auf eine Klimaanlage an der Wand, aus der comichaft Wassertropfen fallen. Die Geste soll das Problem am Telefon verdeutlichen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss lernen die Studierenden praktische Sätze, um alltägliche Probleme in der Wohnung zu melden. Dies umfasst das Melden eines kaputten Geräts, eines Wasserlecks oder den Verlust des Schlüssels an den Vermieter oder die Hausverwaltung."
    }
]
