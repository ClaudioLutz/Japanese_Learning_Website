...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Geld und Bankgeschäfte in Japan meistern\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Geld und Bankgeschäfte in Japan meistern"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Lerne unverzichtbare Sätze und Vokabeln für den Umgang mit Geld in Japan. Von der Nutzung eines Geldautomaten über den Geldwechsel bis hin zur Eröffnung eines Bankkontos – diese Lektion bereitet dich auf alle wichtigen finanziellen Situationen vor."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen: Die japanische Währung - 日本の通貨 (Nihon no Tsūka)",
        "keywords": "Yen (円, en), Bargeld (現金, genkin), Münzen (硬貨, kōka), Banknoten (紙幣, shihei), Betrag (金額, kingaku)",
        "image_concept": "Ein niedlicher Anime-Charakter mit großen, neugierigen Augen blickt auf einen Tisch, auf dem verschiedene stilisierte, generische japanische Yen-Münzen und -Scheine ausgebreitet sind. Der Charakter hat einen nachdenklichen Ausdruck. Die Farben sind hell und freundlich. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In dieser Lektion lernst du, die verschiedenen japanischen Münzen und Banknoten zu erkennen und zu benennen. Du übst auch, wie man Geldbeträge auf Japanisch korrekt ausspricht und versteht."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Am Geldautomaten (ATM) - ATMの利用 (Ē Tī Emu no Riyō)",
        "keywords": "Geldautomat (ATM), abheben (引き出し, hikidashi), einzahlen (預け入れ, azukeire), Kontostand (残高照会, zandaka shōkai), PIN (暗証番号, anshō bangō)",
        "image_concept": "Ein freundlicher Anime-Charakter steht vor einem modernen, aber generischen Geldautomaten in einem hell erleuchteten Geschäft. Der Charakter tippt mit einem Finger auf den leeren Bildschirm und hat einen konzentrierten Gesichtsausdruck. Die Ästhetik ist kawaii und einladend. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernst du die wichtigsten Vokabeln und Sätze, um einen Geldautomaten in Japan selbstständig zu bedienen. Du erfährst, wie du Geld abhebst, einzahlst und deinen Kontostand abfragst."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Geld wechseln - 両替 (Ryōgae)",
        "keywords": "Geldwechsel (両替, ryōgae), Wechselkurs (為替レート, kawase rēto), Schalter (窓口, madoguchi), Reisepass (パスポート, pasupōto), Formular (申込書, mōshikomisho)",
        "image_concept": "Ein hilfsbereiter, lächelnder Anime-Bankangestellter hinter einem Schalter reicht einem Touristen-Charakter einen Stapel generischer Formulare. Der Tourist sieht erleichtert und dankbar aus. Zwischen ihnen schwebt ein kleines, stilisiertes Globus-Symbol, das den Währungsumtausch andeutet. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt, wie und wo du in Japan Geld wechseln kannst. Du lernst die notwendigen Sätze, um nach dem Wechselkurs zu fragen und den Vorgang am Bankschalter oder in einer Wechselstube durchzuführen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Interaktionen in der Bank - 銀行でのやり取り (Ginkō de no Yaritori)",
        "keywords": "Bank (銀行, ginkō), Wartenummer (整理券, seiriken), Schalter (窓口, madoguchi), Bankangestellter (銀行員, ginkōin), Bitte warten Sie (少々お待ちください, shōshō omachi kudasai)",
        "image_concept": "Innenansicht einer hellen, sauberen und modernen japanischen Bank. Mehrere Anime-Charaktere sitzen geduldig auf einer Wartebank. Ein Charakter steht gerade auf und blickt auf einen Nummernanzeiger, der nur aus leuchtenden Kreisen besteht. Die Atmosphäre ist ruhig und geordnet. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne, dich in einer japanischen Bank zurechtzufinden. Von der Ziehung einer Wartenummer über das Verständnis der Schalteransagen bis hin zur höflichen Kommunikation mit dem Bankpersonal."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Ein Bankkonto eröffnen - 口座開設 (Kōza Kaisetsu)",
        "keywords": "Konto eröffnen (口座開設, kōza kaisetsu), Aufenthaltskarte (在留カード, zairyū kādo), Stempel (判子/印鑑, hanko/inkan), Antragsformular (申込書, mōshikomisho), Sparkonto (普通預金, futsū yokin)",
        "image_concept": "Eine Nahaufnahme von den Händen eines Anime-Charakters. Eine Hand hält eine stilisierte, generische Aufenthaltskarte (ohne Text, nur mit Platzhalter-Formen). Die andere Hand hält einen kleinen, traditionell aussehenden persönlichen Stempel (Hanko). Der Hintergrund ist ein unscharfes Büro. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Ein fortgeschritteneres Thema: Du lernst den Prozess und das Vokabular zur Eröffnung eines Bankkontos in Japan. Dies beinhaltet die benötigten Dokumente wie die Aufenthaltskarte (Zairyū Card) und den persönlichen Stempel (Hanko)."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Überweisungen und Zahlungen - 振込と支払い (Furikomi to Shiharai)",
        "keywords": "Überweisung (振込, furikomi), Empfänger (受取人, uketorinin), Kontonummer (口座番号, kōza bangō), Gebühr (手数料, tesūryō), Rechnung bezahlen (支払う, harau)",
        "image_concept": "Ein Anime-Charakter sitzt an einem Schreibtisch und schaut auf ein generisches Rechnungsformular (ohne Text). Neben ihm steht ein Laptop mit einem leeren Bildschirm. Der Charakter hat einen konzentrierten Ausdruck und hält einen Stift, als ob er das Formular ausfüllen würde. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne, wie man eine Inlandsüberweisung (Furikomi) tätigt, eine der häufigsten Banktransaktionen in Japan. Du erfährst auch, wie man Rechnungen am Schalter, am Automaten oder im Konbini bezahlt."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Kulturelle Etikette & Vokabular - 文化的なマナーと単語 (Bunkateki na Manā to Tango)",
        "keywords": "Geld-Tablett (カルトン/コイントレー, karuton/koin torē), Höflichkeitssprache (敬語, keigo), Zinsen (利息, risoku), Bankbuch (通帳, tsūchō), Dankbarkeit (ありがとうございます, arigatō gozaimasu)",
        "image_concept": "Eine Nahaufnahme einer Transaktion an einem Schalter aus der Vogelperspektive. Die Hand eines Anime-Charakters legt sorgfältig stilisierte Geldscheine auf ein kleines, blaues Plastiktablett (Koin-Tray). Die Hand eines anderen Charakters wartet daneben, um das Tablett entgegenzunehmen. Der Fokus liegt auf der höflichen Geste. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite fasst wichtige kulturelle Aspekte zusammen, wie die Verwendung eines Geld-Tabletts (Koin-Tray) zur Übergabe von Bargeld, die erwartete Höflichkeit und nützliche Zusatzvokabeln rund um das Thema Finanzen."
    }
]
