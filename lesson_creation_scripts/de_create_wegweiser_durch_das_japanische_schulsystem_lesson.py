...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Wegweiser durch das japanische Schulsystem\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Wegweiser durch das japanische Schulsystem"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Tauche ein in den japanischen Schulalltag! Diese Lektion führt dich durch Klassenzimmer, Schulclubs und die gefürchteten Prüfungen und vermittelt dir dabei wichtiges Vokabular und tiefgreifende kulturelle Einblicke."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Die Struktur des Bildungssystems (Kyōiku Seido no Kōzō - 教育制度の構造)",
        "keywords": "Grundschule, Mittelschule, Oberschule, Universität, Shōgakkō, Chūgakkō, Kōkō, Daigaku, 小学校, 中学校, 高校, 大学",
        "image_concept": "Ein freundlicher Anime-Lehrer steht neben einer illustrierten Zeittafel. Die Tafel zeigt vier niedliche, stilisierte Gebäude: eine kleine Grundschule, eine etwas größere Mittelschule, eine Oberschule und ein imposantes Universitätsgebäude, die den Bildungsweg darstellen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die grundlegende Struktur des japanischen Bildungssystems von der Grundschule bis zur Universität kennen, einschließlich der Bezeichnungen und der Dauer der einzelnen Schulstufen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Ein typischer Schultag (Ippanteki na Gakkō no Ichinichi - 一般的な学校の一日)",
        "keywords": "Unterricht, Mittagessen, Putzzeit, Schulweg, Jugyō, Kyūshoku, Sōji, Tōkō, 授業, 給食, 掃除, 登校",
        "image_concept": "Eine Gruppe von Anime-Schülern in Schuluniformen isst fröhlich in ihrem hellen Klassenzimmer zu Mittag. Einige Schüler verteilen das Essen (Kyūshoku) aus großen Töpfen an ihre Mitschüler. Die Szene strahlt eine warme, gemeinschaftliche Atmosphäre aus. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen Vokabular und kulturelle Praktiken rund um den typischen Tagesablauf in einer japanischen Schule, vom morgendlichen Antreten (Chōrei) über den Unterricht (Jugyō) und das gemeinsame Mittagessen (Kyūshoku) bis hin zur Putzzeit (Sōji)."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Schuluniform und Schulregeln (Seifuku to Kōsoku - 制服と校則)",
        "keywords": "Schuluniform, Matrosenuniform, Gakuran, Schulregeln, Seifuku, Sērāfuku, Gakuran, Kōsoku, 制服, セーラー服, 学ラン, 校則",
        "image_concept": "Zwei Schülerinnen und ein Schüler stehen fröhlich vor einem Schultor mit Kirschblütenbäumen. Ein Mädchen trägt eine klassische Matrosenuniform, das andere eine moderne Blazer-Uniform und der Junge einen schwarzen Gakuran. Ihre Frisuren sind ordentlich und gepflegt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf die ikonischen japanischen Schuluniformen (Seifuku), wie die Matrosenuniform (Sērāfuku) und den Gakuran, sowie auf die strengen Schulregeln (Kōsoku), die oft Frisuren, Accessoires und Verhalten betreffen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Nachmittagsclubs: Das Herz des Schullebens (Bukatsu: Gakkō Seikatsu no Shinzō - 部活：学校生活の心臓)",
        "keywords": "Clubaktivitäten, Sportclub, Kulturclub, Bukatsu, Undōbu, Bunkabu, 部活, 運動部, 文化部",
        "image_concept": "Eine dynamische Außenszene auf einem Schulgelände, die verschiedene Clubaktivitäten zeigt. Im Vordergrund übt ein Mädchen in traditioneller Kleidung Kalligrafie (Shodō). Im Hintergrund sieht man eine Gruppe, die Baseball spielt, und eine andere, die im Kendo-Training ist. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden entdecken die zentrale Rolle der Clubaktivitäten (Bukatsu) im japanischen Schulleben. Sie lernen den Unterschied zwischen Sportclubs (Undōbu) und Kulturclubs (Bunkabu) sowie Vokabular für beliebte Aktivitäten wie Baseball, Kendo oder Kalligrafie kennen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Die Senpai-Kouhai-Beziehung (Senpai-Kōhai no Kankei - 先輩後輩の関係)",
        "keywords": "Älterer Schüler, jüngerer Schüler, Hierarchie, Respekt, Senpai, Kōhai, Keigo, 先輩, 後輩, 敬語",
        "image_concept": "Ein älterer Schüler (Senpai) in einem Tennisclub-Trikot zeigt einem jüngeren Schüler (Kouhai) mit einem geduldigen Lächeln die richtige Haltung für einen Aufschlag. Der Kouhai hört aufmerksam und respektvoll zu. Die Szene findet auf einem sonnigen Tennisplatz statt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt das wichtige kulturelle Konzept der Senpai-Kouhai-Beziehung – die Hierarchie zwischen älteren (Senpai) und jüngeren (Kouhai) Schülern. Die Studierenden lernen die damit verbundenen sozialen Erwartungen und erste Grundlagen der Höflichkeitssprache (Keigo) kennen."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Prüfungsstress und \"Prüfungshölle\" (Shiken no Sutorēsu to Juken Sensō - 試験のストレスと受験戦争)",
        "keywords": "Prüfung, Aufnahmeprüfung, Paukschule, Lernen, Shiken, Nyūshi, Juku, Benkyō, 試験, 入試, 塾, 勉強",
        "image_concept": "Ein entschlossener Anime-Schüler sitzt nachts an seinem Schreibtisch, der mit Büchern und Notizen übersät ist. Eine Schreibtischlampe beleuchtet sein Gesicht. Draußen vor dem Fenster ist ein dunkler Nachthimmel mit Sternen zu sehen. Die Atmosphäre ist fokussiert und ruhig, nicht verzweifelt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die intensive Prüfungskultur in Japan kennen, einschließlich des Vokabulars für verschiedene Prüfungen (Shiken), Aufnahmeprüfungen (Nyūshi) und Paukschulen (Juku). Der kulturelle Druck, bekannt als \"Juken Sensō\" (Prüfungskrieg), wird erläutert."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Schulveranstaltungen und Zeremonien (Gakkō Gyōji to Gishiki - 学校行事と儀式)",
        "keywords": "Einschulung, Sportfest, Kulturfest, Abschlussfeier, Nyūgakushiki, Undōkai, Bunkasai, Sotsugyōshiki, 入学式, 運動会, 文化祭, 卒業式",
        "image_concept": "Eine lebhafte Szene während eines Schulkulturfestes (Bunkasai). Schüler in passenden Schürzen betreiben einen liebevoll dekorierten Takoyaki-Stand in ihrem Klassenzimmer. Überall hängen bunte, handgemachte Girlanden und Dekorationen. Alle lachen und haben Spaß. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt die wichtigsten jährlichen Schulveranstaltungen und Zeremonien, die das Schuljahr prägen. Die Studierenden lernen Vokabular für die Einschulungszeremonie (Nyūgakushiki), das Sportfest (Undōkai), das Kulturfest (Bunkasai) und die Abschlussfeier (Sotsugyōshiki)."
    }
]
