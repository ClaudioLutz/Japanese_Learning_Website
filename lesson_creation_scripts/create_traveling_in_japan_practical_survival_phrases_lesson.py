#!/usr/bin/env python3
"""
This script creates a comprehensive Traveling in Japan: Practical Survival Phrases lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Traveling in Japan: Practical Survival Phrases"
LESSON_DIFFICULTY = "Beginner"
LESSON_DESCRIPTION = "Master essential Japanese phrases for navigating Japanese cities with confidence. This lesson equips you with the language skills to handle common travel situations, from asking for directions to ordering food."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Basic Greetings - あいさつ (Aisatsu)",
        "keywords": "greetings, hello, goodbye, thank you, excuse me, good morning, good evening",
        "image_concept": "A cute manga/anime style illustration of two characters bowing to each other in a traditional Japanese greeting. Cherry blossoms in the background, soft lighting, clean lines, culturally authentic clothing.",
        "content_focus": "Learn essential greetings and polite phrases for interacting with locals."
    },
    {
        "page_number": 3,
        "title": "Asking for Directions - 道案内 (Michiannai)",
        "keywords": "directions, where is, train station, bathroom, lost, map, please tell me",
        "image_concept": "A cute manga/anime character looking slightly lost while holding a map, with a concerned expression. Background of a bustling Japanese street with traditional shops and street signs (no visible text on signs). Clean lines, soft colors.",
        "content_focus": "Learn how to ask for directions and understand basic directional instructions."
    },
    {
        "page_number": 4,
        "title": "Transportation - 交通機関 (Kōtsū Kikan)",
        "keywords": "train, bus, taxi, ticket, platform, airport, how much, one-way, round-trip",
        "image_concept": "A cute manga/anime character happily riding a shinkansen (bullet train). Background shows the train interior with other passengers (no visible text). Clean lines, bright colors.",
        "content_focus": "Learn phrases for using various modes of transportation and purchasing tickets."
    },
    {
        "page_number": 5,
        "title": "Accommodation - 宿泊施設 (Shukuhaku Shisetsu)",
        "keywords": "hotel, check-in, check-out, reservation, room key, luggage, excuse me, thank you",
        "image_concept": "A cute manga/anime character standing at a hotel reception desk, talking to a staff member (no visible text or name tags). Background shows a typical Japanese hotel lobby. Clean lines, warm lighting.",
        "content_focus": "Learn phrases for checking into a hotel, asking for assistance, and handling common hotel situations."
    },
    {
        "page_number": 6,
        "title": "Dining Out - レストラン (Resutoran)",
        "keywords": "restaurant, menu, order, water, please, delicious, thank you, bill, chopsticks",
        "image_concept": "A cute manga/anime character enjoying a delicious meal at a Japanese restaurant. Background shows other diners and traditional Japanese food (no visible text on menus). Clean lines, vibrant food colors.",
        "content_focus": "Learn how to order food, ask for the bill, and express your enjoyment of the meal."
    },
    {
        "page_number": 7,
        "title": "Shopping - 買い物 (Kaimono)",
        "keywords": "shopping, how much, expensive, cheap, I want this, credit card, cash, bag",
        "image_concept": "A cute manga/anime character holding shopping bags, looking happy and satisfied. Background is a vibrant Japanese shopping street (no visible text on shop signs). Clean lines, bright colors.",
        "content_focus": "Learn how to ask about prices, make purchases, and handle common shopping scenarios."
    },
    {
        "page_number": 8,
        "title": "Emergencies - 緊急事態 (Kinkyū Jitai)",
        "keywords": "help, police, hospital, doctor, lost, emergency, please help me, thank you",
        "image_concept": "A cute manga/anime character looking concerned while talking on a phone, possibly calling for help. Background is a blurry cityscape. Soft colors, clean lines.",
        "content_focus": "Learn essential phrases for handling emergencies and seeking assistance."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Traveling in Japan: Practical Survival Phrases - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Traveling in Japan: Practical Survival Phrases - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about traveling in japan: practical survival phrases, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "travel, Japan, Japanese, phrases, survival, beginner, transportation, food, directions, accommodation, sightseeing, culture, etiquette, greetings, emergencies"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Traveling in Japan: Practical Survival Phrases",
        ...
        conclusion_topic = "Conclusion for Traveling in Japan: Practical Survival Phrases lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "travel, Japan, Japanese, phrases, survival, beginner, transportation, food, directions, accommodation, sightseeing, culture, etiquette, greetings, emergencies, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Traveling in Japan: Practical Survival Phrases - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Traveling in Japan: Practical Survival Phrases - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of traveling in japan: practical survival phrases",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
