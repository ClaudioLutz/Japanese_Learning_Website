...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive 日本の住まい探し (Nihon no Sumai Sagashi) - Your Guide to Renting an Apartment lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "日本の住まい探し (Nihon no Sumai Sagashi) - Your Guide to Renting an Apartment"
...
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "1. 不動産屋へ行こう！ (Fudousan-ya e Ikou!) - Let's Go to the Real Estate Agent!",
        "keywords": "不動産屋 (fudousan-ya), 賃貸物件 (chintai bukken), 探す (sagasu), 希望 (kibou), 条件 (jouken), 駅近 (ekichika)",
    ...
    {
        "page_number": 3,
        "title": "2. 間取りを読もう！ (Madori o Yomou!) - Let's Read the Floor Plan!",
        "keywords": "間取り (madori), 1R (wan ruumu), 1K (wan kei), 1DK (wan dii kei), 1LDK (wan eru dii kei), 和室 (washitsu), 洋室 (youshitsu), 畳 (tatami)",
        ...
        "content_focus": "Decode Japanese apartment layouts. This page teaches the meaning of common abbreviations like 1R, 1K, and 1LDK, and the difference between Japanese-style rooms with tatami mats (和室) and Western-style rooms (洋室)."
    },
    {
        "page_number": 4,
        "title": "3. お金の話 (Okane no Hanashi) - The Money Talk",
        "keywords": "家賃 (yachin), 敷金 (shikikin), 礼金 (reikin), 管理費 (kanrihi), 保証金 (hoshoukin), 更新料 (koushinryou)",
        ...
        "content_focus": "Understand the unique costs of renting in Japan. This page breaks down essential financial terms, including monthly rent (家賃), security deposit (敷金), and the non-refundable 'key money' or 'gift money' (礼金)."
    },
    {
        "page_number": 5,
        "title": "4. アパートの中 (Apaato no Naka) - Inside the Apartment",
        "keywords": "玄関 (genkan), 浴室 (yokushitsu), トイレ (toire), 台所 (daidokoro), ベランダ (beranda), 押入れ (oshiire), エアコン (eakon)",
        ...
        "content_focus": "Familiarize yourself with the different areas and common fixtures inside a typical Japanese apartment, from the entryway where you remove shoes (玄関) to the deep, traditional closets (押入れ) and the unit bath."
    },
    {
        "page_number": 6,
        "title": "5. 家具と家電 (Kagu to Kaden) - Furniture and Appliances",
        "keywords": "家具 (kagu), 家電 (kaden), 冷蔵庫 (reizouko), 洗濯機 (sentakuki), 電子レンジ (denshi renji), ベッド (beddo), テーブル (teeburu)",
        ...
        "content_focus": "Learn the essential vocabulary for furnishing a new home. This page covers common furniture (家具) and home appliances (家電) that you will likely need to purchase, as most Japanese apartments come unfurnished."
    },
    {
        "page_number": 7,
        "title": "6. 団地での生活ルール (Danchi de no Seikatsu Ruuru) - Rules of Apartment Life",
        "keywords": "ゴミ出し (gomidashi), 騒音 (souon), 近所付き合い (kinjozukiai), 挨拶 (aisatsu), 可燃ゴミ (kanen gomi), 不燃ゴミ (funen gomi)",
        ...
        "content_focus": "Learn the crucial rules of Japanese apartment living to maintain harmony with your neighbors. This page focuses on the complex garbage sorting and disposal system (ゴミ出し), noise etiquette, and the importance of simple greetings (挨拶)."
    },
    {
        "page_number": 8,
        "title": "7. トラブルと連絡 (Toraburu to Renraku) - Problems and Communication",
        "keywords": "大家さん (ooya-san), 管理会社 (kanri-gaisha), 故障 (koshou), 水漏れ (mizumore), 鍵をなくした (kagi o nakushita), 連絡する (renraku suru)",
        ...
        "content_focus": "Prepare for unexpected issues. This page teaches you how to communicate common household problems, like a broken air conditioner or a water leak, to your landlord (大家さん) or the building's management company (管理会社)."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="日本の住まい探し (Nihon no Sumai Sagashi) - Your Guide to Renting an Apartment - Lesson Overview",
        ...
        intro_keywords = "不動産, 賃貸, アパート, マンション, 家賃, 敷金, 礼金, 間取り, 1LDK, 家具, 家電, 引っ越し, ゴミ出し, 契約, 近所付き合い"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to 日本の住まい探し (Nihon no Sumai Sagashi) - Your Guide to Renting an Apartment",
        ...
        conclusion_topic = "Conclusion for 日本の住まい探し (Nihon no Sumai Sagashi) - Your Guide to Renting an Apartment lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "不動産, 賃貸, アパート, マンション, 家賃, 敷金, 礼金, 間取り, 1LDK, 家具, 家電, 引っ越し, ゴミ出し, 契約, 近所付き合い, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="日本の住まい探し (Nihon no Sumai Sagashi) - Your Guide to Renting an Apartment - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="日本の住まい探し (Nihon no Sumai Sagashi) - Your Guide to Renting an Apartment - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of 日本の住まい探し (nihon no sumai sagashi) - your guide to renting an apartment",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
