...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Verb Foundations: Mastering Japanese Conjugation lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Verb Foundations: Mastering Japanese Conjugation"
LESSON_DIFFICULTY = "Beginner"
LESSON_DESCRIPTION = "Unlock the core of Japanese grammar by mastering the three verb groups. This lesson provides a step-by-step guide to conjugating verbs into their polite present and past forms, building a solid foundation for fluent conversation."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "動詞の世界へようこそ (Doushi no Sekai e Youkoso) - Welcome to the World of Verbs",
        "keywords": "verb, doushi, dictionary form, jisho-kei, infinitive, root form, action words",
        "image_concept": "A cheerful anime-style character with large, curious eyes holds a large, thick dictionary with a completely blank cover. The character looks excited to open it. The background is a soft-focus, stylized library with shelves of books that have blank spines. The style is cute manga/anime with clean lines and a warm color palette.",
        "content_focus": "Introduce the concept of a Japanese verb (doushi) and its base form, the dictionary form (jisho-kei). Explain that this is the form found in dictionaries and is the starting point for all conjugations."
    },
    {
        "page_number": 3,
        "title": "３つのグループ分け (Mittsu no Guruupu Wake) - The Three Group Divisions",
        "keywords": "verb groups, classification, u-verb, ru-verb, irregular verb, godan, ichidan, fukisoku",
        "image_concept": "Three friendly and distinct Japanese animal mascots stand on three separate colored platforms (e.g., a red square, a blue circle, a green triangle). The mascots could be a Shiba Inu, a crane, and a tanuki, each representing a group. They are waving happily to the viewer against a simple, clean background. The art style is cute manga with clean lines and cultural authenticity.",
        "content_focus": "Explain the most critical concept: Japanese verbs are divided into three groups which determine their conjugation patterns. Briefly introduce Group 1 (u-verbs), Group 2 (ru-verbs), and Group 3 (irregular verbs) as the fundamental categories for learning."
    },
    {
        "page_number": 4,
        "title": "グループ１：五段動詞 (Guruupu Ichi: Godan Doushi) - Group 1: U-Verbs",
        "keywords": "Group 1, godan doushi, u-verb, -u ending, conjugation rule, i-stem, kaku, nomu",
        "image_concept": "The Shiba Inu mascot from the previous page stands at the beginning of a path made of five stepping stones, representing the five vowel sounds. The mascot is pointing a paw towards the second stone in the path, which is glowing slightly to signify the 'i' sound change. The scene is set in a peaceful Japanese garden. The art is cute manga style.",
        "content_focus": "Detail the characteristics of Group 1 verbs (godan doushi or 'u-verbs'). Explain how to identify them and introduce the core conjugation pattern: changing the final 'u' sound to an 'i' sound before adding suffixes like -masu."
    },
    {
        "page_number": 5,
        "title": "グループ２：一段動詞 (Guruupu Ni: Ichidan Doushi) - Group 2: Ru-Verbs",
        "keywords": "Group 2, ichidan doushi, ru-verb, -eru ending, -iru ending, conjugation rule, taberu, miru",
        "image_concept": "The crane mascot stands elegantly on a single, flat platform, representing 'ichidan' (one step). With its beak, it is gently lifting away a small block from the end of a row of blocks. The removed block is translucent, representing the dropped 'ru'. The overall aesthetic is minimalist, clean, and graceful, with a Japanese ink wash (sumi-e) inspired background.",
        "content_focus": "Explain the simplicity of Group 2 verbs (ichidan doushi or 'ru-verbs'). Show how to identify them (most verbs ending in -eru or -iru) and teach the straightforward conjugation rule: simply drop the final 'ru' and add the new ending."
    },
    {
        "page_number": 6,
        "title": "グループ３：不規則動詞 (Guruupu San: Fukisoku Doushi) - Group 3: Irregular Verbs",
        "keywords": "Group 3, fukisoku doushi, irregular verbs, suru, kuru, to do, to come, memorization",
        "image_concept": "The tanuki mascot is playfully juggling two glowing, magical-looking orbs of light. The tanuki has a slightly mischievous and quirky expression, highlighting the 'unpredictable' nature of these verbs. The background is a whimsical forest clearing under a starry night sky. The style is cute manga/anime with clean lines.",
        "content_focus": "Introduce the two primary irregular verbs, する (suru) and 来る (kuru). Emphasize that these verbs don't follow standard rules and their conjugations must be memorized. Provide their key forms as examples of their irregularity."
    },
    {
        "page_number": 7,
        "title": "現在形と未来形：ます形 (Genzai-kei to Mirai-kei: -masu Form) - Present & Future Tense: -masu Form",
        "keywords": "-masu form, teineigo, polite form, present tense, future tense, affirmative, non-past",
        "image_concept": "A cute anime-style student in a school uniform is politely bowing to an older, kind-faced woman wearing a traditional kimono. They are on a street lined with traditional Japanese buildings. The scene conveys respect and politeness, the essence of the -masu form. There are no signs or text on the buildings. The art style is cute manga with clean lines and cultural authenticity.",
        "content_focus": "Consolidate the knowledge by showing how to create the polite, non-past (present/future) tense using the -masu form for all three verb groups. This section focuses on practical application in polite conversation."
    },
    {
        "page_number": 8,
        "title": "過去形：ました形 (Kako-kei: -mashita Form) - Past Tense: -mashita Form",
        "keywords": "-mashita form, past tense, polite past, affirmative, conjugation, tabemashita, kakimashita",
        "image_concept": "The same student character from the previous image is now sitting at a table in a cozy, traditional Japanese cafe. The student is smiling, looking contentedly at an empty plate and cup, indicating a completed action (e.g., they ate or drank). A slice of matcha cake can be inferred to have been on the plate. The lighting is warm and inviting. The art style is cute manga with clean lines.",
        "content_focus": "Build directly on the -masu form by introducing its past tense equivalent, -mashita. Explain that this is a simple and consistent substitution across all verb groups once the -masu stem is known, allowing students to immediately express past actions politely."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Verb Foundations: Mastering Japanese Conjugation - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Verb Foundations: Mastering Japanese Conjugation - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about verb conjugation fundamentals, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "Japanese verbs, verb conjugation, doushi, katsuyou, verb groups, Group 1 verbs, u-verbs, godan doushi, Group 2 verbs, ru-verbs, ichidan doushi, Group 3 verbs, irregular verbs, fukisoku doushi, -masu form, dictionary form, jisho-kei"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Verb Foundations: Mastering Japanese Conjugation",
        ...
        conclusion_topic = "Conclusion for Verb Foundations: Mastering Japanese Conjugation lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "Japanese verbs, verb conjugation, doushi, katsuyou, verb groups, Group 1 verbs, u-verbs, godan doushi, Group 2 verbs, ru-verbs, ichidan doushi, Group 3 verbs, irregular verbs, fukisoku doushi, -masu form, dictionary form, jisho-kei, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Verb Foundations: Mastering Japanese Conjugation - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Verb Foundations: Mastering Japanese Conjugation - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of verb foundations: mastering japanese conjugation",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
