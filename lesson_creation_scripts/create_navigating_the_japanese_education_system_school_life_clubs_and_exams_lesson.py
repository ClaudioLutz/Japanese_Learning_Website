...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Navigating the Japanese Education System: School Life, Clubs, and Exams lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Navigating the Japanese Education System: School Life, Clubs, and Exams"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Explore the structure and daily life of Japanese schools, from elementary to high school. This lesson offers key vocabulary and cultural insights into iconic elements like school uniforms, club activities, and the high-stakes examination system."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "The School Ladder - 学校の制度 (Gakkou no Seido)",
        "keywords": "小学校 (shougakkou), 中学校 (chuugakkou), 高校 (koukou), 義務教育 (gimu kyouiku), 6-3-3制 (roku-san-san sei)",
        "image_concept": "A single student shown at three distinct stages on a path leading towards a large university building in the distance. First, a small child with a yellow hat and a randoseru backpack (elementary). Next, a middle schooler in a simple uniform. Finally, a high schooler in a more distinct uniform looking determined. The path could be winding or like stepping stones. Cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Understand the basic 6-3-3 structure of the Japanese education system, from elementary school through high school. Learn the names for each level and identify which parts are compulsory education."
    },
    {
        "page_number": 3,
        "title": "A Day in the Life - 一日の流れ (Ichinichi no Nagare)",
        "keywords": "朝礼 (chourei), 授業 (jugyou), 給食 (kyuushoku), 昼休み (hiruyasumi), 掃除の時間 (souji no jikan)",
        "image_concept": "A bright, sunlit classroom where several students are cheerfully participating in 'o-soji' (cleaning time). One student sweeps with a traditional straw broom, another wipes a window, and two others carry a desk together. They are all in their school uniforms. The overall atmosphere is cooperative and positive. Cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Learn the vocabulary for a typical Japanese school day schedule, including morning homeroom, classes, school lunch, and the culturally significant practice of students cleaning their own school."
    },
    {
        "page_number": 4,
        "title": "The School Uniform - 制服 (Seifuku)",
        "keywords": "制服 (seifuku), 学ラン (gakuran), セーラー服 (seeraa fuku), ブレザー (burezaa), 夏服 (natsufuku), 冬服 (fuyufuku)",
        "image_concept": "A full-body shot of two high school students, a boy and a girl, standing side-by-side in front of a cherry blossom tree. The boy wears a classic black 'gakuran' uniform (high-collar). The girl wears a classic navy blue 'sailor fuku'. They are both smiling slightly. Cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Explore the world of Japanese school uniforms. Learn to identify different types like the 'gakuran' for boys and 'sailor fuku' for girls, understand the concept of seasonal uniforms, and discuss their cultural importance."
    },
    {
        "page_number": 5,
        "title": "After-School Clubs - 部活動 (Bukatsudou)",
        "keywords": "部活 (bukatsu), 運動部 (undoubu), 文化部 (bunkabu), サークル (saakuru), 合宿 (gasshuku)",
        "image_concept": "A split-panel image. On the left, a dynamic action shot of a high school baseball club practicing on a field; a batter is mid-swing. On the right, a calm, focused scene from an ikebana (flower arranging) club, with a student carefully placing a flower into a vase. This contrast highlights the diversity of club activities. Cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Dive into the vibrant world of 'bukatsu' (club activities). Differentiate between sports clubs and culture clubs, and understand the high level of commitment and teamwork involved, including training camps."
    },
    {
        "page_number": 6,
        "title": "Seniors and Juniors - 先輩と後輩 (Senpai to Kouhai)",
        "keywords": "先輩 (senpai), 後輩 (kouhai), 関係 (kankei), 敬語 (keigo), 上下関係 (jouge kankei)",
        "image_concept": "Inside a school gymnasium, an older male student (senpai) with a confident and kind expression is demonstrating a basketball dribbling technique to a younger, eager-to-learn male student (kohai). The senpai is guiding the kohai's hands on the ball. The interaction is one of mentorship and respect. Cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Learn one of the most crucial concepts in Japanese society: the senpai-kohai relationship. Understand the roles, responsibilities, and use of respectful language within this hierarchical dynamic, especially in a school or club context."
    },
    {
        "page_number": 7,
        "title": "The Examination Gauntlet - 受験 (Juken)",
        "keywords": "受験 (juken), 試験 (shiken), 塾 (juku), 予備校 (yobikou), 受験戦争 (juken sensou), 合格 (goukaku)",
        "image_concept": "A single student studying at a wooden desk late at night. The desk is piled neatly with textbooks and notebooks. A single desk lamp illuminates the scene. Through the window behind the student, a dark sky with a crescent moon and stars is visible. The student's expression is focused and determined. Cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Understand the high-stakes world of Japanese entrance examinations. Learn vocabulary related to exams, cram schools ('juku'), and the intense period of study known as 'examination hell' or 'examination war'."
    },
    {
        "page_number": 8,
        "title": "School Events & Ceremonies - 学校行事 (Gakkou Gyouji)",
        "keywords": "入学式 (nyuugakushiki), 卒業式 (sotsugyoushiki), 運動会 (undoukai), 文化祭 (bunkasai), 修学旅行 (shuugaku ryokou)",
        "image_concept": "A vibrant scene from a school culture festival ('bunkasai'). Students are happily working together at a food stall decorated with colorful handmade paper lanterns and streamers. One student is flipping okonomiyaki on a grill while another hands a finished one to a smiling classmate. The background shows a bustling schoolyard filled with other students. Cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Discover the major events that mark the Japanese school year. Learn the vocabulary for entrance and graduation ceremonies, sports days, cultural festivals, and school trips, and understand their significance."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Navigating the Japanese Education System: School Life, Clubs, and Exams - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Navigating the Japanese Education System: School Life, Clubs, and Exams - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about navigating the japanese education system, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "学校 (gakkou), 生徒 (seito), 先生 (sensei), 小学校 (shougakkou), 中学校 (chuugakkou), 高校 (koukou), 大学 (daigaku), 入学式 (nyuugakushiki), 卒業式 (sotsugyoushiki), 部活 (bukatsu), 先輩 (senpai), 後輩 (kouhai), 塾 (juku), 受験 (juken), 制服 (seifuku)"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Navigating the Japanese Education System: School Life, Clubs, and Exams",
        ...
        conclusion_topic = "Conclusion for Navigating the Japanese Education System: School Life, Clubs, and Exams lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "学校 (gakkou), 生徒 (seito), 先生 (sensei), 小学校 (shougakkou), 中学校 (chuugakkou), 高校 (koukou), 大学 (daigaku), 入学式 (nyuugakushiki), 卒業式 (sotsugyoushiki), 部活 (bukatsu), 先輩 (senpai), 後輩 (kouhai), 塾 (juku), 受験 (juken), 制服 (seifuku), cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Navigating the Japanese Education System: School Life, Clubs, and Exams - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Navigating the Japanese Education System: School Life, Clubs, and Exams - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of navigating the japanese education system: school life, clubs, and exams",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
