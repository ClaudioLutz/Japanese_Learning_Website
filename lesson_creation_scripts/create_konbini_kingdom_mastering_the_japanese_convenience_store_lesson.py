#!/usr/bin/env python3
"""
This script creates a comprehensive Konbini Kingdom: Mastering the Japanese Convenience Store lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Konbini Kingdom: Mastering the Japanese Convenience Store"
LESSON_DIFFICULTY = "Beginner"
LESSON_DESCRIPTION = "Dive into the vibrant world of Japanese convenience stores (konbini)! This lesson equips you with essential vocabulary and phrases for a smooth konbini experience, from grabbing a quick snack to paying for utilities."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Welcome to the Konbini! - コンビニへようこそ！ (Konbini e yōkoso!)",
        "keywords": "greetings, entering, exiting, politeness, irrasshaimase, arigatou gozaimasu",
        "image_concept": "A cheerful, brightly lit konbini interior with shelves stocked with various products. A young person is entering the store, and a store clerk is bowing slightly with a welcoming expression. Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Basic greetings used upon entering and leaving a konbini. Understanding the importance of polite language."
    },
    {
        "page_number": 3,
        "title": "Finding Your Favorites - ほしいものを見つけよう！ (Hoshii mono o mitsukerou!)",
        "keywords": "food, drinks, snacks, onigiri, bento, bread, sweets, asking for help",
        "image_concept": "Close-up of various konbini food items like onigiri, bento boxes, and colorful drinks arranged neatly on shelves. Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Common food and drink items found in konbini.  Practice asking where specific items are located."
    },
    {
        "page_number": 4,
        "title": "At the Register - レジで (Reji de)",
        "keywords": "cash, credit card, electronic payment, point card, bags, chopsticks, hot/cold",
        "image_concept": "A customer at the konbini register, holding a basket of items. The cashier is smiling politely.  Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Vocabulary and phrases related to the checkout process.  Asking for bags, utensils, and specifying temperature preferences."
    },
    {
        "page_number": 5,
        "title": "Beyond Snacks: Konbini Services - コンビニのサービス (Konbini no sābisu)",
        "keywords": "ATM, copy machine, fax, bill payment, tickets, shipping, photocopying",
        "image_concept": "A montage showcasing the various services available at a konbini, such as an ATM, a copy machine, and a ticket kiosk.  Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Exploring the various services offered at Japanese convenience stores beyond food and drinks."
    },
    {
        "page_number": 6,
        "title": "Konbini Etiquette - コンビニでのマナー (Konbini de no manā)",
        "keywords": "quietness, trash disposal, line etiquette, phone calls, respecting personal space",
        "image_concept": "A person quietly disposing of their trash in a designated bin inside the konbini. Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Understanding the unspoken rules and etiquette expected within a Japanese convenience store."
    },
    {
        "page_number": 7,
        "title": "Useful Phrases - 役に立つフレーズ (Yakunitatsu Furēzu)",
        "keywords": "sumimasen, onegai shimasu, kore kudasai, ikura desu ka, arigatou gozaimasu",
        "image_concept": "A speech bubble containing common Japanese phrases used in a convenience store context.  Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Essential phrases to use in various scenarios within the konbini.  Focus on practical application and pronunciation."
    },
    {
        "page_number": 8,
        "title": "Konbini Adventures - コンビニ冒険 (Konbini Bōken)",
        "keywords": "role-playing, practice, real-world scenarios, ordering, asking for directions, paying",
        "image_concept": "Two friends happily enjoying snacks they purchased from the konbini. Cute manga/anime art style with clean lines and cultural authenticity.",
        "content_focus": "Practical role-playing exercises to simulate real-life konbini situations and reinforce learned vocabulary and phrases."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Konbini Kingdom: Mastering the Japanese Convenience Store - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Konbini Kingdom: Mastering the Japanese Convenience Store - Lesson Overview",
        ...
        intro_keywords = "convenience store, konbini, コンビニ, shopping, food, drinks, snacks, onigiri, bento, payment, services, ATM, copy machine, cultural etiquette, Japan"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Konbini Kingdom: Mastering the Japanese Convenience Store",
        ...
        conclusion_topic = "Conclusion for Konbini Kingdom: Mastering the Japanese Convenience Store lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "convenience store, konbini, コンビニ, shopping, food, drinks, snacks, onigiri, bento, payment, services, ATM, copy machine, cultural etiquette, Japan, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Konbini Kingdom: Mastering the Japanese Convenience Store - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Konbini Kingdom: Mastering the Japanese Convenience Store - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of konbini kingdom: mastering the japanese convenience store",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
