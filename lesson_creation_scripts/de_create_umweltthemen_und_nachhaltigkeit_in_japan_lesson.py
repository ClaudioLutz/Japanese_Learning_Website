...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Umweltthemen und Nachhaltigkeit in Japan\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Umweltthemen und Nachhaltigkeit in Japan"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Lerne den essenziellen Wortschatz, um über Ökologie, Nachhaltigkeit und Umweltschutz in Japan zu sprechen. Entdecke, wie kulturelle Konzepte wie 'mottainai' das moderne Umweltbewusstsein prägen und wie Japan globale Herausforderungen angeht."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen des Umweltschutzes (Kankyō Hogo no Kiso - 環境保護の基礎)",
        "keywords": "Umwelt, kankyō, Natur, shizen, Problem, mondai, schützen, mamoru, Erde, chikyū, Verschmutzung, osen",
        "image_concept": "Ein schöner, ruhiger japanischer Wald mit hohen Zedernbäumen und einem kleinen Shinto-Schrein im Hintergrund. Im Vordergrund betrachtet eine Figur im niedlichen Anime-Stil mit nachdenklichem Gesichtsausdruck einen einzelnen, auf dem moosbewachsenen Boden liegenden Plastikbecher. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite lernst du die grundlegenden Vokabeln, um über die Umwelt, Natur und die Notwendigkeit ihres Schutzes zu sprechen. Dies bildet die Basis für alle folgenden Diskussionen über spezifische Umweltthemen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Müll und Recycling (Gomi to Risaikuru - ゴミとリサイクル)",
        "keywords": "Müll, gomi, Mülltrennung, gomi bunbetsu, brennbarer Müll, moeru gomi, Plastik, purasuchikku, PET-Flasche, pettobotoru, recyceln, risaikuru suru",
        "image_concept": "Ein sympathischer junger Mann im Anime-Stil steht vor einer Reihe von drei verschiedenfarbigen Mülltonnen (z.B. blau für Dosen, gelb für Plastik, grau für brennbaren Müll). Er hält eine Plastikflasche in der einen und eine Zeitung in der anderen Hand und kratzt sich mit einem verwirrten, aber niedlichen Ausdruck am Kopf. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier erfährst du alles über das komplexe und allgegenwärtige Mülltrennungssystem in Japan. Du lernst die wichtigsten Müllkategorien und Verben für das Recycling, eine wesentliche Fähigkeit für den Alltag in Japan."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Die 3Rs und das Konzept 'Mottainai' (Surī Āru to Mottainai - 3Rともったいない)",
        "keywords": "reduzieren, herasu, wiederverwenden, sai-riyō, Ressource, shigen, verschwenden, mudazukai, wertvoll, taisetsu, Mottainai",
        "image_concept": "Zwei junge Anime-Freundinnen in einem gemütlichen Zimmer. Eine näht sorgfältig einen kleinen Riss in einem Stofftier, während die andere bewundernd zusieht. Auf dem Tisch neben ihnen steht eine schön dekorierte Glasflasche, die als Vase für eine einzelne Blume wiederverwendet wird. Die Szene strahlt Wärme und Sorgfalt aus. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt das Prinzip 'Reduce, Reuse, Recycle' (3R) und verbindet es mit dem tief in der japanischen Kultur verwurzelten Konzept 'mottainai' – dem Bedauern über Verschwendung. Lerne, wie diese Philosophie den nachhaltigen Konsum beeinflusst."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Energie und Ressourcen (Enerugī to Shigen - エネルギーと資源)",
        "keywords": "Energie, enerugī, Strom, denryoku, sparen, setsuyaku suru, erneuerbare Energie, saisei kanō enerugī, Atomkraftwerk, genshiryoku hatsudensho, Solarenergie, taiyōkō hatsuden",
        "image_concept": "Ein Blick durch ein Fenster eines modernen japanischen Apartments bei Nacht. Drinnen schaltet eine Anime-Figur gerade das Licht aus. Draußen sieht man die Lichter der Stadt, aber auf einigen Dächern sind leuchtende Solarpaneele und in der Ferne einige Windräder zu erkennen, die einen Kontrast zur traditionellen Stadtlandschaft bilden. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erweitere deinen Wortschatz um die Themen Energieverbrauch und -erzeugung. Du lernst, über Stromsparen, verschiedene Energiequellen wie Solar- und Atomenergie und die Debatte über eine nachhaltige Energiezukunft in Japan zu sprechen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Naturschutz und Biodiversität (Shizen Hogo to Seibutsu Tayōsei - 自然保護と生物多様性)",
        "keywords": "Naturschutz, shizen hogo, Nationalpark, kokuritsu kōen, seltene Tierart, kishō dōbutsu, Wald, mori, Ozean, umi, Ökosystem, seitaikei",
        "image_concept": "Eine freundliche Anime-Parkrangerin mit Fernglas steht auf einem Wanderweg in einem üppigen, grünen japanischen Bergwald. Sie beobachtet lächelnd eine Familie japanischer Makaken (Schneeaffen), die in einer heißen Quelle (Onsen) baden. Die Szene ist friedlich und zeigt die Harmonie zwischen Mensch und Tier. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Japan ist reich an einzigartiger Natur. Auf dieser Seite lernst du Vokabeln, um über den Schutz von Nationalparks, Wäldern, Küsten und gefährdeten Tierarten wie dem japanischen Serau oder dem Iriomote-Wildkater zu diskutieren."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Klimawandel und seine Folgen (Kikō Hendō to sono Eikyō - 気候変動とその影響)",
        "keywords": "Klimawandel, kikō hendō, globale Erwärmung, chikyū ondanka, Taifun, taifū, CO2, nisanka tanso, abnormes Wetter, ijō kishō, Meeresspiegel, kaisuimen",
        "image_concept": "Eine Anime-Figur in Regenkleidung steht unter einem großen Regenschirm an einer Küstenpromenade und blickt auf ein aufgewühltes Meer. Am Himmel sind dramatische, wirbelnde Wolken zu sehen, die einen herannahenden Taifun andeuten. Die Stimmung ist ernst, aber nicht beängstigend, und unterstreicht die Kraft der Natur. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier geht es um globale Probleme aus japanischer Perspektive. Lerne, über die Ursachen und Folgen des Klimawandels zu sprechen, einschließlich der Zunahme von extremen Wetterereignissen wie Taifunen und Hitzewellen, die Japan direkt betreffen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Aktivismus und eine nachhaltige Zukunft (Aktivizumu to Jizoku Kanō na Mirai - アクティビズムと持続可能な未来)",
        "keywords": "Umweltorganisation, kankyō dantai, Freiwilliger, borantia, Beitrag leisten, kōken suru, nachhaltige Gesellschaft, jizoku kanō na shakai, Zukunft, mirai, Umweltschutzbewegung, kankyō hogo undō",
        "image_concept": "Eine vielfältige Gruppe fröhlicher junger Anime-Charaktere nimmt an einer Strandaufräumaktion teil. Sie halten Müllsäcke und geben sich High-Fives. Im Hintergrund ist ein sauberer Sandstrand und ein strahlend blauer Ozean zu sehen. Die Szene ist hoffnungsvoll und zeigt gemeinschaftliches Handeln. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Lektion endet mit einem positiven Ausblick. Du lernst Vokabular, um über persönliches Engagement, Freiwilligenarbeit, Umweltorganisationen und die gemeinsamen Anstrengungen zum Aufbau einer nachhaltigeren Gesellschaft in Japan zu sprechen."
    }
]
