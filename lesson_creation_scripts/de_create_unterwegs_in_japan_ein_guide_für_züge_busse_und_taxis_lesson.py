...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Unterwegs in Japan: Ein Guide für Züge, Busse und Taxis\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Unterwegs in Japan: Ein Guide für Züge, Busse und Taxis"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Lerne, wie du dich in Japan mit Zügen, Bussen und Taxis zurechtfindest. Diese Lektion vermittelt dir das notwendige Vokabular und die kulturelle Etikette, um selbstbewusst und respektvoll durchs Land zu reisen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen: Bahnhöfe und Fahrkarten (Eki to Kippu - 駅と切符)",
        "keywords": "Bahnhof, 駅, eki, Fahrkarte, 切符, kippu, Fahrkartenschalter, みどりの窓口, midori no madoguchi, Fahrkartenautomat, 券売機, kenbaiki, Eingangssperre, 改札口, kaisatsuguchi, Ausgang, 出口, deguchi",
        "image_concept": "Ein niedlicher Anime-Charakter mit blonden Haaren steht neugierig, aber etwas überfordert vor einem japanischen Fahrkartenautomaten. Ein freundlicher Bahnhofsmitarbeiter in Uniform steht daneben und lächelt hilfsbereit. Der Hintergrund ist ein heller, sauberer, aber vereinfachter Bahnhofsbereich. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Lernenden erwerben das Grundvokabular, um sich in einem japanischen Bahnhof zurechtzufinden. Dies umfasst das Finden des richtigen Schalters, den Kauf einer Fahrkarte am Automaten und das Passieren der Eingangssperren."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Im Zug: Ein- und Aussteigen (Densha ni Noru - 電車に乗る)",
        "keywords": "Zug, 電車, densha, einsteigen, 乗る, noru, aussteigen, 降りる, oriru, Bahnsteig, ホーム, hoomu, Waggon, 車両, sharyou, Sitzplatz, 席, seki, Tür, ドア, doa, Lokalzug, 普通, futsuu",
        "image_concept": "Seitenansicht eines niedlichen, bunten japanischen Zuges, der an einem Bahnsteig hält. Mehrere kawaii Anime-Charaktere stehen in einer perfekt geraden Linie und warten geduldig darauf, dass sich die Türen öffnen. Eine Figur ist gerade dabei, den Zug zu betreten. Helle, freundliche Atmosphäre. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite werden Vokabeln und Verben gelehrt, die für das eigentliche Zugfahren benötigt werden. Die Lernenden lernen, über das Ein- und Aussteigen zu sprechen und wichtige Teile des Zuges und des Bahnsteigs zu benennen."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Mit dem Bus durch die Stadt (Basu de no Idou - バスでの移動)",
        "keywords": "Bus, バス, basu, Bushaltestelle, バス停, basutei, Fahrpreis, 運賃, unchin, Stopp-Knopf, 降車ボタン, kousha botan, Fahrer, 運転手, untenshu, hinten einsteigen, 後ろ乗り, ushironori",
        "image_concept": "Das Innere eines hellen, sauberen japanischen Busses. Ein kawaii Anime-Charakter streckt die Hand aus, um den Stopp-Knopf zu drücken. Im Vordergrund sieht man den Busfahrer in Uniform und Mütze, der im Rückspiegel freundlich lächelt. Der Knopf hat keine Schrift, ist aber als solcher erkennbar. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Lernenden lernen die Besonderheiten des Busfahrens in Japan kennen. Der Fokus liegt auf dem Ablauf, der sich oft vom Zugfahren unterscheidet (z.B. ein Ticket beim Einsteigen ziehen und beim Aussteigen bezahlen)."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Ein Taxi nehmen (Takushii ni Noru - タクシーに乗る)",
        "keywords": "Taxi, タクシー, takushii, Taxistand, タクシー乗り場, takushii noriba, Fahrer, 運転手, untenshu, Adresse, 住所, juusho, Kofferraum, トランク, toranku, automatische Tür, 自動ドア, jidou doa",
        "image_concept": "Ein typisches japanisches Taxi steht nachts auf einer Straße, im Hintergrund verschwommene, bunte Lichter einer Großstadt. Die hintere Tür des Taxis steht von selbst offen. Ein kawaii Charakter schaut mit großen, erstaunten Augen auf die automatische Tür. Der Fahrer ist ein freundlich aussehender Mann in Anzug. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt das Vokabular und die Phrasen, die man für eine Taxifahrt benötigt. Die Lernenden lernen, wie man ein Taxi findet, dem Fahrer das Ziel nennt und verstehen kulturelle Besonderheiten wie die automatischen Türen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Nach dem Weg fragen (Michi o Tazuneru - 道を尋ねる)",
        "keywords": "Wo ist...?, 〜はどこですか, wa doko desu ka?, geradeaus, まっすぐ, massugu, rechts, 右, migi, links, 左, hidari, umsteigen, 乗り換え, norikae, nächste Haltestelle, 次の駅, tsugi no eki",
        "image_concept": "Zwei niedliche Anime-Charaktere in einem großen, hellen, aber komplex wirkenden Bahnhof. Ein Charakter hält eine leere Karte in der Hand und schaut verwirrt. Der andere Charakter, ein Einheimischer, lächelt freundlich und zeigt mit der Hand in eine Richtung, um den Weg zu weisen. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier geht es um die praktische Anwendung: Die Lernenden üben Schlüsselsätze, um nach dem Weg zu fragen und einfache Wegbeschreibungen zu verstehen. Ein besonderer Fokus liegt auf dem Thema 'Umsteigen'."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Das Shinkansen-Erlebnis (Shinkansen Taiken - 新幹線体験)",
        "keywords": "Shinkansen, 新幹線, reservierter Sitzplatz, 指定席, shiteiseki, nicht reservierter Sitzplatz, 自由席, jiyuuseki, Bahnhofs-Bento, 駅弁, ekiben, Bahnsteig, ホーム, hoomu",
        "image_concept": "Ein Anime-Charakter sitzt bequem am Fensterplatz in einem Shinkansen und blickt nach draußen, wo ein stilisierter Berg Fuji vorbeizieht. Auf dem Klapptisch vor dem Charakter steht eine farbenfrohe und appetitlich aussehende, aber generische Bento-Box. Der Innenraum des Zuges ist modern und sauber. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite ist dem berühmten Hochgeschwindigkeitszug gewidmet. Die Lernenden lernen spezifisches Vokabular für die Buchung und die Fahrt mit dem Shinkansen und erfahren etwas über die Kultur des 'Ekiben' (Bahnhofs-Lunchbox)."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Etikette und IC-Karten (Manā to IC Kādo - マナーとICカード)",
        "keywords": "IC-Karte, ICカード, aufladen, チャージする, chaaji suru, Prioritätssitz, 優先席, yuusenseki, leise sein, 静かに, shizuka ni, anstehen, 並ぶ, narabu, Handy, 携帯電話, keitai denwa, Manieren, マナー, manā",
        "image_concept": "Eine Gruppe verschiedener kawaii Anime-Charaktere in einem U-Bahn-Waggon. Ein Charakter bietet einer älteren Person seinen Platz an. Ein anderer hört leise Musik mit Kopfhörern. Eine Figur tippt eine bunte, generische IC-Karte an ein leuchtendes Lesegerät an der Ticketsperre. Die Stimmung ist ruhig und respektvoll. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss der Lektion werden wichtige kulturelle Verhaltensregeln im öffentlichen Nahverkehr (Ruhe bewahren, Anstehen, etc.) sowie die praktische Nutzung von wiederaufladbaren IC-Karten wie Suica oder Pasmo behandelt."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        # Find category
        category = LessonCategory.query.filter_by(name="Reisen & Geografie").first()
        if not category:
            print(f"[WARNING] Category 'Reisen & Geografie' not found. Defaulting to 'Sprachgrundlagen'.")
