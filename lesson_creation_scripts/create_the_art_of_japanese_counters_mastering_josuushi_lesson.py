...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive The Art of Japanese Counters: Mastering Josuushi lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "The Art of Japanese Counters: Mastering Josuushi"
LESSON_DIFFICULTY = "Beginner"
LESSON_DESCRIPTION = "Unlock the secret to sounding like a native speaker by mastering Japanese counters! This lesson will guide you from the most common counters for objects and people to more specific ones, including the fascinating sound changes that occur."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "はじめに：数え方の基本 (Hajime ni: Kazoekata no Kihon) - Introduction: The Basics of Counting",
        "keywords": "josuushi, tsu, hitotsu, futatsu, counting, general counter, basics",
        "image_concept": "A friendly manga-style female teacher with glasses stands beside a wooden table. On the table, there is a diverse collection of single items: one apple, one small toy robot, one teacup, one rock, and one origami crane. The teacher has a gentle, welcoming smile and is gesturing towards the items with an open palm, as if presenting a puzzle. The background is a simple, soft-focus classroom setting. Style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "This page introduces the fundamental concept of 'josuushi' (counters) and explains why they are essential in Japanese. Students will learn the most versatile and universal counter, 〜つ (tsu), which is used for counting native Japanese numbers from one to ten when the specific counter is unknown or not needed."
    },
    {
        "page_number": 3,
        "title": "人を数える (Hito o Kazoeru) - Counting People",
        "keywords": "nin, hitori, futari, sannin, people, person, exceptions, counting people",
        "image_concept": "A scene at a crosswalk in a friendly Japanese town. A single high school student in a uniform (a boy) is waiting on one side. On the other side, a pair of friends (two girls) are chatting and waiting together. Further in the background, a small family of three (father, mother, small child) are walking together. This visually separates the concepts of 1, 2, and 3+ people. Style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Students will learn the specific counter for people, 〜人 (nin). This page will emphasize the crucial and very common exceptions for one person (一人, hitori) and two people (二人, futari), before showing the regular pattern from three people (三人, sannin) onwards."
    },
    {
        "page_number": 4,
        "title": "モノの三銃士：個、本、枚 (Mono no Sanjuushi: Ko, Hon, Mai) - The Three Musketeers of Objects",
        "keywords": "ko, hon, mai, objects, shape, flat, long, small, compact, cylindrical",
        "image_concept": "A triptych-style image showing three distinct categories. Panel 1: A wooden bowl filled with several small, round items like mochi and a few strawberries (for 個, ko). Panel 2: A stylish pencil holder containing three pencils, two pens, and a rolled-up poster (for 本, hon). Panel 3: A neat stack of three folded t-shirts next to a fanned-out hand of five playing cards (for 枚, mai). Style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "This page introduces the three most essential counters for inanimate objects. Students will learn to differentiate and use: 〜個 (ko) for small, compact, or roundish items; 〜本 (hon) for long, thin, cylindrical items; and 〜枚 (mai) for thin, flat items."
    },
    {
        "page_number": 5,
        "title": "音の変化に注意！(Oto no Henka ni Chuui!) - Watch Out for Sound Changes!",
        "keywords": "rendaku, handakuten, sound change, iki, sanbon, roppon, ippiki, sanbiki",
        "image_concept": "A dynamic, split-panel image. On the left side, a cute manga character is holding one bottle of soda and has a small, sharp 'pop!' visual effect near the bottle, representing 'ippon'. On the right side, the same character is struggling to hold three bottles of soda, and there's a softer, buzzing visual effect near the bottles, representing 'sanbon'. The character's expression changes from determined to slightly overwhelmed. Style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "This page tackles the tricky but important concept of sound changes (rendaku, etc.) that occur with certain number and counter combinations. It will focus on the most common patterns using 〜本 (hon → pon/bon) and 〜匹 (hiki → piki/biki) as the primary examples."
    },
    {
        "page_number": 6,
        "title": "動物の数え方 (Doubutsu no Kazoekata) - How to Count Animals",
        "keywords": "hiki, piki, biki, tou, wa, animals, small animals, large animals, birds",
        "image_concept": "A scenic view of a Japanese park with a pond. In the foreground, two small puppies (for 匹, hiki) are playing on the grass. In the mid-ground, a large statue of a horse stands prominently (for 頭, tou). In the background, three ducks (for 羽, wa) are swimming in the pond. This creates a clear visual distinction between the animal categories. Style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Students will learn how to count animals based on their size. This page introduces 〜匹 (hiki) for small animals (cats, dogs, fish), 〜頭 (tou) for large animals (elephants, cows, horses), and 〜羽 (wa) for birds (and rabbits)."
    },
    {
        "page_number": 7,
        "title": "もっと詳しく：専門の助数詞 (Motto Kuwashiku: Senmon no Josuushi) - More Details: Specialized Counters",
        "keywords": "satsu, dai, hai, pai, bai, books, machines, vehicles, drinks, cups",
        "image_concept": "A cozy, modern Japanese apartment room. On a desk, there is a laptop computer and a digital camera (for 台, dai). Next to the desk is a small bookshelf with a neat stack of five manga volumes (for 冊, satsu). On the coffee table in front of a sofa, there are two steaming mugs of coffee (for 杯, hai). Style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Expand your counting abilities with more specialized, yet common, counters. This page covers 〜冊 (satsu) for bound items like books and magazines, 〜台 (dai) for machines and vehicles like computers and bicycles, and 〜杯 (hai) for cupfuls or bowlfuls of liquid."
    },
    {
        "page_number": 8,
        "title": "質問してみよう！(Shitsumon shite miyou!) - Let's Try Asking!",
        "keywords": "ikutsu, nan-nin, nan-bon, nan-biki, question words, asking, how many",
        "image_concept": "A bright and friendly scene at a Japanese bakery. A young customer with a curious expression is pointing towards a tray of croissants. A large, stylized, empty speech bubble with a question mark shape inside it appears above the customer's head. The smiling baker is holding up four fingers and pointing to the croissants, as if answering the question 'How many?'. Style is cute manga/anime with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "This page puts everything together by teaching students how to ask 'How many?'. It covers the general question word いくつ (ikutsu) as well as specific question forms like 何人 (nannin), 何本 (nanbon), and 何匹 (nanbiki), enabling students to use counters in real conversations."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing The Art of Japanese Counters: Mastering Josuushi - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="The Art of Japanese Counters: Mastering Josuushi - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about the art of japanese counters (josuushi), the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "josuushi, 助数詞, counters, counting, numbers, Japanese grammar, vocabulary, つ (tsu), 人 (nin), 匹 (hiki), 本 (hon), 個 (ko), 枚 (mai), sound changes, rendaku"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to The Art of Japanese Counters: Mastering Josuushi",
        ...
        conclusion_topic = "Conclusion for The Art of Japanese Counters: Mastering Josuushi lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "josuushi, 助数詞, counters, counting, numbers, Japanese grammar, vocabulary, つ (tsu), 人 (nin), 匹 (hiki), 本 (hon), 個 (ko), 枚 (mai), sound changes, rendaku, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="The Art of Japanese Counters: Mastering Josuushi - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="The Art of Japanese Counters: Mastering Josuushi - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of the art of japanese counters: mastering josuushi",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
