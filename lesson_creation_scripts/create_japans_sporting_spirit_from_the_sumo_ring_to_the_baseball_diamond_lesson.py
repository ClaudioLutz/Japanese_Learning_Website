...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japan's Sporting Spirit: From the Sumo Ring to the Baseball Diamond lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Japan's Sporting Spirit: From the Sumo Ring to the Baseball Diamond"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Explore the dynamic world of Japanese sports, from the ancient traditions of sumo to the modern passion for baseball. This lesson will equip you with the essential vocabulary and cultural context to discuss popular sports and understand their significant role in Japanese society."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Page 1: An Introduction to Sports - スポーツ入門 (Supo-tsu Nyuumon)",
        "keywords": "スポーツ (sports), 試合 (match), 選手 (player), 勝つ (to win), 負ける (to lose), 好き (to like), 人気 (popular)",
        "image_concept": "A dynamic and colorful composition of various sports equipment arranged artfully against a clean, neutral background. Include a baseball and bat, a sumo mawashi (loincloth), a kendo shinai (bamboo sword) and men (helmet), a judo black belt, and a soccer ball. The style is cute manga/anime with clean lines and cultural authenticity. No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Learn fundamental vocabulary for talking about sports in general. Students will practice expressing which sports are popular and which ones they personally like or dislike, using verbs like 'shimasu' (to do/play) with different sports."
    },
    {
        "page_number": 3,
        "title": "Page 2: The National Sport - 相撲の世界 (Sumou no Sekai)",
        "keywords": "相撲 (sumo), 力士 (rikishi/sumo wrestler), 土俵 (dohyo/ring), 横綱 (yokozuna/grand champion), 稽古 (keiko/practice), 伝統 (tradition), 儀式 (ritual)",
        "image_concept": "Two chibi-style sumo wrestlers (rikishi) in a powerful crouched stance, facing each other in the center of a straw dohyo. One wrestler has a serious expression, the other a determined one. In the background, a referee in traditional, ornate clothing holds a gunbai (war fan). The style is cute manga/anime with clean lines and cultural authenticity. No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Delve into the ancient world of sumo. This page covers key terminology specific to sumo wrestling, the hierarchy of wrestlers, and the cultural importance of its Shinto-based rituals and traditions."
    },
    {
        "page_number": 4,
        "title": "Page 3: The National Passion - 国民的人気：野球 (Kokuminteki Ninki: Yakyuu)",
        "keywords": "野球 (baseball), 投手 (pitcher), 打者 (batter), ホームラン (home run), 甲子園 (Koshien), プロ野球 (professional baseball), 応援 (cheering)",
        "image_concept": "An anime-style baseball pitcher on a bright, sunny day, in the middle of a powerful wind-up motion on the pitcher's mound. His uniform is pristine. The catcher is visible in the background, mitt ready. The stadium field is a vibrant green with a perfectly raked dirt infield. The style is cute manga/anime with clean lines and cultural authenticity. No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Discover why baseball is Japan's most beloved modern sport. Learn vocabulary for key positions and plays, and understand the cultural significance of both professional leagues and the wildly popular National High School Baseball Championship (Koshien)."
    },
    {
        "page_number": 5,
        "title": "Page 4: The Way of the Warrior - 武道の精神 (Budou no Seishin)",
        "keywords": "武道 (budo/martial arts), 柔道 (judo), 剣道 (kendo), 空手 (karate), 道場 (dojo), 先生 (sensei/teacher), 精神 (spirit/mind)",
        "image_concept": "Three cute anime characters practicing different martial arts inside a traditional dojo with wooden floors and shoji screens. One character in a judogi is performing a gentle throw on another. A third character in full kendo armor stands in a ready stance with a shinai. The atmosphere is one of focus and mutual respect. The style is cute manga/anime with clean lines and cultural authenticity. No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Explore the philosophical and physical discipline of Budo (the Martial Way). This page introduces the core concepts and vocabulary for three major martial arts: Judo, Kendo, and Karate, emphasizing respect, discipline, and self-improvement."
    },
    {
        "page_number": 6,
        "title": "Page 5: School Sports Culture - 学校の部活 (Gakkou no Bukatsu)",
        "keywords": "部活 (bukatsu/club activity), 先輩 (senpai/senior), 後輩 (kouhai/junior), 練習 (renshuu/practice), チームワーク (teamwork), 厳しい (strict/tough)",
        "image_concept": "A group of anime high school students in various sports club uniforms (e.g., track, tennis, soccer) are gathered on the school grounds at sunset. They are stretching and chatting, looking tired but happy after a long practice. The school building is visible in the background. The style is cute manga/anime with clean lines and cultural authenticity. No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Understand the central role of 'bukatsu' (after-school club activities) in Japanese student life. This page explains the strict senpai-kouhai hierarchy, the grueling practice schedules, and the immense value placed on teamwork and perseverance."
    },
    {
        "page_number": 7,
        "title": "Page 6: The Art of Cheering - 応援の文化 (Ouen no Bunka)",
        "keywords": "応援 (ouen/cheering), 応援団 (ouendan/cheering squad), 頑張れ (ganbare/go for it!), ファイト (faito/fight!), 太鼓 (taiko/drum), 旗 (hata/flag)",
        "image_concept": "A passionate anime-style 'ouendan' in action. A male leader in a black gakuran uniform and a hachimaki (headband) is energetically waving a large fan. Behind him, another member beats a large taiko drum, and a third proudly holds a giant school flag that billows in the wind. Their faces show intense spirit and dedication. The style is cute manga/anime with clean lines and cultural authenticity. No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Learn how to cheer on your favorite team like a local. This page introduces common cheering phrases and explores the highly organized and passionate culture of 'ouendan' (cheering squads), complete with drums, flags, and synchronized chants."
    },
    {
        "page_number": 8,
        "title": "Page 7: Let's Watch a Game! - 試合を見に行こう！ (Shiai o Mi ni Ikou!)",
        "keywords": "チケット (ticket), 席 (seki/seat), どっちが勝ってる？ (who is winning?), すごい (amazing), 惜しい (so close!), 点 (ten/point)",
        "image_concept": "A first-person perspective from a seat high up in a brightly lit baseball stadium at night. The viewer's cute, anime-style hands are visible in the foreground, holding a tray with takoyaki and a drink cup with a straw. The field below is in focus, with tiny players in the middle of a game. The atmosphere is exciting and immersive. The style is cute manga/anime with clean lines and cultural authenticity. No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Apply your knowledge in a real-world scenario. This page provides practical conversational phrases for attending a live sports match, from buying tickets and finding your seat to reacting to the game's exciting moments."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Japan's Sporting Spirit: From the Sumo Ring to the Baseball Diamond - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Japan's Sporting Spirit: From the Sumo Ring to the Baseball Diamond - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about sports culture in japan: sumo, baseball, and more, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "スポーツ (sports), 相撲 (sumo), 野球 (baseball), 武道 (martial arts), 柔道 (judo), 剣道 (kendo), 選手 (athlete), 試合 (match), 応援 (cheering), 部活 (club activities), 頑張れ (go for it), 甲子園 (Koshien), 優勝 (championship), 伝統 (tradition)"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Japan's Sporting Spirit: From the Sumo Ring to the Baseball Diamond",
        ...
        conclusion_topic = "Conclusion for Japan's Sporting Spirit: From the Sumo Ring to the Baseball Diamond lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "スポーツ (sports), 相撲 (sumo), 野球 (baseball), 武道 (martial arts), 柔道 (judo), 剣道 (kendo), 選手 (athlete), 試合 (match), 応援 (cheering), 部活 (club activities), 頑張れ (go for it), 甲子園 (Koshien), 優勝 (championship), 伝統 (tradition), cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Japan's Sporting Spirit: From the Sumo Ring to the Baseball Diamond - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Japan's Sporting Spirit: From the Sumo Ring to the Baseball Diamond - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of japan's sporting spirit: from the sumo ring to the baseball diamond",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
