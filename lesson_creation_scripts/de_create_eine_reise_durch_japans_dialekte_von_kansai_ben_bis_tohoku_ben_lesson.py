...
LESSON_DESCRIPTION = "Entdecke die faszinierende sprachliche Vielfalt Japans jenseits des Standard-Tokio-Dialekts. Lerne die charakteristischen Klänge und Ausdrücke berühmter regionaler Dialekte wie Kansai-ben, Hakata-ben und Tohoku-ben kennen und verstehe, wie sie die lokale Kultur und Identität prägen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Was ist 'Hogen'? Eine Einführung (Hogen to wa? - 方言とは？)",
        "keywords": "Hogen, 方言, Hyojungo, 標準語, Standardjapanisch, Dialekt, Gemeinsprache, sprachliche Vielfalt",
        "image_concept": "Eine stilisierte, bunte Landkarte Japans. Aus den Regionen Kansai, Kyushu und Tohoku ragen niedliche, repräsentative Anime-Charaktere hervor, die freundlich winken. Die Karte selbst ist vereinfacht und ohne jeglichen Text. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen den Unterschied zwischen dem Standardjapanisch (Hyōjungo), das in Lehrbüchern gelehrt wird, und den regionalen Dialekten (Hōgen) kennen. Es wird erklärt, warum Dialekte existieren und welche Rolle sie in der japanischen Gesellschaft spielen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Der lebhafte Kansai-Dialekt (Kansai-ben - 関西弁)",
        "keywords": "Kansai-ben, 関西弁, Osaka-ben, 大阪弁, meccha,めっちゃ, akan, あかん, nandeyanen, なんでやん, Comedy, Manzai",
        "image_concept": "Zwei Anime-Freunde in Osaka. Einer trägt eine Baseballkappe (ohne Logo) und macht eine übertriebene, komische Geste, während der andere lacht. Im Hintergrund ist die stilisierte Silhouette von Osaka Castle erkennbar. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite stellt den wohl bekanntesten Dialekt vor: Kansai-ben. Die Lernenden entdecken typische Vokabeln wie 'meccha' (sehr), 'akan' (nicht gut/unmöglich) und den berühmten komödiantischen Einwand 'nandeyanen' (Was soll das?)."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Grammatik im Kansai-Dialekt (Kansai-ben no Bunpo - 関西弁の文法)",
        "keywords": "Grammatik, Bunpo, 文法, Verneinung, -hen, へん, Kopula, ya, や, wakarahen, わからへん",
        "image_concept": "Ein freundlicher Anime-Lehrer steht vor zwei großen, leeren Sprechblasen. Eine Sprechblase ist schlicht (Standard), die andere hat ein energiegeladenes, blitzartiges Muster (Kansai). Der Lehrer deutet vergleichend von einer zur anderen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier geht es um die Grammatik des Kansai-Dialekts. Die Studierenden lernen, wie die Standard-Verneinung '-nai' zu '-hen' wird (z.B. tabenai -> tabehen) und die Kopula 'da' durch 'ya' ersetzt wird (z.B. sou da -> sou ya)."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Der charmante Hakata-Dialekt (Hakata-ben - 博多弁)",
        "keywords": "Hakata-ben, 博多弁, Fukuoka, 福岡, Satzende, -to, ～と, -bai, ～ばい, -tai, ～たい, kawaii,かわいい",
        "image_concept": "Eine freundliche Anime-Figur reicht eine dampfende Schüssel Ramen über den Tresen eines Yatai (traditioneller Imbissstand) in einer gemütlichen Abendstimmung. Die Szene strahlt Wärme und Gastfreundschaft aus. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Lernenden entdecken den Dialekt aus Fukuoka, der oft als 'niedlich' oder 'warm' empfunden wird. Im Fokus stehen die charakteristischen Satzendpartikeln wie '-to?' für Fragen (statt 'no?') und die betonenden Partikeln '-bai' und '-tai'."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Der ländliche Tohoku-Dialekt (Tohoku-ben - 東北弁)",
        "keywords": "Tohoku-ben, 東北弁, Zūzū-ben, ズーズー弁, Aussprache, -be, ～べ, -da, ～だ, ländlich, inaka",
        "image_concept": "Ein Anime-Charakter in warmer Winterkleidung mit Schal und Mütze steht in einer wunderschönen, verschneiten Landschaft. Im Hintergrund sind traditionelle japanische Bauernhäuser zu sehen. Der Charakter hält einen einzelnen, perfekten Apfel in der Hand. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt den Tohoku-Dialekt, der für seine besondere, oft als schwer verständlich geltende Aussprache (Zūzū-ben) bekannt ist. Die Lernenden lernen die typischen Satzendungen '-be' (Aufforderung) und '-da' (Zustimmung) kennen."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Dialekte in Anime & Manga (Anime to Manga no Hogen - アニメと漫画の方言)",
        "keywords": "Anime, アニメ, Manga, 漫画, Popkultur, Charakter, Archetyp, stereotypische Darstellung, Stimm-Schauspieler, Seiyuu",
        "image_concept": "Eine dynamische Komposition aus drei großen, ausdrucksstarken Anime-Gesichtern. Ein Gesicht lacht schallend (Kansai-Stereotyp), eines lächelt sanft und warm (Hakata-Stereotyp) und eines blickt ruhig und gütig (Tohoku-Stereotyp). Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen, wie Dialekte in der japanischen Popkultur eingesetzt werden, um Charaktere zu definieren. Es wird erklärt, welche Stereotypen oft mit bestimmten Dialekten verbunden sind (z.B. der lustige Osakaner, der stoische Landbewohner)."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Hörverständnis: Dialekte erkennen (Chokai: Hogen no Kikiwake - 聴解：方言の聞き分け)",
        "keywords": "Hörverständnis, Chokai, 聴解, Erkennungsmerkmale, Zusammenfassung, Übung, kikiwake, 聞き分け",
        "image_concept": "Ein Anime-Charakter sitzt mit einem nachdenklichen, konzentrierten Gesichtsausdruck da und trägt Kopfhörer. Um den Kopf schweben drei verschiedenfarbige Sprechblasen mit abstrakten Mustern darin: eine mit einem feurigen Wirbel, eine mit sanften Wellen und eine mit einem Schneekristall-Muster. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Eine zusammenfassende Übungsseite. Die wichtigsten Erkennungsmerkmale der drei behandelten Dialekte (Wortwahl, Satzende, Intonation) werden wiederholt. Die Lernenden werden herausgefordert, kurze Sätze gedanklich dem richtigen Dialekt zuzuordnen."
    }
]
