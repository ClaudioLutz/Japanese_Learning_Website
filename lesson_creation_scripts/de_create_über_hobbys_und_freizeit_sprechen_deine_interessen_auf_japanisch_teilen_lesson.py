...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Über Hobbys und Freizeit sprechen: Deine Interessen auf Japanisch teilen\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Über Hobbys und Freizeit sprechen: Deine Interessen auf Japanisch teilen"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Lerne, wie du auf Japanisch über deine Hobbys und Lieblingsbeschäftigungen sprechen kannst. Von Vokabeln für beliebte Aktivitäten bis hin zu einfachen Sätzen, um deine Interessen zu teilen und nach denen anderer zu fragen – diese Lektion macht dich fit für den Small Talk!"

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundwortschatz für Hobbys (Shumi no Kihon Tango - 趣味の基本単語)",
        "keywords": "Hobby, 趣味, shumi, Lesen, 読書, dokusho, Film, 映画, eiga, Sport, スポーツ, supootsu, Musik, 音楽, ongaku",
        "image_concept": "Eine vielfältige Gruppe von drei fröhlichen jungen Menschen im Anime-Stil. Über ihren Köpfen schweben bunte Symbole, die verschiedene Hobbys repräsentieren: ein offenes Buch, eine Filmklappe, ein Fußball und eine Musiknote. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In dieser Einführung lernst du das grundlegende Vokabular für die gängigsten Hobbys und Freizeitaktivitäten in Japan, um eine Basis für die folgenden Lektionen zu schaffen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Sagen, was dein Hobby ist (Shumi wa ... desu - 趣味は～です)",
        "keywords": "Grammatik, Satzstruktur, ～は～です, wa ... desu, Mein Hobby ist, 私の趣味, watashi no shumi",
        "image_concept": "Ein fröhliches Mädchen im Manga-Stil steht stolz vor einem großen, gut gefüllten Bücherregal. Sie zeigt mit dem Daumen auf sich selbst und lächelt zuversichtlich, als ob sie sagt: 'Mein Hobby ist Lesen'. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne die einfachste grammatikalische Struktur, um dein Hobby vorzustellen: 「趣味は [Hobby] です」 (Shumi wa [Hobby] desu). Du übst, vollständige Sätze mit den Vokabeln von der ersten Seite zu bilden."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Sagen, was du magst (Suki desu - ～が好きです)",
        "keywords": "mögen, lieben, 好きです, suki desu, Partikel が, ga, Vorlieben, 好み, konomi",
        "image_concept": "Ein liebenswerter Junge im Anime-Stil, der sanft eine flauschige Katze umarmt. Große, rosa Herzen schweben um sie herum, um das Gefühl von Zuneigung und 'mögen' (suki) zu verdeutlichen. Die Szene ist sehr herzerwärmend und süß. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernst du eine natürlichere und häufig verwendete Ausdrucksweise: 「[Hobby] が好きです」 ([Hobby] ga suki desu), um auszudrücken, was du magst. Wir erklären die Funktion des Partikels 'ga' in diesem Kontext."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Über Aktivitäten sprechen (...o shimasu - ～をします)",
        "keywords": "machen, tun, します, shimasu, Partikel を, o, Videospiele, ゲーム, geemu, Sport treiben, スポーツをします",
        "image_concept": "Zwei Freunde, ein Junge und ein Mädchen, sitzen auf dem Boden und spielen begeistert Videospiele auf einer Konsole. Sie halten Controller in den Händen und haben konzentrierte, aber fröhliche Gesichtsausdrücke. Dynamische Linien um sie herum deuten auf Action hin. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Für Hobbys, die eine aktive Handlung beinhalten (wie Sport oder Spiele), lernst du die Struktur 「[Aktivität] をします」 ([Aktivität] o shimasu). Wir behandeln den Unterschied zwischen 'suki desu' und 'shimasu'."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Nach den Hobbys anderer fragen (Shitsumon suru - 質問する)",
        "keywords": "Frage, 質問, shitsumon, Was ist dein Hobby?, 趣味は何ですか, shumi wa nan desu ka, Fragewörter, 疑問詞, gimonshi",
        "image_concept": "Zwei Charaktere sitzen sich an einem Tisch in einem Café gegenüber. Ein Charakter lehnt sich neugierig vor und über seinem Kopf schwebt ein großes, stilisiertes Fragezeichen, das seine Frage symbolisiert. Der andere Charakter hört aufmerksam zu. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne, wie du ein Gespräch über Hobbys beginnst, indem du die entscheidende Frage stellst: 「趣味は何ですか」 (Shumi wa nan desu ka?). Du wirst auch alternative, etwas lässigere Frageformen kennenlernen."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Wortschatz erweitern: Tradition & Moderne (Dentou to Gendai - 伝統と現代)",
        "keywords": "Kalligraphie, 書道, shodou, Teezeremonie, 茶道, sadou, Karaoke, カラオケ, Anime, アニメ, Manga, 漫画",
        "image_concept": "Ein geteiltes Bild. Auf der linken Seite praktiziert eine Figur in traditioneller japanischer Kleidung (Kimono) in einem ruhigen Raum Kalligraphie (shodou). Auf der rechten Seite singt eine andere Figur in moderner Kleidung leidenschaftlich in ein Mikrofon in einer bunten Karaoke-Box. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erweitere deinen Wortschatz mit spezifisch japanischen Hobbys. Wir stellen traditionelle Künste wie Kalligraphie (書道) und moderne Phänomene wie Anime, Manga und Karaoke vor."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Kultureller Einblick & Konversation (Bunka to Kaiwa - 文化と会話)",
        "keywords": "Schulklub, 部活, bukatsu, Gespräch, 会話, kaiwa, Kultur, 文化, bunka, soziale Interaktion",
        "image_concept": "Eine Szene auf einem japanischen Schulgelände. Im Hintergrund sieht man das Schulgebäude. Im Vordergrund sind verschiedene Schülergruppen in ihren Schuluniformen zu sehen, die an Klubaktivitäten (bukatsu) teilnehmen: eine Gruppe spielt Baseball, eine andere malt an Staffeleien. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Tauche in die japanische Kultur ein und lerne die Bedeutung von Schulklubs (部活 - bukatsu) kennen. Zum Abschluss übst du ein kurzes Beispieldialog, in dem zwei Personen alle gelernten Sätze anwenden, um sich über ihre Hobbys auszutauschen."
    }
]
