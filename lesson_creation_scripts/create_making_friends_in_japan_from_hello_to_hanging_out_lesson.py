...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Making Friends in Japan: From 'Hello' to Hanging Out lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Making Friends in Japan: From 'Hello' to Hanging Out"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Master the essential phrases and cultural etiquette for making genuine connections in Japan. This lesson will guide you from your first conversation to making plans and building lasting friendships."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Page 1 - 最初の挨拶 (Saisho no Aisatsu)",
        "keywords": "icebreaker, first meeting, conversation starter, jiko shoukai, hajimemashite",
        "image_concept": "Two young adults, one male and one female, meeting for the first time in a bright, modern university classroom. They are smiling and bowing slightly to each other in a gesture of introduction. The style is a cute manga/anime art style with clean lines and cultural authenticity. No text, writing, signs, or characters are visible.",
        "content_focus": "Learn how to initiate a conversation beyond a simple 'Konnichiwa'. This page covers natural ways to approach someone in a shared context like a class, club, or social event, and how to give a brief self-introduction."
    },
    {
        "page_number": 3,
        "title": "Page 2 - 共通の話題 (Kyoutsuu no Wadai)",
        "keywords": "hobbies, interests, shumi, suki, kyoumi, asking questions",
        "image_concept": "A small, diverse group of three friends sitting on floor cushions in a cozy Japanese-style room. One person is excitedly showing a manga volume to the others, another is holding a video game controller, and the third is listening with a big smile. The style is a cute manga/anime art style with clean lines and cultural authenticity. No text, writing, signs, or characters are visible.",
        "content_focus": "Discover how to find common ground by asking about hobbies and interests. This page focuses on question-and-answer patterns using 'Shumi wa nan desu ka?' and related vocabulary for popular Japanese pastimes like anime, games, music, and sports."
    },
    {
        "page_number": 4,
        "title": "Page 3 - 相槌の達人 (Aizuchi no Tatsujin)",
        "keywords": "aizuchi, active listening, sou desu ne, naruhodo, ee, un, conversational flow",
        "image_concept": "A close-up, side-profile view of two people in an engaging conversation. The person on the left is speaking with expressive hand gestures, while the person on the right is listening intently, nodding, with a warm and encouraging facial expression. The style is a cute manga/anime art style with clean lines and cultural authenticity. No text, writing, signs, or characters are visible.",
        "content_focus": "Master the Japanese art of active listening through 'aizuchi'. This page explains the importance of interjections like 'hai', 'sou desu ne', and 'naruhodo' to show you are engaged in the conversation and encourage the speaker."
    },
    {
        "page_number": 5,
        "title": "Page 4 - 誘ってみよう！ (Sasotte miyou!)",
        "keywords": "invitation, sasou, making plans, issho ni, ~masen ka, ~mashou",
        "image_concept": "Two friends are standing on a stylish urban street. One person is cheerfully pointing towards a charming, modern coffee shop in the background, making an inviting gesture to the other, who looks pleased and interested. The style is a cute manga/anime art style with clean lines and cultural authenticity. No text, writing, signs, or characters are visible.",
        "content_focus": "Learn how to confidently ask someone to hang out. This page introduces key grammar patterns like '~masen ka?' (Won't you...?) and '~mashou' (Let's...!) for making invitations for coffee, lunch, movies, or other social activities."
    },
    {
        "page_number": 6,
        "title": "Page 5 - 上手な断り方 (Jouzu na Kotowarikata)",
        "keywords": "accepting, declining, kotowaru, enryo, chotto, mata kondo",
        "image_concept": "A person looking apologetic holds up a hand in a gentle 'stop' gesture while looking at their smartphone calendar with a regretful expression. The friend who invited them is smiling understandingly, not looking offended. The style is a cute manga/anime art style with clean lines and cultural authenticity. No text, writing, signs, or characters are visible.",
        "content_focus": "Understand the nuances of accepting and declining invitations. This page covers enthusiastic ways to say yes, and more importantly, culturally appropriate and polite ways to say no using vague expressions like 'chotto...' to avoid causing offense."
    },
    {
        "page_number": 7,
        "title": "Page 6 - 雑談のネタ (Zatsudan no Neta)",
        "keywords": "small talk, zatsudan, weather, food, travel, safe topics",
        "image_concept": "Three friends are sitting together on a park bench, laughing and chatting. One is drinking from a bottle of tea from a vending machine, another is eating a taiyaki pastry. The background shows beautiful autumn foliage. The style is a cute manga/anime art style with clean lines and cultural authenticity. No text, writing, signs, or characters are visible.",
        "content_focus": "Build your conversational stamina with common small talk topics. This page provides vocabulary and phrases for discussing safe and popular subjects in Japan, such as weather, seasonal foods, travel destinations, and popular TV shows or movies."
    },
    {
        "page_number": 8,
        "title": "Page 7 - 「知り合い」から「友達」へ (Shiriai kara Tomodachi e)",
        "keywords": "tomodachi, shiriai, relationship building, group harmony, wa, nakayoku naru",
        "image_concept": "A happy group of four or five established friends posing for a fun selfie. They are huddled close together, making peace signs and laughing. The background is a soft-focus, generic festive scene, like a local festival with lanterns (no writing on them). The feeling is one of comfort, familiarity, and deep friendship. The style is a cute manga/anime art style with clean lines and cultural authenticity. No text, writing, signs, or characters are visible.",
        "content_focus": "Explore the cultural definition of friendship in Japan. This page discusses the difference between an acquaintance ('shiriai') and a friend ('tomodachi'), the importance of group harmony ('wa'), and how relationships deepen over time through shared experiences."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Making Friends in Japan: From 'Hello' to Hanging Out - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Making Friends in Japan: From 'Hello' to Hanging Out - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about making friends and socializing in japan, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "friendship, tomodachi, socializing, kaiwa, jiko shoukai, shumi, yotei, sasoi, aizuchi, Japanese culture, communication, group harmony, enryo, small talk, nomikai"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Making Friends in Japan: From 'Hello' to Hanging Out",
        ...
        conclusion_topic = "Conclusion for Making Friends in Japan: From 'Hello' to Hanging Out lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "friendship, tomodachi, socializing, kaiwa, jiko shoukai, shumi, yotei, sasoi, aizuchi, Japanese culture, communication, group harmony, enryo, small talk, nomikai, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Making Friends in Japan: From 'Hello' to Hanging Out - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Making Friends in Japan: From 'Hello' to Hanging Out - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of making friends in japan: from 'hello' to hanging out",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
