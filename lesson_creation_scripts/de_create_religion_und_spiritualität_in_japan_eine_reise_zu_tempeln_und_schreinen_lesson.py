...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Religion und Spiritualität in Japan: Eine Reise zu Tempeln und Schreinen\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Religion und Spiritualität in Japan: Eine Reise zu Tempeln und Schreinen"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Entdecke die faszinierende Welt des Shintoismus und Buddhismus in Japan. Lerne, wie man Tempel und Schreine besucht, an Zeremonien teilnimmt und über spirituelle Praktiken spricht."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Schrein oder Tempel? (Jinja to Otera - 神社とお寺)",
        "keywords": "Schrein, Jinja, 神社, Tempel, Otera, お寺, Shintoismus, Shintō, 神道, Buddhismus, Bukkyō, 仏教, Unterschied, Religion",
        "image_concept": "Eine Split-Screen-Illustration. Auf der linken Seite steht eine niedliche Manga-Figur vor einem schlichten, roten Shinto-Torii-Tor, das in einen Wald führt. Auf der rechten Seite steht dieselbe Figur vor einem verzierten, mehrstöckigen buddhistischen Tempeltor (Sanmon) mit einer großen Bronzeglocke in der Nähe. Die Stile der Gebäude sind klar unterscheidbar, aber harmonisch dargestellt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du lernst die grundlegenden Unterschiede zwischen einem Shinto-Schrein (Jinja) und einem buddhistischen Tempel (Otera). Dies umfasst typische architektonische Merkmale, die jeweilige Symbolik und die zugehörige Religion."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Ein Schreinbesuch (Jinja Mairi - 神社参り)",
        "keywords": "Schreinbesuch, Jinja Mairi, 神社参り, Torii, 鳥居, Reinigungsritual, Temizu, 手水, Beten, Haiden, 拝殿, Klatschen, Kashiwade, 柏手, Opfergabe, O-saisen, お賽銭",
        "image_concept": "Eine niedliche Anime-Figur führt das Wasserreinigungsritual an einem Temizuya (Wasserbecken) durch. Die Figur hält eine hölzerne Kelle (hishaku) über ein Steinbecken mit fließendem Wasser. Kirschblütenblätter könnten in der Luft schweben. Die Figur schaut konzentriert und respektvoll. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du lernst Schritt für Schritt die richtige Etikette beim Besuch eines Shinto-Schreins: die Verbeugung am Torii, das Reinigungsritual am Temizuya und die Gebetszeremonie (zwei Verbeugungen, zweimal Klatschen, eine Verbeugung)."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Ein Tempelbesuch (Otera Mairi - お寺参り)",
        "keywords": "Tempelbesuch, Otera Mairi, お寺参り, Tempeltor, Sanmon, 山門, Weihrauch, Osenkō, お線香, Gebetshaltung, Gasshō, 合掌, Buddha-Statue, Butsuzō, 仏像",
        "image_concept": "Eine kawaii Manga-Figur steht respektvoll vor einem großen Weihrauchgefäß (kōro) vor einem Tempelgebäude. Die Figur hat ihre Hände in der Gasshō-Gebetshaltung gefaltet. Rauchschwaden steigen aus dem Gefäß auf. Die Atmosphäre ist ruhig und friedlich. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du lernst die Etikette beim Besuch eines buddhistischen Tempels. Das beinhaltet das Durchschreiten des Haupttors (Sanmon), das Anzünden von Weihrauch (Osenkō) und die richtige Gebetshaltung (Gasshō) mit gefalteten Händen, aber ohne Klatschen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Götter & Buddhas (Kami-sama to Hotoke-sama - 神様と仏様)",
        "keywords": "Götter, Kami, 神, Buddha, Hotoke, 仏, Shinto-Gottheiten, Buddhistische Figuren, Naturgeister, Erleuchtung, Satori, 悟り, Bodhisattva, Bosatsu, 菩薩",
        "image_concept": "Zwei niedliche, stilisierte spirituelle Figuren schweben nebeneinander. Links ein freundlicher, naturbasierter Kami-Geist, der vielleicht wie ein sanfter Fuchs oder ein Wesen aus Blättern und Licht aussieht. Rechts eine heitere, meditierende junge Buddha-Figur mit klassischen Merkmalen, die auf einer Lotusblume sitzt. Sie sind einander freundlich gesinnt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du lernst die zentralen Figuren und Konzepte beider Religionen kennen: die unzähligen Kami (Götter und Geister) des Shinto, die oft in der Natur zu finden sind, und die verschiedenen Buddhas und Bodhisattvas des Buddhismus, die den Weg zur Erleuchtung weisen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Glücksbringer und Wahrsagerei (Omamori to Omikuji - お守りとおみくじ)",
        "keywords": "Glücksbringer, Omamori, お守り, Wahrsagezettel, Omikuji, おみくじ, Glück, Kichi, 吉, Pech, Kyō, 凶, Votivtafeln, Ema, 絵馬",
        "image_concept": "Eine Anime-Figur schaut aufgeregt auf ein Omikuji (Papierorakel), das sie gerade ausgerollt hat. Im Hintergrund ist eine Holzkonstruktion, an die viele andere gefaltete Omikuji an Schnüren gebunden sind. In der Nähe hält eine andere Figur glücklich eine kleine, bunte Omamori-Tasche (Amulett). Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du entdeckst beliebte spirituelle Gegenstände und Praktiken. Lerne, was Omamori (Schutzamulette) für verschiedene Zwecke sind, wie man Omikuji (Papier-Orakel) zieht und was man mit ihnen macht, und wofür Ema (Holztafeln für Wünsche) verwendet werden."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Religiöse Feste und Zeremonien (Matsuri to Gyōji - 祭りと行事)",
        "keywords": "Fest, Matsuri, 祭り, Neujahrsbesuch, Hatsumōde, 初詣, Ahnenfest, Obon, お盆, Shichi-Go-San, 七五三, Hochzeit, Kekkonshiki, 結婚式, Beerdigung, Osōshiki, お葬式",
        "image_concept": "Eine lebhafte Festivalszene (Matsuri) bei Nacht. Niedliche Manga-Figuren in traditionellen Sommer-Yukatas beobachten ein Feuerwerk über einer Pagode eines Tempels oder Schreins. Eine Figur isst einen kandierten Apfel. Papierlaternen sind aufgehängt und verbreiten ein warmes Licht. Die Atmosphäre ist fröhlich und festlich. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du lernst wichtige religiöse Feste und Lebenszyklus-Zeremonien kennen. Dazu gehören der erste Schreinbesuch im neuen Jahr (Hatsumōde), das buddhistische Ahnenfest Obon und wie Shintoismus und Buddhismus bei Anlässen wie Hochzeiten und Beerdigungen oft unterschiedliche Rollen spielen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Glaube im Alltag (Seikatsu no naka no Shinkō - 生活の中の信仰)",
        "keywords": "Hausaltar (Shinto), Kamidana, 神棚, Hausaltar (Buddhistisch), Butsudan, 仏壇, Vor dem Essen, Itadakimasu, いただきます, Dankbarkeit, Kansha, 感謝, Synkretismus, Shūkyō-teki shinkuretizumu, 宗教的シンクレティズム",
        "image_concept": "Das Innere eines gemütlichen, modernen japanischen Wohnzimmers. Auf einem hohen Regal an einer Wand befindet sich ein kleiner, schlichter Shinto-Kamidana (Hausaltar). Auf einem niedrigeren Schrank an einer anderen Wand steht ein kleiner, geschlossener buddhistischer Butsudan. Eine freundliche Katze im Anime-Stil schläft auf dem Boden und vermittelt ein Gefühl von friedlichem Alltagsleben. Sonnenlicht scheint durch ein Fenster. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du verstehst, wie spirituelle Praktiken in den japanischen Alltag integriert sind. Dies umfasst den Hausaltar für Shinto-Götter (Kamidana) und den für buddhistische Ahnen (Butsudan) sowie die spirituelle Dimension von alltäglichen Ausdrücken der Dankbarkeit wie 'Itadakimasu'."
    }
]
