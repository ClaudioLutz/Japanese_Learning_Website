...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Japanisch für Debatten und Diskussionen: Meinungen souverän vertreten\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Japanisch für Debatten und Diskussionen: Meinungen souverän vertreten"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Meistere die Kunst der japanischen Diskussion! Lerne, wie du selbstbewusst deine Meinung äußerst, zustimmst oder höflich widersprichst. Diese Lektion vermittelt dir wichtige Ausdrücke und kulturelle Einblicke für eine respektvolle und effektive Kommunikation."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen der japanischen Diskussion (Kihon - 基本)",
        "keywords": "Grundlagen, Diskussion, Harmonie, 和 (wa), Gesprächskultur, Zuhören, Einleitung",
        "image_concept": "Eine Gruppe von vier diversen Anime-Charakteren sitzt in einem gemütlichen Kreis auf Tatami-Matten. Ein Charakter spricht gerade, während die anderen drei aufmerksam und mit leichtem Lächeln zuhören, was eine harmonische und respektvolle Atmosphäre vermittelt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die kulturellen Grundlagen japanischer Diskussionen kennen, insbesondere das Konzept der Harmonie (和, wa). Sie verstehen, warum indirekte Kommunikation und aktives Zuhören entscheidend sind, und lernen erste Phrasen zur Einleitung eines Gesprächs."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die eigene Meinung äußern (Iken o yuu - 意見を言う)",
        "keywords": "Meinung, äußern, ～と思います (to omoimasu), ～と考えます (to kangaemasu), Standpunkt, 意見 (iken), 個人的には (kojinteki ni wa)",
        "image_concept": "Ein Anime-Charakter mit einer nachdenklichen, aber zuversichtlichen Miene. Über seinem Kopf schwebt eine stilisierte, leuchtende Glühbirne, die eine Idee oder einen Gedanken symbolisiert. Der Hintergrund ist einfach gehalten, um den Fokus auf den Charakter und seine Mimik zu legen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die gebräuchlichsten und wichtigsten Formulierungen, um ihre eigene Meinung auszudrücken. Der Schwerpunkt liegt auf der fundamentalen Grammatikstruktur \"～と思います\" (~to omoimasu) und Varianten, um verschiedene Grade der Sicherheit und Förmlichkeit auszudrücken."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Zustimmung signalisieren (Sansei suru - 賛成する)",
        "keywords": "Zustimmung, einverstanden, Aizuchi (相槌), そうですね (sou desu ne), 確かに (tashika ni), 賛成です (sansei desu), nicken",
        "image_concept": "Zwei Anime-Charaktere stehen sich gegenüber, beide lächeln breit. Ein Charakter nickt enthusiastisch, während der andere ihm zustimmend einen Daumen nach oben zeigt. Die Körpersprache drückt volle Übereinstimmung und positive Energie aus. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen verschiedene Wege, um Zustimmung auszudrücken – von einfachen Bestätigungen (Aizuchi) wie 「はい」 oder 「ええ」 bis hin zu stärkeren Zustimmungen wie 「その通りです」. Es wird erklärt, wie man auf den Ideen anderer aufbaut, um das Gespräch positiv zu gestalten."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Höflich widersprechen (Enkyokuna hitei - 遠曲な否定)",
        "keywords": "Widerspruch, höflich, Kissenwörter, クッション言葉 (kusshon kotoba), ちょっと (chotto), 恐れ入りますが (osoreirimasu ga), indirekt",
        "image_concept": "Ein Anime-Charakter hebt beschwichtigend eine Hand mit der offenen Handfläche nach vorne, während er mit einem leicht entschuldigenden, aber ernsten Gesichtsausdruck zu einem anderen Charakter blickt. Die Geste signalisiert ein sanftes \"Moment mal\" oder eine höfliche Unterbrechung. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf die Kunst des indirekten und höflichen Widerspruchs. Die Studierenden lernen \"Kissenwörter\" (cushion words), um ihre abweichende Meinung sanft einzuleiten und eine direkte Konfrontation zu vermeiden, z.B. mit Phrasen wie 「それは一理ありますが、…」 (Das hat zwar etwas für sich, aber...)."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Klar und deutlich widersprechen (Hakkiri hantai suru - はっきり反対する)",
        "keywords": "Widersprechen, deutlich, 反対です (hantai desu), 違うと思います (chigau to omoimasu), formell, Business, sachlich",
        "image_concept": "Zwei Anime-Charaktere in Business-Kleidung stehen in einem modernen Büroraum vor einem großen, leeren Whiteboard. Sie schauen sich mit ernsten, fokussierten Mienen an. Einer der Charaktere zeigt auf eine Stelle auf dem leeren Board, der andere schüttelt leicht den Kopf, was eine sachliche Meinungsverschiedenheit andeutet. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen, wann und wie man in formelleren oder geschäftlichen Kontexten, in denen Klarheit Vorrang hat, direkter widersprechen kann. Es werden Ausdrücke wie 「反対です」 (Ich bin dagegen) vorgestellt und deren angemessener Gebrauch kontextualisiert."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Nachfragen und um Klärung bitten (Shitsumon & Kakunin - 質問＆確認)",
        "keywords": "Nachfragen, Klärung, Wie bitte?, どう思いますか (dou omoimasu ka), ～について (ni tsuite), もう一度 (mou ichido),確認 (kakunin)",
        "image_concept": "Ein freundlich aussehender Anime-Charakter schaut einen anderen Charakter mit einem fragenden Gesichtsausdruck an. Er zuckt leicht mit den Schultern und hat die Hände offen, als würde er eine Frage stellen. Über seinem Kopf ist eine stilisierte Wolke in Form eines Fragezeichens. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen, wie sie aktiv am Gespräch teilnehmen, indem sie die Meinung anderer erfragen (z.B. 「〇〇さんはどう思いますか」) und um Klärung bitten, falls sie etwas nicht verstanden haben (z.B. 「もう一度お願いします」)."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Eine Diskussion abschließen (Matome & Ketsuron - まとめ＆結論)",
        "keywords": "Zusammenfassung, Fazit, Abschluss, 結論として (ketsuron to shite), まとめると (matomeru to), Gesprächsende, Einigung",
        "image_concept": "Die gleiche Gruppe von Anime-Charakteren wie auf Seite 1. Sie wirken nun zufrieden und gelöst. Zwei von ihnen schütteln sich die Hände, während die anderen lächelnd zusehen oder sich leicht voreinander verbeugen, was einen erfolgreichen und positiven Abschluss der Diskussion symbolisiert. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss der Lektion lernen die Studierenden, wie man eine Diskussion zusammenfasst und zu einem Ende bringt. Sie üben Formulierungen, um die Hauptpunkte zu wiederholen (「まとめると、…」) und einen Konsens oder eine abschließende Bemerkung zu formulieren."
    }
]
