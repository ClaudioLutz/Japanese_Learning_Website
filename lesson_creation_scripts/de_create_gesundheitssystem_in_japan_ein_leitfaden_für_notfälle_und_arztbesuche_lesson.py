...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Gesundheitssystem in Japan: Ein Leitfaden für Notfälle und Arztbesuche\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Gesundheitssystem in Japan: Ein Leitfaden für Notfälle und Arztbesuche"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Fühl dich sicher und vorbereitet! Diese Lektion vermittelt dir das nötige Vokabular und die kulturellen Kenntnisse, um dich im japanischen Gesundheitssystem zurechtzufinden – vom Apothekenbesuch bis zum Notfall im Krankenhaus."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundwortschatz: Wer und Wo? (Kihon Goi: Dare to Doko? - 基本語彙：誰とどこ？)",
        "keywords": "Krankenhaus (Byouin - 病院), Klinik (Kurinikku - クリニック), Arzt (Isha - 医者), Krankenschwester (Kangoshi - 看護師), Apotheke (Yakkyoku - 薬局), Medikament (Kusuri - 薬)",
        "image_concept": "Ein freundlicher Anime-Arzt und eine lächelnde Anime-Krankenschwester stehen vor einem sauberen, modernen Klinikgebäude. Die Szene ist hell und einladend. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In dieser Einführungsseite lernst du die wichtigsten Substantive, um Orte und Personen im japanischen Gesundheitssystem zu identifizieren. Wir klären den Unterschied zwischen einem großen Krankenhaus (Byouin) und einer kleineren, spezialisierten Klinik (Kurinikku)."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Wie fühlst du dich? Symptome beschreiben (Shoujou o Setsumei suru - 症状を説明する)",
        "keywords": "Schmerzen (Itai - 痛い), Kopfschmerzen (Zutsuu - 頭痛), Fieber (Netsu - 熱), Husten (Seki - 咳), Erkältung (Kaze - 風邪), Übelkeit (Hakike - 吐き気), mir ist schlecht (Kibun ga warui - 気分が悪い)",
        "image_concept": "Ein niedlicher Anime-Charakter sitzt im Bett und sieht leicht krank aus, mit geröteten Wangen, einem Kühlpack auf der Stirn und einem Thermometer im Mund. Die Atmosphäre ist fürsorglich, nicht beängstigend. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernst du, deine Beschwerden und Symptome präzise auf Japanisch auszudrücken. Wir behandeln Vokabeln für gängige Krankheiten und Schmerzen sowie die nützliche Grammatikstruktur „～があります“ (ich habe ~) und das Adjektiv „itai“ (schmerzhaft)."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Der Arztbesuch: Von der Anmeldung bis zur Diagnose (Shinryou no Nagare - 診療の流れ)",
        "keywords": "Anmeldung (Uketsuke - 受付), Krankenversicherungskarte (Hokenshou - 保険証), Wartezimmer (Machiaishitsu - 待合室), Untersuchung (Shinsatsu - 診察), Rezept (Shohousen - 処方箋)",
        "image_concept": "Ein Anime-Charakter steht an einem modernen Empfangstresen einer Klinik und überreicht einer freundlichen Rezeptionistin eine kleine Karte (die Versicherungskarte). Im Hintergrund ist ein sauberes Wartezimmer mit Stühlen zu sehen. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite führt dich Schritt für Schritt durch einen typischen Arztbesuch in Japan. Du lernst, was du an der Rezeption sagen musst, die Bedeutung der „Hokenshou“ und welche Fragen der Arzt stellen könnte, wie zum Beispiel „Wo tut es weh?“ (Doko ga itai desu ka?)."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - In der Apotheke: Medikamente erhalten (Yakkyoku de: Kusuri o Morau - 薬局で：薬をもらう)",
        "keywords": "Apotheker (Yakuzaishi - 薬剤師), Medikamentenheft (Okusuri-techou - お薬手帳), Dosierung (Fukuyouryou - 服用量), nach dem Essen (Shokugo - 食後), vor dem Essen (Shokuzen - 食前)",
        "image_concept": "Ein freundlicher Anime-Apotheker in einem weißen Kittel steht hinter dem Tresen und zeigt einem Kunden ein kleines Notizbuch (das Okusuri-techou). Im Hintergrund sind Regale mit bunten, aber unbeschrifteten Medikamentenschachteln. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Nach dem Arzt geht es in die Apotheke. Hier erfährst du, wie du ein Rezept einlöst, was ein „Okusuri-techou“ ist und wie du Anweisungen zur Einnahme von Medikamenten verstehst, z. B. wie oft und ob vor oder nach dem Essen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Im Notfall: Hilfe rufen (Kinkyuu no Baai: Kyuukyuusha o Yobu - 緊急の場合：救急車を呼ぶ)",
        "keywords": "Notfall (Kinkyuu - 緊急), Krankenwagen (Kyuukyuusha - 救急車), Notruf 119 (Hyakujuukyuuban - 119番), Unfall (Jiko - 事故), Verletzung (Kega - 怪我), Adresse (Juusho - 住所)",
        "image_concept": "Ein Anime-Charakter telefoniert im Freien mit besorgtem Gesichtsausdruck. Im Hintergrund nähert sich ein stilisierter, niedlicher japanischer Krankenwagen (weiß mit einer roten Linie). Die Szene vermittelt Dringlichkeit, aber keine Panik. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite bereitet dich auf ernste Situationen vor. Du lernst, wie man die Notrufnummer 119 für einen Krankenwagen wählt und welche kritischen Informationen du am Telefon durchgeben musst, wie z.B. „Kaji desu ka? Kyuukyuu desu ka?“ (Feuer oder medizinischer Notfall?) und deine Adresse."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Im Krankenhaus: Abteilungen & stationärer Aufenthalt (Byouin: Bumon to Nyuuin - 病院：部門と入院)",
        "keywords": "Innere Medizin (Naika - 内科), Chirurgie (Geka - 外科), Orthopädie (Seikei-geka - 整形外科), Notaufnahme (Kyuukyuu Gairai - 救急外来), stationäre Aufnahme (Nyuuin - 入院)",
        "image_concept": "Ein Anime-Charakter steht in einem hellen, sauberen Krankenhausflur und betrachtet einen Wegweiser an der Wand. Der Wegweiser hat nur Symbole (z.B. ein Herz, einen Knochen, ein Stethoskop), keine Wörter, um die Abteilungen darzustellen. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Für komplexere Fälle lernst du hier die Bezeichnungen wichtiger Krankenhausabteilungen. Außerdem wird der Unterschied zwischen einer ambulanten Behandlung und einer stationären Aufnahme (Nyuuin) erklärt, einschließlich des damit verbundenen Vokabulars."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Kulturelle Feinheiten & Versicherungssystem (Bunka to Hoken Seido - 文化と保険制度)",
        "keywords": "ohne Termin (Yoyaku-nashi - 予約なし), Wartezeit (Machijikan - 待ち時間), Barzahlung (Genkin-barai - 現金払い), Höflichkeit, Dankbarkeit ausdrücken (Orei o iu - お礼を言う)",
        "image_concept": "Eine zweigeteilte Szene. Links sitzt ein Anime-Charakter geduldig in einem Wartezimmer und liest ein Buch. Rechts verbeugt sich derselbe Charakter respektvoll vor einem Arzt zum Abschied. Die Stimmung ist ruhig und höflich. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss fassen wir wichtige kulturelle Aspekte zusammen. Themen sind das in Japan übliche System der Arztbesuche ohne Termin, die daraus resultierenden langen Wartezeiten, die Wichtigkeit der Versicherungskarte und die angemessene Art, sich beim medizinischen Personal zu bedanken."
    }
]
