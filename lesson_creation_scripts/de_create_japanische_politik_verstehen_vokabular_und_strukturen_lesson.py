...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Japanische Politik verstehen: Vokabular und Strukturen\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Japanische Politik verstehen: Vokabular und Strukturen"
LESSON_DIFFICULTY = "Fortgeschritten"
LESSON_DESCRIPTION = "Tauche ein in die Welt der japanischen Politik! Lerne Schlüsselbegriffe, um über die Regierung, Wahlen und aktuelle Ereignisse zu sprechen und ein tieferes Verständnis für die japanische Gesellschaft zu entwickeln."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen der Politik (Seiji no Kiso - 政治の基礎)",
        "keywords": "Politik, 政治, seiji, Regierung, 政府, seifu, Land, 国, kuni, Bürger, 国民, kokumin, Demokratie, 民主主義, minshu shugi",
        "image_concept": "Eine vielfältige Gruppe von niedlichen Anime-Charakteren (ein Student, eine Büroangestellte, eine ältere Person) steht vor einer stilisierten, vereinfachten Landkarte von Japan. Sie sehen nachdenklich und engagiert aus, als würden sie über die Zukunft des Landes diskutieren. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite lernen Sie die grundlegendsten Begriffe, um über Politik, Regierung und Staat in Japan zu sprechen. Dies bildet die Basis für das Verständnis der komplexeren Strukturen, die in den folgenden Seiten behandelt werden."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Das japanische Parlament (Kokkai - 国会)",
        "keywords": "Parlament, 国会, kokkai, Oberhaus, 参議院, sangiin, Unterhaus, 衆議院, shūgiin, Abgeordneter, 議員, giin, Gesetzgebung, 立法, rippō",
        "image_concept": "Ein niedlicher, freundlich aussehender Biber in einem kleinen Anzug steht vor einem vereinfachten, aber wiedererkennbaren, großen Gebäude, das das Nationale Parlamentsgebäude (Kokkai-gijidō) darstellt. Der Biber hält eine kleine, zusammengerollte Schriftrolle (die ein Gesetz symbolisiert) in seinen Pfoten. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier erfahren Sie alles über das japanische Parlament, den Kokkai. Sie lernen die Struktur mit seinen zwei Kammern – dem Oberhaus und dem Unterhaus – sowie die Bezeichnungen für die Abgeordneten und den Prozess der Gesetzgebung kennen."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Die Exekutive: Premierminister & Kabinett (Sōri Daijin to Naikaku - 総理大臣と内閣)",
        "keywords": "Premierminister, 総理大臣, sōri daijin, Kabinett, 内閣, naikaku, Minister, 大臣, daijin, Ernennung, 任命, ninmei, Verwaltung, 行政, gyōsei",
        "image_concept": "Eine weise aussehende Anime-Eule mit Brille und Anzug steht an einem Podium. Hinter der Eule sitzen mehrere andere niedliche Tierfiguren (wie ein Fuchs, ein Bär, ein Hase) in Anzügen an einem Tisch, die das Kabinett repräsentieren. Die Szene spielt in einem formellen, aber freundlichen Besprechungsraum. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf die Exekutive. Sie lernen den Titel und die Rolle des japanischen Premierministers, des Regierungschefs, sowie die Zusammensetzung und Funktion seines Kabinetts kennen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Der Kaiser und die Kaiserliche Familie (Tennō to Kōshitsu - 天皇と皇室)",
        "keywords": "Kaiser, 天皇, tennō, Kaiserin, 皇后, kōgō, Kaiserpalast, 皇居, kōkyo, Symbol, 象徴, shōchō, Thron, 皇位, kōi",
        "image_concept": "Ein majestätischer, aber sanfter und niedlicher Kranich trägt eine kleine, elegante, stilisierte Krone. Der Kranich steht anmutig vor einem wunderschönen, traditionellen japanischen Garten mit einem Teich und einer Brücke, was an den Kaiserlichen Palastgarten erinnert. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erfahren Sie mehr über die einzigartige Rolle des Kaisers (Tennō) in der modernen japanischen Politik. Diese Seite erklärt seine rein symbolische und zeremonielle Funktion als „Symbol des Staates“, wie sie in der Nachkriegsverfassung festgelegt ist."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Wahlen und Politische Parteien (Senkyo to Seitō - 選挙と政党)",
        "keywords": "Wahl, 選挙, senkyo, Partei, 政党, seitō, stimmen, 投票する, tōhyō suru, Regierungspartei, 与党, yotō, Oppositionspartei, 野党, yatō",
        "image_concept": "Mehrere niedliche Anime-Figuren stehen geduldig in einer Schlange. Die erste Figur, eine fröhliche junge Frau, wirft gerade einen kleinen, leeren, gefalteten Zettel in eine stilisierte, einfache Wahlurne. Die Szene ist hell, positiv und vermittelt ein Gefühl von bürgerschaftlichem Engagement. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Wie werden politische Entscheidungen getroffen und wer sind die Hauptakteure? Diese Seite behandelt das Vokabular rund um Wahlen, den Akt des Wählens und das Konzept der politischen Parteien, einschließlich der Regierungspartei und der Opposition."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Verfassung und Gesetz (Kenpō to Hōritsu - 憲法と法律)",
        "keywords": "Verfassung, 憲法, kenpō, Gesetz, 法律, hōritsu, Artikel 9, 9条, kyū-jō, Recht, 権利, kenri, Pflicht, 義務, gimu",
        "image_concept": "Ein niedlicher, gelehrter Shiba Inu-Welpe mit Brille sitzt neben einem großen, alten, geschlossenen Buch, das auf dem Einband eine stilisierte Kirschblüte hat (es repräsentiert die Verfassung). Der Welpe hat eine Pfote nachdenklich auf das Buch gelegt und schaut auf. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Jedes Land hat seine Grundgesetze. Hier lernen Sie die Begriffe für Verfassung und Gesetz kennen. Ein besonderer Fokus liegt auf der japanischen Verfassung und ihrem berühmten pazifistischen Artikel 9, einem zentralen Thema in der politischen Diskussion Japans."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Über Politik diskutieren (Seiji o Kataru - 政治を語る)",
        "keywords": "Debatte, 討論, tōron, Problem, 問題, mondai, unterstützen, 賛成する, sansei suru, ablehnen, 反対する, hantai suru, Meinung, 意見, iken",
        "image_concept": "Zwei Gruppen niedlicher Anime-Charaktere sitzen an den gegenüberliegenden Seiten eines Tisches. Eine Gruppe zeigt den Daumen nach oben, die andere Gruppe den Daumen nach unten. In der Mitte des Tisches schwebt eine leuchtende Glühbirne, die eine 'Idee' oder ein 'Thema' symbolisiert. Ihre Gesichtsausdrücke sind leidenschaftlich, aber freundlich, nicht feindselig. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser letzten Seite wenden Sie Ihr Wissen an. Sie lernen Vokabeln, um politische Themen zu diskutieren, eine Meinung zu äußern und einem Standpunkt zuzustimmen oder ihn abzulehnen. Damit sind Sie gerüstet, um an politischen Gesprächen teilzunehmen."
    }
]
