...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Kochen auf Japanisch: Ein kulinarischer Sprachführer\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Kochen auf Japanisch: Ein kulinarischer Sprachführer"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Tauche ein in die Welt der japanischen Küche! Lerne essenzielle Vokabeln für Zutaten und Kochanweisungen und entdecke die Namen beliebter Gerichte, um selbstbewusst Rezepte zu lesen und in Japan Essen zu bestellen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundausstattung der Küche (Daidokoro no Dōgu - 台所の道具)",
        "keywords": "Küche (daidokoro), Messer (hōchō), Schneidebrett (manaita), Topf (nabe), Pfanne (furaipan), Reiskocher (suihanki), Stäbchen (hashi)",
        "image_concept": "Ein kawaii Anime-Mädchen mit Schürze steht stolz in einer hellen, sauberen Küche. Sie gestikuliert freudig in Richtung einer Arbeitsplatte, auf der ein japanisches Kochmesser (hōchō), ein hölzernes Schneidebrett (manaita), ein traditioneller Topf (nabe) und ein moderner Reiskocher (suihanki) ordentlich arrangiert sind. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In dieser Lektion lernen die Studierenden die japanischen Bezeichnungen für grundlegende Küchenutensilien und -geräte, die für die Zubereitung japanischer Gerichte unerlässlich sind."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Wichtige Zutaten (Omo na Shokuzai - 主な食材)",
        "keywords": "Reis (gohan/kome), Sojasauce (shōyu), Miso, Tofu, Seetang (nori), Fisch (sakana), Gemüse (yasai), Fleisch (niku), Dashi",
        "image_concept": "Eine Draufsicht im Flat-Lay-Stil auf einem Holztisch. Verschiedene japanische Zutaten sind kunstvoll angeordnet: eine Schale mit dampfendem weißen Reis, eine kleine, dunkle Flasche (für Sojasauce) ohne Etikett, ein Block Tofu, frischer Ingwer, eine Lauchzwiebel, ein Stück roher Lachs und eine Schale mit Miso-Paste. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die Namen der wichtigsten Zutaten der japanischen Küche kennen, von Grundnahrungsmitteln wie Reis und Sojasauce bis hin zu frischen Produkten wie Gemüse und Fisch."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Schneidetechniken (Kiru Gihō - 切る技法)",
        "keywords": "schneiden (kiru), würfeln (saikoro giri), in feine Streifen schneiden (sengiri), hacken (mijigiri), schälen (muku)",
        "image_concept": "Eine Nahaufnahme von Händen im Anime-Stil, die ein japanisches Messer halten. Auf einem Schneidebrett darunter sind Karotten in verschiedenen präzisen Schnittformen zu sehen: ein kleiner Haufen sehr feiner Streifen (sengiri), ein paar ordentliche Würfel (saikoro giri) und ein Häufchen fein gehackter Stücke (mijigiri). Die Szene vermittelt Präzision und Kunstfertigkeit. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf die wichtigen Verben und Adverbien für verschiedene Schneidetechniken. Die Studierenden lernen, wie man Anweisungen zum Zerkleinern von Zutaten in Rezepten versteht."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Kochmethoden (Chōrihō - 調理法)",
        "keywords": "kochen/köcheln (niru), grillen/braten (yaku), frittieren (ageru), dämpfen (musu), pfannenrühren (itameru)",
        "image_concept": "Eine dynamische Vierer-Split-Screen-Darstellung. Oben links: Ein Topf mit köchelnder Brühe (niru). Oben rechts: Ein kleiner Tischgrill, auf dem Spieße mit Fleisch und Gemüse liegen (yaku). Unten links: Garnelen und Gemüse, die in einem Topf mit heißem Öl frittiert werden (ageru). Unten rechts: Ein Bambusdämpfer, aus dem Dampf aufsteigt (musu). Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden erlernen die Verben für die gebräuchlichsten japanischen Garmethoden. Dies ermöglicht es ihnen, die zentralen Anweisungen in einem Rezept zu verstehen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Geschmack beschreiben (Aji o Hyōgen suru - 味を表現する)",
        "keywords": "lecker (oishii), süß (amai), salzig (shoppai), sauer (suppai), bitter (nigai), scharf (karai), Umami",
        "image_concept": "Ein Anime-Charakter mit geschlossenen Augen und einem seligen Lächeln isst eine Schüssel Donburi (Reisschale). Um seinen Kopf schweben funkelnde Sterne und kleine, leuchtende Partikel, die die köstlichen Geschmäcker (süß, salzig, umami) symbolisieren. Der Hintergrund ist warm und einladend. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernen die Studierenden, wie sie den Geschmack von Speisen mit gängigen Adjektiven beschreiben können, einschließlich des wichtigen Konzepts 'Umami', und wie sie ihre Wertschätzung für ein Gericht ausdrücken."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Berühmte Gerichte (Yūmei na Ryōri - 有名な料理)",
        "keywords": "Sushi, Ramen, Tempura, Udon, Gyoza, Miso-Suppe (misoshiru), Curry-Reis (karē raisu)",
        "image_concept": "Ein Tisch in einem japanischen Restaurant, reich beladen mit einer Vielzahl von ikonischen Gerichten. Im Vordergrund eine wunderschön arrangierte Sushi-Platte, dahinter eine große, dampfende Schüssel Ramen, daneben ein Teller mit goldbraunem Tempura und eine Schale mit Miso-Suppe. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die Namen und die grundlegenden Bestandteile einiger der berühmtesten japanischen Gerichte. Dies hilft beim Bestellen im Restaurant und beim Erkennen von Gerichten."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Ein Rezept lesen (Reshipi o Yomu - レシピを読む)",
        "keywords": "zuerst (mazu), danach (tsugi ni), hinzufügen (kuwaeru), mischen (mazeru), erhitzen (kanetsu suru), fertig (dekiagari)",
        "image_concept": "Ein junger Anime-Charakter schaut konzentriert auf ein aufgeschlagenes Kochbuch (die Seiten sind leer, um Text zu vermeiden). Vor ihm auf der Arbeitsfläche sind alle Zutaten für Onigiri (Reisbällchen) vorbereitet: eine große Schüssel mit Reis, eine Dose Thunfisch (ohne Etikett), eine Flasche Mayonnaise (ohne Etikett) und Nori-Blätter. Die Szene zeigt den Beginn des Kochprozesses. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In dieser abschließenden Lektion werden alle gelernten Vokabeln und Konzepte zusammengeführt. Die Studierenden lernen typische Ausdrücke und die Struktur eines einfachen japanischen Rezepts, um es von Anfang bis Ende zu verstehen."
    }
]
