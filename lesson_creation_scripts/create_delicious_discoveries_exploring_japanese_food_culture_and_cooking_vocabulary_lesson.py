#!/usr/bin/env python3
"""
This script creates a comprehensive Delicious Discoveries: Exploring Japanese Food Culture and Cooking Vocabulary lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Delicious Discoveries: Exploring Japanese Food Culture and Cooking Vocabulary"
LESSON_DIFFICULTY = "Beginner"
LESSON_DESCRIPTION = "Embark on a culinary journey through Japan! This lesson explores essential cooking vocabulary and cultural practices related to Japanese cuisine, from basic ingredients to common cooking techniques."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Kitchen Essentials - Daidokoro no Kihon (Daidokoro no Kihon)",
        "keywords": "kitchen tools, utensils, equipment, names, uses",
        "image_concept": "A cute manga-style illustration of various common kitchen tools arranged neatly on a countertop. Depict items like a knife, cutting board, pot, bowl, spatula, and whisk.  Clean lines, bright colors, and no text.",
        "content_focus": "Students learn basic kitchen vocabulary for tools and utensils like knives (hōchō), cutting boards (manaita), pots (nabe), and bowls (ochawan)."
    },
    {
        "page_number": 3,
        "title": "Ingredient Spotlight - Shokuzai ni Chūmoku (Shokuzai ni Chūmoku)",
        "keywords": "vegetables, fruits, meats, seafood, seasonings, basic ingredients",
        "image_concept": "A vibrant arrangement of various colorful vegetables, fruits, a piece of fish, and some meat on a wooden cutting board, in a cute manga style. No text.",
        "content_focus": "Introduction to common Japanese ingredients: vegetables (yasai), fruits (kudamono), meats (niku), seafood (sakana), and basic seasonings (chōmiryō)."
    },
    {
        "page_number": 4,
        "title": "Cooking Verbs in Action - Ryōri Dōshi (Ryōri Dōshi)",
        "keywords": "cut, boil, fry, grill, steam, mix, cooking actions",
        "image_concept": "A split-panel manga illustration showing a cute character performing different cooking actions like cutting vegetables, stirring a pot, and grilling fish.  No text or labels.",
        "content_focus": "Students learn essential cooking verbs like kiru (to cut), yuderu (to boil), ageru (to fry), yaku (to grill), musu (to steam), and mazeru (to mix)."
    },
    {
        "page_number": 5,
        "title": "Recipe Reading 101 - Reshipi no Yomikata (Reshipi no Yomikata)",
        "keywords": "recipe structure, measurements, instructions, understanding recipes",
        "image_concept": "A stylized, open cookbook with simple, visually appealing illustrations of ingredients and a few cooking steps, depicted in a cute manga style. No Japanese or English text.",
        "content_focus": "Introduction to basic recipe structure, common measurements, and understanding cooking instructions in Japanese."
    },
    {
        "page_number": 6,
        "title": "Table Manners and Etiquette - Teiburu Manā (Teiburu Manā)",
        "keywords": "chopsticks, bowing, thanking, Japanese dining customs",
        "image_concept": "A manga-style illustration of two cute characters sitting at a low table, enjoying a meal and demonstrating proper chopstick etiquette. No text or speech bubbles.",
        "content_focus": "Learn essential Japanese table manners, including proper chopstick use, bowing, expressing gratitude, and other dining customs."
    },
    {
        "page_number": 7,
        "title": "Regional Specialties - Gotōchi Gurume (Gotōchi Gurume)",
        "keywords": "regional dishes, famous foods, local cuisine",
        "image_concept": "A collage of cute manga-style illustrations representing various regional Japanese dishes, like sushi, ramen, tempura, and okonomiyaki. No text or labels.",
        "content_focus": "Explore regional specialties from different parts of Japan, highlighting unique ingredients and culinary traditions."
    },
    {
        "page_number": 8,
        "title": "Let's Cook! - Ryōri Shimashou! (Ryōri Shimashou!)",
        "keywords": "practice, application, simple recipe, cooking activity",
        "image_concept": "A cute manga character enthusiastically holding a finished dish (like onigiri or miso soup) with cooking utensils in the background.  Focus on the joy of cooking. No text.",
        "content_focus": "Students practice learned vocabulary and grammar by following a simple recipe in Japanese (e.g., making onigiri or miso soup)."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Delicious Discoveries: Exploring Japanese Food Culture and Cooking Vocabulary - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Delicious Discoveries: Exploring Japanese Food Culture and Cooking Vocabulary - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about japanese food culture and cooking vocabulary, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "Japanese food, cooking, vocabulary, ingredients, recipes, cuisine, culture, kitchen, verbs, nouns, dining, meal, preparation, techniques, customs"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Delicious Discoveries: Exploring Japanese Food Culture and Cooking Vocabulary",
        ...
        conclusion_topic = "Conclusion for Delicious Discoveries: Exploring Japanese Food Culture and Cooking Vocabulary lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "Japanese food, cooking, vocabulary, ingredients, recipes, cuisine, culture, kitchen, verbs, nouns, dining, meal, preparation, techniques, customs, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Delicious Discoveries: Exploring Japanese Food Culture and Cooking Vocabulary - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Delicious Discoveries: Exploring Japanese Food Culture and Cooking Vocabulary - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of delicious discoveries: exploring japanese food culture and cooking vocabulary",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
