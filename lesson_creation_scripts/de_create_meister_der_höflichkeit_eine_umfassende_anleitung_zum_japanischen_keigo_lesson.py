...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Meister der Höflichkeit: Eine umfassende Anleitung zum japanischen Keigo\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Meister der Höflichkeit: Eine umfassende Anleitung zum japanischen Keigo"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Entdecke die faszinierende Welt der japanischen Höflichkeitssprache! Diese Lektion führt dich durch die verschiedenen Formen von Keigo (尊敬語, 謙譲語, 丁寧語), damit du in jeder sozialen und beruflichen Situation den richtigen Ton triffst."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Was ist Keigo? (Keigo to wa? - 敬語とは？)",
        "keywords": "Einführung, Grundlagen, Höflichkeit, Hierarchie, Respekt, uchi-soto, 内外, drei Arten",
        "image_concept": "Ein junger Büroangestellter in Anzug verbeugt sich tief vor einem älteren Geschäftsmann in einem modernen Büro-Foyer. Der ältere Mann nimmt die Verbeugung mit einem leichten Nicken entgegen. Die Szene vermittelt Respekt und Hierarchie. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt die grundlegende Notwendigkeit und die soziale Funktion von Keigo in Japan. Die Studierenden lernen die drei Hauptkategorien kennen: Sonkeigo (Respektssprache), Kenjōgo (Bescheidenheitssprache) und Teineigo (höfliche Sprache)."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die Basis: Höfliche Sprache (Teineigo - 丁寧語)",
        "keywords": "Teineigo, 丁寧語, desu, です, masu, ます, Alltags-Höflichkeit, formelle Endungen, Grundlagen",
        "image_concept": "Zwei junge Erwachsene, ein Mann und eine Frau, unterhalten sich freundlich in einem Café. Sie lächeln und gestikulieren auf eine höfliche, aber nicht übermäßig formelle Weise. Die Atmosphäre ist entspannt und respektvoll. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden vertiefen ihr Verständnis von Teineigo, der Grundlage aller höflichen Konversation. Der Fokus liegt auf der korrekten Verwendung der です (desu) und ます (masu) Formen als Standard-Höflichkeit im täglichen Leben."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Andere ehren: Respektssprache (Sonkeigo - 尊敬語)",
        "keywords": "Sonkeigo, 尊敬語, jemanden ehren, Kunde, Lehrer, Vorgesetzter, o-ni naru, お〜になる, irassharu, いらっしゃる, gozonji, ご存知",
        "image_concept": "Eine Verkäuferin in einer schicken Kaufhausuniform verbeugt sich respektvoll und mit einem einladenden Lächeln vor einer elegant gekleideten Kundin. Die Verkäuferin gestikuliert in Richtung einer Vitrine mit Luxusartikeln und erhöht so den Status der Kundin. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf Sonkeigo, die Sprache, die verwendet wird, um den Gesprächspartner oder eine dritte Person zu ehren und zu erhöhen. Die Studierenden lernen spezielle Verben und honorige Präfixe (お-/ご-), um Respekt gegenüber ranghöheren Personen auszudrücken."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Bescheidenheit zeigen: Bescheidenheitssprache (Kenjōgo - 謙譲語)",
        "keywords": "Kenjōgo, 謙譲語, Bescheidenheit, sich selbst herabsetzen, Firma, Familie, mairu, 参る, itasu, 致す, mōshiageru, 申し上げる",
        "image_concept": "Ein junger Mitarbeiter in einem Büro überreicht seinem Chef demütig mit beiden Händen ein Dokument. Der Mitarbeiter ist leicht verbeugt und hat einen bescheidenen Gesichtsausdruck, während der Chef am Schreibtisch sitzt und das Dokument entgegennimmt. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernen die Studierenden Kenjōgo, die Sprache der Bescheidenheit. Es wird erklärt, wie man über die eigenen Handlungen oder die der eigenen Gruppe (uchi) spricht, um sich selbst gegenüber einer ranghöheren Person (soto) herabzusetzen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Direkter Vergleich: Sonkeigo vs. Kenjōgo (Sonkeigo tai Kenjōgo - 尊敬語 対 謙譲語)",
        "keywords": "Vergleich, Gegenüberstellung, Perspektive, Sprecher, Zuhörer, Kontext, wann was verwenden, Fallbeispiele",
        "image_concept": "Ein geteiltes Bild (Split Screen). Auf der linken Seite (Sonkeigo) ist ein Professor an einer Tafel, umgeben von einem leichten, goldenen Leuchten, was seinen erhöhten Status symbolisiert. Auf der rechten Seite (Kenjōgo) ist ein Student, der demütig seine Hausaufgabe abgibt und sich dabei leicht verbeugt, um seine bescheidene Position zu zeigen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite stellt Sonkeigo und Kenjōgo direkt gegenüber, um die Unterschiede zu verdeutlichen. Anhand von Beispielsituationen (z.B. 'Der Chef geht' vs. 'Ich gehe') lernen die Studierenden, wann welche Form angewendet werden muss, abhängig davon, wer die Handlung ausführt."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Keigo in der Praxis (Jissen de no Keigo - 実践での敬語)",
        "keywords": "Anwendung, Geschäftstreffen, Telefonat, E-Mail, Kundenservice, Alltagssituationen, Rollenspiel",
        "image_concept": "Eine dynamische Szene in einem modernen japanischen Büro während eines Telefonats. Eine Mitarbeiterin sitzt am Schreibtisch, spricht konzentriert ins Headset und macht sich Notizen. Im Hintergrund sind Kollegen bei der Arbeit. Ihre Haltung ist professionell und höflich. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden wenden ihr Wissen in praktischen Szenarien an. Die Seite bietet Beispiele und Phrasen für typische Situationen wie ein Geschäftstelefonat, die Begrüßung eines wichtigen Kunden oder das Schreiben einer formellen E-Mail."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Feinschliff: Verschönernde Sprache & Anreden (Bikago to Keishō - 美化語と敬称)",
        "keywords": "Bikago, 美化語, o-cha, お茶, o-kane, お金, Anreden, -sama, 様, -buchō, 部長, Titel, Namenssuffixe",
        "image_concept": "Eine elegante Szene einer Person, die einem Gast in einem traditionellen japanischen Raum Tee serviert. Der Fokus liegt auf den schön präsentierten Objekten: einer Teekanne, Tassen (o-cha) und Süßigkeiten (o-kashi), die die 'verschönernde' Natur von Bikago visualisieren. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese letzte Seite behandelt fortgeschrittenere Nuancen wie Bikago (verschönernde Sprache, z.B. お酒 für Sake), die Wörter eleganter klingen lässt, sowie die korrekte Verwendung von Titeln und Anreden (Keishō) wie 様 (sama) oder Firmentiteln."
    }
]
