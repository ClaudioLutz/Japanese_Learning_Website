#!/usr/bin/env python3
"""
This script creates a comprehensive Stylish Japan: Navigating Fashion and Shopping Culture lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Stylish Japan: Navigating Fashion and Shopping Culture"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Dive into the exciting world of Japanese fashion and shopping!  From trendy streetwear to traditional garments, this lesson explores vocabulary, cultural nuances, and practical shopping phrases to help you confidently navigate Japanese stores and express your personal style."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Clothing Basics - 服の基本 (Fuku no Kihon)",
        "keywords": "shirt, pants, skirt, dress, shoes, accessories, top, bottom, outerwear",
        "image_concept": "A diverse group of stylish anime characters wearing different types of everyday clothing (shirts, pants, skirts, dresses, accessories) in a variety of colors. The characters are showcasing various outfits without any exaggerated features, in a casual, friendly setting. Cute manga/anime art style with clean lines.",
        "content_focus": "Learn essential vocabulary for common clothing items and basic color/size descriptions."
    },
    {
        "page_number": 3,
        "title": "Trendy Styles - 流行スタイル (Ryūkō Sutairu)",
        "keywords": "trendy, fashionable, streetwear, Harajuku, Shibuya, styles, brands, popular",
        "image_concept": "Several anime characters showcasing distinctly different fashion subcultures/styles popular in Japan (Harajuku, Lolita, etc.) with authentic details but without extreme exaggeration. Cute manga/anime art style with clean lines.",
        "content_focus": "Explore popular fashion trends in Japan, including Harajuku and Shibuya styles, and learn related vocabulary."
    },
    {
        "page_number": 4,
        "title": "Traditional Garments - 伝統的な服装 (Dentō-teki na Fukusō)",
        "keywords": "kimono, yukata, obi, haori, traditional, formal, casual, occasions",
        "image_concept": "Two anime characters, one wearing a colorful yukata and the other a more formal kimono, in a setting suggestive of a festival or traditional event. Focus on accurate depiction of the garments. Cute manga/anime art style with clean lines.",
        "content_focus": "Introduce traditional Japanese clothing like kimono and yukata, explaining their cultural significance and appropriate occasions for wearing them."
    },
    {
        "page_number": 5,
        "title": "Shopping Destinations - ショッピングスポット (Shoppingu Supotto)",
        "keywords": "department store, boutique, online shopping, second-hand shop, market, prices",
        "image_concept": "A montage showcasing various shopping environments in Japan: a bustling department store, a trendy boutique, a traditional market stall, and someone browsing on their phone representing online shopping. Cute manga/anime art style with clean lines.",
        "content_focus": "Overview of different shopping locations in Japan, from department stores to local markets, and vocabulary related to pricing and sales."
    },
    {
        "page_number": 6,
        "title": "Navigating the Store - 店での案内 (Mise de no Annai)",
        "keywords": "asking for sizes, trying on clothes, asking for assistance, finding items, customer service",
        "image_concept": "An anime character interacting with a shop assistant, gesturing towards an item of clothing and looking inquisitive, depicting a shopping interaction.  Cute manga/anime art style with clean lines.",
        "content_focus": "Learn essential phrases for navigating a store, asking for help, trying on clothes, and inquiring about sizes and availability."
    },
    {
        "page_number": 7,
        "title": "Making a Purchase - 購入 (Kōnyū)",
        "keywords": "payment methods, cash, credit card, tax, discounts, receipts, bags",
        "image_concept": "A close-up of a hand holding a credit card near a card reader, with a shopping bag and a receipt visible in the background, depicting a transaction. Cute manga/anime art style with clean lines.",
        "content_focus": "Learn vocabulary and phrases related to making a purchase, including payment methods, discounts, and receiving a receipt."
    },
    {
        "page_number": 8,
        "title": "Expressing Your Style - スタイルを表現する (Sutairu o Hyōgen Suru)",
        "keywords": "preferences, likes, dislikes, opinions, fashion sense, expressing oneself, compliments",
        "image_concept": "Two anime characters, looking at each other and smiling, with one gesturing towards the other's outfit, conveying a compliment. Cute manga/anime art style with clean lines.",
        "content_focus": "Practice expressing personal preferences in clothing and giving compliments on others' fashion choices using appropriate Japanese phrases."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Stylish Japan: Navigating Fashion and Shopping Culture - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Stylish Japan: Navigating Fashion and Shopping Culture - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about japanese fashion and shopping culture, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "fashion, shopping, clothes, trends, department store, boutique, sale, discount, sizes, colors, styles, trying on, asking for help, Japanese brands, cultural etiquette"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Stylish Japan: Navigating Fashion and Shopping Culture",
        ...
        conclusion_topic = "Conclusion for Stylish Japan: Navigating Fashion and Shopping Culture lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "fashion, shopping, clothes, trends, department store, boutique, sale, discount, sizes, colors, styles, trying on, asking for help, Japanese brands, cultural etiquette, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Stylish Japan: Navigating Fashion and Shopping Culture - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Stylish Japan: Navigating Fashion and Shopping Culture - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of stylish japan: navigating fashion and shopping culture",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
