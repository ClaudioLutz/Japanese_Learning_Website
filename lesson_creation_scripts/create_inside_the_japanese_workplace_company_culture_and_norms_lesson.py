...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Inside the Japanese Workplace: Company Culture and Norms lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Inside the Japanese Workplace: Company Culture and Norms"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Navigate the Japanese office with confidence by understanding its unique culture. This lesson introduces essential concepts like the senpai-kouhai hierarchy, the importance of after-work gatherings (nomikai), and key vocabulary to help you thrive in a Japanese professional environment."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "日本の職場へようこそ (Nihon no Shokuba e Youkoso) - Welcome to the Japanese Workplace",
        "keywords": "会社 (kaisha), 職場 (shokuba), 会社員 (kaishain), オフィス (ofisu), 部署 (busho)",
        "image_concept": "A bright, clean, open-plan Japanese office. Desks are arranged in island formations (shimas). Several neatly dressed employees are working at their computers. In the background, one person is at a copy machine. The overall atmosphere is professional and orderly. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Learn the basic vocabulary for the office environment. This page introduces the concepts of the company (会社), the workplace (職場), and how departments (部署) are structured in a typical Japanese office."
    },
    {
        "page_number": 3,
        "title": "上下関係：先輩と後輩 (Jouge Kankei: Senpai to Kouhai) - The Hierarchy: Senpai and Kouhai",
        "keywords": "先輩 (senpai), 後輩 (kouhai), 上司 (joushi), 部下 (buka), 敬語 (keigo)",
        "image_concept": "An older, kind-faced office worker (the senpai) is patiently showing a younger, new employee (the kouhai) something on a computer monitor. The kouhai is leaning in, listening attentively with a respectful expression. The senpai's posture is open and guiding. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image. The computer screen should be blank or have an abstract pattern.",
        "content_focus": "Understand the critical concepts of seniority and hierarchy. This page explains the roles of senpai (senior), kouhai (junior), joushi (superior), and buka (subordinate), and introduces the necessity of using respectful language (keigo)."
    },
    {
        "page_number": 4,
        "title": "コミュニケーションの基本：報連相 (Komyunikēshon no Kihon: Hou-Ren-Sou) - Communication Basics: Hou-Ren-Sou",
        "keywords": "報告 (houkoku), 連絡 (renraku), 相談 (soudan), 報連相 (hourensou), 会議 (kaigi)",
        "image_concept": "Three office workers are standing around a small table, having a brief meeting. One person is speaking and gesturing, clearly making a report. The other two, a superior and a peer, are listening intently, one nodding and the other with a hand on their chin in a thoughtful pose, representing the consultation and communication loop. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Master the 'Hou-Ren-Sou' principle—the cornerstone of Japanese business communication. Learn the importance of Reporting (報告), Informing (連絡), and Consulting (相談) to ensure smooth teamwork and avoid misunderstandings."
    },
    {
        "page_number": 5,
        "title": "ビジネスマナー：お辞儀と名刺交換 (Bijinesu Manā: Ojigi to Meishi Koukan) - Business Manners: Bowing and Business Card Exchange",
        "keywords": "お辞儀 (ojigi), 名刺 (meishi), 名刺交換 (meishi koukan), 丁寧 (teinei), 挨拶 (aisatsu)",
        "image_concept": "Two professionals in business suits are formally exchanging business cards. They are both bowing to each other at a respectful angle. Each person is holding the card they are presenting with both hands, and receiving the other's card with both hands. The cards are depicted as simple blank white rectangles. Their posture is formal and precise. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Learn the essential rituals of Japanese business etiquette. This page covers the different types of bows (お辞儀) and their meanings, as well as the step-by-step process for correctly exchanging business cards (名刺交換)."
    },
    {
        "page_number": 6,
        "title": "仕事の後：飲み会文化 (Shigoto no Ato: Nomikai Bunka) - After Work: The Drinking Party Culture",
        "keywords": "飲み会 (nomikai), 乾杯 (kanpai), 飲み放題 (nomihoudai), 無礼講 (bureikou), 二次会 (nijikai)",
        "image_concept": "A cheerful scene inside a Japanese izakaya. A group of coworkers is seated around a low table filled with small dishes and drinks. They are all raising their glasses in a 'kanpai' toast. One person is smiling while pouring a drink for their boss. The atmosphere is warm and communal. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Explore the social dynamics of the 'nomikai' (company drinking party). Understand its role in team building, the etiquette of pouring drinks for others, and key vocabulary like 'kanpai!' (cheers!) and the concept of a second party (二次会)."
    },
    {
        "page_number": 7,
        "title": "日常業務と残業 (Nichijou Gyoumu to Zangyou) - Daily Duties and Overtime",
        "keywords": "残業 (zangyou), 過労死 (karoushi), 終身雇用 (shuushin koyou), ワークライフバランス (wāku raifu baransu), 判子 (hanko)",
        "image_concept": "A lone office worker sits at their desk late at night, illuminated by a single desk lamp. On the desk is a stack of papers, a traditional red ink pad, and a personal seal (hanko). In the background, an analog wall clock with no numbers shows the hands pointing to a late hour, like 10 PM. The mood is quiet and focused. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Discuss the realities of daily work, including the prevalence of overtime (残業). This page touches on the traditional idea of lifetime employment (終身雇用), the modern conversation around work-life balance, and the use of personal seals (hanko) for official documents."
    },
    {
        "page_number": 8,
        "title": "会社員の一日 (Kaishain no Ichinichi) - A Day in the Life of an Office Worker",
        "keywords": "朝礼 (chourei), ランチ (ranchi), 打ち合わせ (uchiawase), お疲れ様です (otsukaresama desu), 帰宅 (kitaku)",
        "image_concept": "A four-panel comic-style image showing the same character's day. Top-left: The character stands with colleagues for a morning meeting (chourei). Top-right: The character eats a bento box lunch at their desk. Bottom-left: The character bows deeply to a client after a meeting. Bottom-right: The character waves goodbye to a colleague while leaving the office at the end of the day. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image.",
        "content_focus": "Synthesize everything you've learned by following a typical office worker's day. This page connects concepts like the morning meeting (朝礼), client meetings (打ち合わせ), and the ubiquitous phrase 'お疲れ様です' used throughout the day."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Inside the Japanese Workplace: Company Culture and Norms - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Inside the Japanese Workplace: Company Culture and Norms - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about inside the japanese workplace: company culture and norms, the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "会社 (kaisha), 職場 (shokuba), 飲み会 (nomikai), 先輩 (senpai), 後輩 (kouhai), 上司 (joushi), 報連相 (hourensou), 名刺交換 (meishi koukan), お辞儀 (ojigi), 敬語 (keigo), 残業 (zangyou), ビジネスマナー (business manner)"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Inside the Japanese Workplace: Company Culture and Norms",
        ...
        conclusion_topic = "Conclusion for Inside the Japanese Workplace: Company Culture and Norms lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "会社 (kaisha), 職場 (shokuba), 飲み会 (nomikai), 先輩 (senpai), 後輩 (kouhai), 上司 (joushi), 報連相 (hourensou), 名刺交換 (meishi koukan), お辞儀 (ojigi), 敬語 (keigo), 残業 (zangyou), ビジネスマナー (business manner), cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Inside the Japanese Workplace: Company Culture and Norms - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Inside the Japanese Workplace: Company Culture and Norms - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of inside the japanese workplace: company culture and norms",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
