...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Japanische Kunst, Kalligrafie und traditionelles Handwerk\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Japanische Kunst, Kalligrafie und traditionelles Handwerk"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Erweitere deinen Wortschatz, um die Ästhetik japanischer Kunst zu verstehen und darüber zu sprechen. Lerne, wie man Museen besucht, über traditionelles Handwerk spricht und die Philosophie hinter Kunstformen wie Kalligrafie und Ukiyo-e würdigt."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen der Kunst (Bijutsu no Kihon - 美術の基本)",
        "keywords": "Kunst, Museum, Ausstellung, Künstler, Werk, Kunstgalerie, 美術 (bijutsu), 美術館 (bijutsukan), 展覧会 (tenrankai), 芸術家 (geijutsuka), 作品 (sakuhin)",
        "image_concept": "Ein Anime-Charakter mit großen, neugierigen Augen steht in einer hellen, modernen Kunstgalerie und betrachtet nachdenklich ein abstraktes Gemälde an der Wand. Die Umgebung ist minimalistisch und lichtdurchflutet. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen grundlegendes Vokabular rund um das Thema Kunst, um sich in einem Museum oder einer Galerie zurechtzufinden und über Kunst im Allgemeinen zu sprechen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die Kunst des Schreibens: Kalligrafie (Shodō - 書道)",
        "keywords": "Kalligrafie, Pinsel, Tusche, Tuschestein, Papier, Zeichen, 書道 (shodō), 筆 (fude), 墨 (sumi), 硯 (suzuri), 紙 (kami), 字 (ji)",
        "image_concept": "Ein niedlicher Anime-Charakter in einem einfachen, traditionellen Kimono kniet konzentriert vor einem niedrigen Tisch. Er/sie hält einen Kalligrafiepinsel und ist im Begriff, ein Schriftzeichen auf weißem Papier zu malen. Tusche, Tuschestein und ein Wassergefäß sind ordentlich daneben angeordnet. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite stellt die traditionelle Kunst der Kalligrafie (Shodō) vor. Die Lernenden entdecken die 'Vier Schätze des Studierzimmers' (Pinsel, Tusche, Tuschestein, Papier) und lernen Vokabular, das mit dieser meditativen Kunstform verbunden ist."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Bilder der fließenden Welt: Ukiyo-e (Ukiyo-e - 浮世絵)",
        "keywords": "Holzschnitt, Edo-Zeit, Hokusai, Landschaft, Schauspieler, 浮世絵 (ukiyo-e), 木版画 (mokuhanga), 江戸時代 (Edo-jidai), 風景 (fūkei), 役者 (yakusha)",
        "image_concept": "Zwei kawaii Anime-Freunde stehen vor einer Wand, an der ein stilisierter Ukiyo-e-Druck hängt (ähnlich der 'Großen Welle', aber als Original-Interpretation). Ein Charakter zeigt begeistert auf das Bild, während der andere es bewundernd betrachtet. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen den berühmten japanischen Holzschnitt-Stil Ukiyo-e kennen. Der Fokus liegt auf Vokabular zur Beschreibung der Motive (Landschaften, schöne Frauen, Kabuki-Schauspieler) und dem historischen Kontext der Edo-Zeit."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Die Schönheit des Tons: Keramik (Tōgei - 陶芸)",
        "keywords": "Keramik, Töpferei, Teeschale, Vase, Brennofen, Töpfer, 陶芸 (tōgei), 焼き物 (yakimono), 茶碗 (chawan), 花瓶 (kabin), 窯 (kama), 陶芸家 (tōgeika)",
        "image_concept": "Ein fröhlicher Anime-Charakter mit einer Schürze sitzt an einer Töpferscheibe und formt mit schmutzigen, aber glücklichen Händen ein kleines Gefäß aus Ton. Im Hintergrund stehen auf einem Holzregal einige fertige, bunte Keramikschalen und -vasen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier wird die japanische Keramikkunst (Tōgei) vorgestellt. Die Lernenden eignen sich Vokabular für verschiedene Keramikgegenstände wie Teeschalen und Vasen sowie für den Herstellungsprozess an."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Weitere traditionelle Handwerke (Sono Hoka no Dentō Kōgei - その他の伝統工芸)",
        "keywords": "Lackwaren, Färben, Ikebana, Fächer, Handwerk, 漆器 (shikki), 染物 (somemono), 生け花 (ikebana), 扇子 (sensu), 工芸 (kōgei)",
        "image_concept": "Ein gemütlicher, traditioneller Raum. Im Vordergrund bewundert ein Anime-Charakter eine elegante, glänzende Lackwaren-Box. Im Hintergrund arrangiert ein anderer Charakter Blumen in einer Vase (Ikebana). Ein schöner Kimono-Stoff hängt an der Wand. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erweitert den Horizont auf weitere wichtige traditionelle Handwerke. Die Studierenden lernen Begriffe für Lackwaren (Shikki), Textilfärberei (Somemono) und die Kunst des Blumenarrangements (Ikebana)."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Kunst schaffen und wertschätzen: Verben (Tsukuru koto to kanshō suru koto - 作ることと鑑賞すること)",
        "keywords": "sehen, machen, malen, zeichnen, bewundern, ausstellen, 見る (miru), 作る (tsukuru), 描く (kaku), 鑑賞する (kanshō suru), 飾る (kazaru)",
        "image_concept": "Ein geteiltes Bild. Auf der linken Seite sitzt ein Anime-Charakter mit einem Skizzenbuch und zeichnet fröhlich eine Landschaft. Auf der rechten Seite steht derselbe Charakter in einer Galerie, die Hände hinter dem Rücken verschränkt, und blickt mit einem Lächeln auf eine Skulptur. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Der Schwerpunkt liegt auf der Anwendung des Gelernten. Die Studierenden lernen wichtige Verben, um auszudrücken, dass sie Kunst betrachten, schaffen, zeichnen oder ausstellen. Dies ermöglicht die Bildung vollständiger Sätze."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Kunst beschreiben: Adjektive (Bijutsu o setsumei suru keiyōshi - 美術を説明する形容詞)",
        "keywords": "schön, wunderbar, alt, neu, schlicht, farbenfroh, 美しい (utsukushii), 素晴らしい (subarashii), 古い (furui), 新しい (atarashii), 渋い (shibui), 賑やか (nigiyaka)",
        "image_concept": "Ein Anime-Charakter steht in einem traditionellen japanischen Raum mit Tatami-Matten. Er/sie betrachtet ein einzelnes, sehr schlichtes, aber elegantes Ikebana-Arrangement in einer Nische (Tokonoma). Der Gesichtsausdruck ist ruhig und wertschätzend. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser letzten Seite lernen die Studierenden Adjektive, um Kunstwerke zu beschreiben und ihre Meinung auszudrücken. Es werden auch kulturelle Konzepte wie 'shibui' (schlichte, unaufdringliche Schönheit) eingeführt, um ein tieferes Verständnis zu fördern."
    }
]
