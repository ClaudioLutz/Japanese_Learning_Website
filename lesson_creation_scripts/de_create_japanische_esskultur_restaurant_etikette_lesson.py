...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Japanische Esskultur & Restaurant-Etikette\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Japanische Esskultur & Restaurant-Etikette"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Tauche ein in die faszinierende Welt der japanischen Esskultur! Lerne, wie man in einem Restaurant bestellt, die wichtigsten Tischmanieren meistert und traditionelle Gerichte wie ein Einheimischer genießt."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Beginn der Mahlzeit (Shokuji no Hajimari - 食事の始まり)",
        "keywords": "Itadakimasu, Gochisousama deshita, Dankbarkeit, vor dem Essen, nach dem Essen, Oshibori, Heißes Tuch",
        "image_concept": "Ein niedlicher Anime-Charakter sitzt an einem japanischen Esstisch. Die Hände sind in der 'Itadakimasu'-Geste gefaltet, die Augen sind geschlossen und ein Lächeln liegt auf den Lippen. Vor dem Charakter steht ein schön angerichtetes, einfaches japanisches Mahl (Reis, Misosuppe, eine Beilage). Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Schüler lernen die kulturelle Bedeutung und korrekte Verwendung der wichtigen Ausdrücke 'Itadakimasu' (vor dem Essen) und 'Gochisousama deshita' (nach dem Essen). Zusätzlich wird die Funktion des 'Oshibori' (heißes Tuch) erklärt."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die Kunst der Stäbchen (Ohashi no Tsukaikata - お箸の使い方)",
        "keywords": "Stäbchen, ohashi, Hashioki, richtig halten, Tabus, Kirai-bashi, Manieren",
        "image_concept": "Eine Nahaufnahme von zwei Händen im Kawaii-Anime-Stil. Die eine Hand demonstriert die korrekte und elegante Haltung von Stäbchen, mit denen gerade ein Stück Maki-Sushi gegriffen wird. Die andere Hand ruht daneben entspannt auf dem Tisch. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite konzentriert sich auf den korrekten Umgang mit Stäbchen ('Ohashi'). Die Schüler lernen, wie man sie richtig hält und benutzt. Ein wichtiger Schwerpunkt liegt auf den 'Kirai-bashi' (verpönte Stäbchen-Nutzung), also den wichtigsten Tabus, wie z.B. das Stecken der Stäbchen in den Reis."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Essen bestellen (Chūmon suru - 注文する)",
        "keywords": "Bestellen, chūmon, Speisekarte, menyū, Kellner, ten'in, Sumimasen, Osusume, Empfehlung",
        "image_concept": "Ein fröhlicher Anime-Charakter sitzt an einem Restauranttisch und zeigt lächelnd auf eine Stelle in einer Speisekarte. Die Speisekarte selbst zeigt nur abstrakte Linien, keinen lesbaren Text. Ein freundlicher Kellner oder eine Kellnerin steht daneben und notiert die Bestellung auf einem kleinen Notizblock. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Schüler lernen praktische Sätze für den Restaurantbesuch. Dies umfasst, wie man die Aufmerksamkeit des Kellners erregt ('Sumimasen'), nach der Speisekarte fragt, ein Gericht bestellt ('... o kudasai') und nach einer Empfehlung fragt ('Osusume wa nan desu ka?')."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Eine kulinarische Reise (Washoku no Sekai - 和食の世界)",
        "keywords": "Washoku, Sushi, Ramen, Tempura, Udon, Izakaya, Teishoku, Set-Menü, japanische Küche",
        "image_concept": "Ein lebhaftes Bild, das in drei vertikale Panels aufgeteilt ist. Jedes Panel zeigt ein ikonisches japanisches Gericht im niedlichen Anime-Stil: eine dampfende Schüssel Ramen, einen bunten Teller mit verschiedenen Sushi-Rollen und Nigiri, und ein goldbraunes Stück Tempura-Garnele. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite gibt einen Überblick über verschiedene Arten japanischer Gerichte ('Washoku') und Restauranttypen. Konzepte wie 'Teishoku' (festes Menü), 'Ramen-ya' (Ramen-Laden), 'Sushi-ya' (Sushi-Restaurant) und 'Izakaya' (japanische Kneipe) werden vorgestellt."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Tischmanieren: Do's & Don'ts (Shokuji no Manā - 食事のマナー)",
        "keywords": "Tischmanieren, Manieren, Nudeln schlürfen, Suppe trinken, Sojasauce, Wasabi, teilen, Etikette",
        "image_concept": "Ein glücklicher Anime-Charakter, der mit Begeisterung (aber ordentlich) Nudeln aus einer großen Schüssel schlürft. Sichtbarer Dampf steigt aus der Schüssel auf, und die Wangen des Charakters sind leicht aufgebläht. Die Szene vermittelt Genuss. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier werden spezifische Tischmanieren vertieft. Die Schüler lernen, warum das Schlürfen von Nudeln akzeptabel und sogar erwünscht ist, wie man Suppe direkt aus der Schale trinkt und wie man Sojasauce und Wasabi richtig mit Sushi verwendet, ohne das Essen zu 'ertränken'."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Die Kultur des Trinkens (Nomikai no Bunka - 飲み会の文化)",
        "keywords": "Nomikai, Izakaya, Kanpai, Bier, biru, Sake, o-sake, einschenken, Prost",
        "image_concept": "Eine Gruppe von drei fröhlichen Anime-Freunden sitzt an einem niedrigen Holztisch in einer gemütlichen Izakaya-Atmosphäre. Sie erheben ihre kleinen Gläser oder Sake-Becher für einen 'Kanpai'-Toast. Die Stimmung ist warm und freundschaftlich. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt die Etikette beim Trinken in geselliger Runde ('Nomikai'), typischerweise in einer 'Izakaya'. Die Schüler lernen den Trinkspruch 'Kanpai!', den Brauch, anderen Getränke einzuschenken (aber nicht sich selbst), und grundlegendes Vokabular für Getränke wie Bier und Sake."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Die Rechnung bezahlen (Okaikei o onegai shimasu - お会計をお願いします)",
        "keywords": "Rechnung, okaikei, Kasse, reji, getrennt zahlen, betsu betsu, Trinkgeld",
        "image_concept": "Ein Anime-Charakter steht an einer einfachen Theke (dem Kassenbereich) und bezahlt. Der Charakter lächelt freundlich und reicht dem Ladenbesitzer, der ebenfalls freundlich ist, eine abstrakte Kreditkarte oder Geldscheine. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Zum Abschluss lernen die Schüler, wie man nach der Rechnung fragt ('Okaikei o onegai shimasu'). Es wird die kulturelle Norm erklärt, dass man in der Regel an der Kasse ('reji') bezahlt und nicht am Tisch. Auch die Möglichkeit, getrennt zu zahlen ('betsu betsu ni') und die Tatsache, dass Trinkgeld unüblich ist, werden behandelt."
    }
]
