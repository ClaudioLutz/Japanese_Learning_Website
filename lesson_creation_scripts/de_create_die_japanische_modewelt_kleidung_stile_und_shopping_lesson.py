...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Die Japanische Modewelt: Kleidung, Stile und Shopping\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Die Japanische Modewelt: Kleidung, Stile und Shopping"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Erweitere deinen japanischen Wortschatz rund um das Thema Mode! Lerne, über Kleidung, aktuelle Stile und Trends zu sprechen und meistere selbstbewusst jede Shopping-Situation in Japan."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlegende Kleidungsstücke (Kihon no Yōfuku - 基本の洋服)",
        "keywords": "T-Shirt, Tシャツ, Hemd, シャツ, Hose, ズボン, Rock, スカート, Kleid, ワンピース, Schuhe, 靴, Jacke, ジャケット",
        "image_concept": "Eine fröhliche junge Person im Anime-Stil steht vor einem offenen, ordentlichen Kleiderschrank. Im Schrank sind verschiedene grundlegende Kleidungsstücke wie ein gefaltetes T-Shirt, eine hängende Hose, ein Kleid und eine Jacke klar zu erkennen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Auf dieser Seite lernst du die grundlegenden Vokabeln für alltägliche Kleidungsstücke, die die Basis für jedes Outfit bilden. Wir behandeln die häufigsten Begriffe für Oberteile, Unterteile und Schuhe."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Kleidung beschreiben: Farben & Muster (Fuku no Hyōgen: Iro to Monyō - 服の表現: 色と模様)",
        "keywords": "rot, 赤い, blau, 青い, weiß, 白い, schwarz, 黒い, gestreift, しま, kariert, チェック, gepunktet, 水玉, Muster, 模様",
        "image_concept": "Zwei Freunde im kawaii-Stil sitzen auf dem Boden und schauen sich begeistert verschiedene Stoffmuster an. Einer hält einen gestreiften Stoff, der andere einen gepunkteten. Die Szene ist farbenfroh und dynamisch. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne, wie du Kleidung detaillierter beschreiben kannst. Wir konzentrieren uns auf wichtige Adjektive für Farben und die japanischen Begriffe für gängige Muster wie Streifen, Karos und Punkte."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Erfolgreich einkaufen (Kaimono ni Iku - 買い物に行く)",
        "keywords": "anprobieren, 試着する, Umkleidekabine, 試着室, wie viel kostet es?, いくらですか, Kaufhaus, デパート, Geschäft, 店, Verkäufer, 店員",
        "image_concept": "Eine Person im Manga-Stil steht in einer hellen, sauberen Umkleidekabine und betrachtet sich im Spiegel. Sie probiert eine modische Jacke an und hat einen glücklichen Gesichtsausdruck. Der Hintergrund ist einfach gehalten, um den Fokus auf die Person und die Handlung zu legen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernst du nützliche Sätze und Vokabeln für den Kleiderkauf in Japan. Vom Betreten eines Geschäfts über das Anprobieren von Kleidung bis hin zum Bezahlen – danach bist du für deine Shoppingtour gerüstet."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Japanische Street Styles (Nihon no Sutorīto Fasshon - 日本のストリートファッション)",
        "keywords": "Harajuku, 原宿, Shibuya, 渋谷, Lolita-Mode, ロリータ, Gyaru, ギャル, Visual Kei, ヴィジュアル系, süß, かわいい",
        "image_concept": "Eine lebhafte Straßenszene, die an Harajuku erinnert. Drei junge Leute in unterschiedlichen, markanten Stilen posieren zusammen: eine Person in einem aufwändigen Lolita-Kleid, eine in einem trendigen Gyaru-Outfit und eine mit dezenten Visual-Kei-Elementen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Tauche ein in die Welt der japanischen Straßenmode! Wir stellen dir berühmte Modestile vor, die du in Vierteln wie Harajuku und Shibuya sehen kannst, und erklären die kulturellen Hintergründe."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Mode für jede Jahreszeit (Kisetsu-goto no Fasshon - 季節ごとのファッション)",
        "keywords": "Frühling, 春, Sommer, 夏, Herbst, 秋, Winter, 冬, Mantel, コート, Badeanzug, 水着, kurzärmlig, 半袖, langärmlig, 長袖",
        "image_concept": "Ein Bild, das in vier Bereiche unterteilt ist. Jeder Bereich zeigt dieselbe Anime-Figur in saisonal passender Kleidung vor einem entsprechenden Hintergrund: mit einem leichten Kleid vor Kirschblüten (Frühling), in Shorts und T-Shirt am Strand (Sommer), mit einem Schal vor buntem Laub (Herbst) und in einem dicken Mantel im Schnee (Winter). Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In Japan spielt die saisonale Anpassung der Kleidung eine große Rolle. Lerne, welche Kleidungsstücke typisch für Frühling, Sommer, Herbst und Winter sind und wie man darüber spricht."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Formell & Traditionell (Fōmaru & Dentō-teki na Ishō - フォーマル & 伝統的な衣装)",
        "keywords": "Anzug, スーツ, Kimono, 着物, Yukata, 浴衣, formell, フォーマルな, traditionell, 伝統的, Hochzeit, 結婚式",
        "image_concept": "Ein elegantes Paar steht nebeneinander. Eine Person trägt einen schicken, modernen Anzug, die andere einen wunderschönen, traditionellen Kimono mit dezentem Blumenmuster. Der Kontrast zwischen modern und traditionell wird deutlich. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt den Unterschied zwischen westlicher formeller Kleidung wie dem Anzug (スーツ) und traditioneller japanischer Kleidung wie dem Kimono (着物) und dem Yukata (浴衣) sowie deren Anlässe."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Trends & Zeitschriften (Fasshon Torendo & Zasshi - ファッショントレンド & 雑誌)",
        "keywords": "Trend, トレンド, beliebt, 人気, Modezeitschrift, ファッション雑誌, Stil, スタイル, modisch, おしゃれ",
        "image_concept": "Eine modisch gekleidete Person sitzt in einem hellen, gemütlichen Café an einem kleinen Tisch. Sie blättert mit einem begeisterten Ausdruck in einer dicken Modezeitschrift. Die Seiten der Zeitschrift sind sichtbar, aber ohne Text, nur mit bunten Formen und Silhouetten, die Mode andeuten. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Wie bleibt man in Japan modisch auf dem Laufenden? Lerne Vokabeln, um über aktuelle Trends zu sprechen und erfahre mehr über die wichtige Rolle von Modezeitschriften in der japanischen Jugendkultur."
    }
]
