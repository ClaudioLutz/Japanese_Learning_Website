...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Liebe, Romantik und Beziehungen auf Japanisch: Ein Leitfaden für Herzensangelegenheiten\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Liebe, Romantik und Beziehungen auf Japanisch: Ein Leitfaden für Herzensangelegenheiten"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Lerne, wie du auf Japanisch Zuneigung ausdrückst, dich verabredest und Beziehungen aufbaust. Diese Lektion führt dich von der ersten Schwärmerei über das entscheidende Liebesgeständnis (Kokuhaku) bis hin zu tiefen Beziehungsphasen."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Der erste Funke: Interesse bekunden (Kyōmi o Shimesu - 興味を示す)",
        "keywords": "mögen, Typ, süß, cool, Schwärmerei, Suki (好き), Taipu (タイプ), Kakkoii (かっこいい), Kawaii (かわいい), Akogare (憧れ)",
        "image_concept": "Ein Junge und ein Mädchen im Oberschulalter schauen sich schüchtern über einen Klassenraum hinweg an. Draußen vor dem Fenster schweben rosa Kirschblütenblätter. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du lernst, wie du dein Interesse an jemandem äußerst, nach dessen „Typ“ fragst und grundlegende Komplimente machst. Es wird auch die wichtige Mehrdeutigkeit von 'suki desu' (ich mag dich/ich liebe dich) für Anfänger erklärt."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Das erste Date: Eine Verabredung vorschlagen (Dēto ni Sasou - デートに誘う)",
        "keywords": "Date, Verabredung, ausgehen, Kino, Café, Zeit verbringen, Dēto (デート), Asobi ni iku (遊びに行く), Eiga (映画), Kissa (喫茶), Shokuji (食事)",
        "image_concept": "Ein junger Mann reicht einer überraschten, aber glücklichen jungen Frau nervös zwei Kinokarten. Sie stehen auf einer belebten, farbenfrohen Straße in einer japanischen Stadt, zum Beispiel in Shibuya, mit vielen Lichtern im Hintergrund. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du lernst praktische Sätze, um jemanden um eine Verabredung zu bitten, Aktivitäten vorzuschlagen und eine Einladung anzunehmen oder höflich abzulehnen. Der Unterschied zwischen einem lockeren Treffen ('asobi ni iku') und einem romantischen Date ('dēto') wird beleuchtet."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Das Geständnis: Der Moment der Wahrheit (Kokuhaku - 告白)",
        "keywords": "Liebesgeständnis, zusammen sein, bitte geh mit mir aus, Antwort, Suki desu (好きです), Tsukiatte kudasai (付き合ってください), Henji (返事), Onegai shimasu (お願いします)",
        "image_concept": "Eine Figur gesteht einer anderen unter einem blühenden Kirschbaum bei Sonnenuntergang ihre Liebe. Die bekennende Figur verbeugt sich leicht, sieht ernst und nervös aus. Die andere Figur ist sichtlich überrascht und errötet. Die Atmosphäre ist emotional und bedeutungsvoll. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt die immense kulturelle Bedeutung des 'Kokuhaku' – dem formalen Liebesgeständnis, das in Japan eine Beziehung offiziell beginnt. Du lernst die Schlüsselsätze, um ein Geständnis zu machen und darauf zu antworten."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Offiziell ein Paar: Beziehungsstatus und Kosenamen (Kankei to Yobina - 関係と呼び名)",
        "keywords": "Freund, Freundin, Partner, Paar, verheiratet, Kareshi (彼氏), Kanojo (彼女), Koibito (恋人), Kappuru (カップル), Fūfu (夫婦)",
        "image_concept": "Ein glückliches junges Paar geht Hand in Hand durch einen Park. Sie tragen passende oder farblich aufeinander abgestimmte Kleidung (ein beliebter Trend für Paare in Japan) und lächeln sich an. Die Szene ist hell, fröhlich und sonnig. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier lernst du das Vokabular, um deinen Beziehungsstatus zu beschreiben. Wir behandeln die Begriffe für Freund ('kareshi') und Freundin ('kanojo') und besprechen, wie Partner sich in Japan typischerweise ansprechen (oft mit Vornamen oder Spitznamen anstelle von Kosenamen)."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Tiefe Gefühle: Liebe und Zuneigung ausdrücken (Aijō Hyōgen - 愛情表現)",
        "keywords": "Ich liebe dich, ich mag dich sehr, ich vermisse dich, Komplimente, Umarmung, Aishiteru (愛してる), Daisuki (大好き), Aitai (会いたい), Homeru (褒める), Daku (抱く)",
        "image_concept": "Ein Paar sitzt eng beisammen auf einer Parkbank und blickt auf eine wunderschöne nächtliche Stadtsilhouette. Eine Person lehnt ihren Kopf sanft an die Schulter der anderen. Die Stimmung ist ruhig, intim und romantisch, mit funkelnden Stadtlichtern in der Ferne. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Du lernst, die feinen Unterschiede zwischen 'suki', 'daisuki' und dem sehr ernsten 'aishiteru' zu verstehen. Wir behandeln Ausdrücke, um Sehnsucht und Wertschätzung zu zeigen, und betonen, dass in Japan oft Taten mehr zählen als Worte."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Gemeinsame Zukunft: Meilensteine der Beziehung (Kinenbi to Shōrai - 記念日と将来)",
        "keywords": "Jahrestag, Heiratsantrag, heiraten, zusammenziehen, Eltern vorstellen, Kinenbi (記念日), Puropōzu (プロポーズ), Kekkon suru (結婚する), Dōsei suru (同棲する), Oya ni shōkai suru (親に紹介する)",
        "image_concept": "Ein Mann kniet vor einer Frau und hält ihr eine offene Ringschachtel hin. Die Frau hält sich die Hände vor den Mund, ihre Augen sind voller Freudentränen. Die Szene spielt an einem malerischen Ort, wie einem Strand bei Sonnenuntergang oder vor einem berühmten Tempel. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite vermittelt Vokabular und Sätze für wichtige Meilensteine einer Beziehung. Von der Feier eines Jahrestages über den Heiratsantrag und das Zusammenziehen bis hin zum wichtigen Schritt, den Partner den Eltern vorzustellen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Höhen und Tiefen: Kulturelle Nuancen (Bunkateki Nuansu - 文化的ニュアンス)",
        "keywords": "Streit, sich vertragen, Eifersucht, Abhängigkeit, Vertrauen, Kenka (喧嘩), Nakanaori (仲直り), Yakimochi (焼きもち), Amae (甘え), Shinrai (信頼)",
        "image_concept": "Ein Paar sitzt nach einem Streit mit dem Rücken zueinander auf dem Boden ihres Apartments und schaut traurig. In einer Ecke des Bildes ist eine kleinere, halbtransparente Szene zu sehen, in der eine Figur der anderen als Geste der Versöhnung eine Tasse Tee anbietet. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Hier werden komplexere Beziehungsdynamiken thematisiert. Du lernst Vokabeln für Streit und Versöhnung. Ein besonderer Fokus liegt auf der Erklärung des wichtigen kulturellen Konzepts 'Amae' (eine Form der positiven, gegenseitigen Abhängigkeit) und seiner Rolle in japanischen Beziehungen."
    }
]
