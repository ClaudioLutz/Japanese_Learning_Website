...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Verabschiedungen auf Japanisch: Von 'Sayonara' bis 'Mata ne'\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Verabschiedungen auf Japanisch: Von 'Sayonara' bis 'Mata ne'"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Lerne, dich auf Japanisch stilvoll und situationsgerecht zu verabschieden. Entdecke die Nuancen von alltäglichen Abschieden bis hin zu emotionalen Lebewohls und meistere jede Situation mit dem richtigen Ausdruck."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Das berühmte 'Sayonara' (Sayōnara - さようなら)",
        "keywords": "Sayonara, さようなら, Lebewohl, Auf Nimmerwiedersehen, Missverständnis, Nuance, endgültiger Abschied",
        "image_concept": "Ein trauriger, aber schöner Moment. Zwei Charaktere im Anime-Stil, ein Junge und ein Mädchen, stehen an einem Bahnsteig, während ein Zug abfährt. Einer winkt mit einem leicht wehmütigen Ausdruck zum Abschied. Die Szene ist in warmen Abendfarben gehalten, die Sonne geht unter. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die wahre Bedeutung von 'Sayonara' und warum es im Alltag selten verwendet wird. Lerne, wann dieser Ausdruck angemessen ist und welche Konnotationen er hat (z.B. bei einem endgültigen Abschied oder von Lehrern zu Schülern)."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Alltägliche Verabschiedungen unter Freunden (Mainichi no Aisatsu - 毎日の挨拶)",
        "keywords": "Ja ne, じゃあね, Mata ne, またね, Mata ashita, また明日, informell, Freunde, Familie, tschüss",
        "image_concept": "Eine Gruppe von drei fröhlichen japanischen Teenagern im Schuluniform-Stil, die sich nach der Schule auf einer Straße mit Kirschblütenbäumen trennen. Sie winken sich lächelnd zu und gehen in verschiedene Richtungen. Helle, sonnige Nachmittagsatmosphäre. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne die gebräuchlichsten informellen Verabschiedungen, die du täglich mit Freunden und Familie verwenden kannst. Verstehe die kleinen Unterschiede zwischen 'Ja ne' (Tschüss dann), 'Mata ne' (Bis dann/Wir sehen uns) und 'Mata ashita' (Bis morgen)."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Formelle Verabschiedungen im Beruf (Teinei na Wakare - 丁寧な別れ)",
        "keywords": "Shitsurei shimasu, 失礼します, Otsukaresama desu, お疲れ様です, Höflichkeit, Keigo, Business, formell, Verbeugung",
        "image_concept": "Zwei Personen im Business-Anzug, ein Mann und eine Frau, im Foyer eines modernen, minimalistischen Bürogebäudes. Sie verbeugen sich respektvoll und tief voreinander zum Abschied. Die Umgebung ist professionell und clean, mit großen Fenstern im Hintergrund. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Meistere die formellen Ausdrücke für das Berufsleben und andere höfliche Situationen. Lerne, wie man 'Shitsurei shimasu' beim Verlassen eines Büros oder Meetings und 'Otsukaresama desu/deshita' am Ende eines Arbeitstages verwendet."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Das Haus verlassen und zurückkehren (Ittekimasu & Itterasshai - いってきます＆いってらっしゃい)",
        "keywords": "Ittekimasu, いってきます, Itterasshai, いってらっしゃい, Zuhause, Familie, Ritual, Genkan, tägliche Routine",
        "image_concept": "Eine Szene im Eingangsbereich (Genkan) eines japanischen Hauses. Eine Mutter in Alltagskleidung winkt ihrem kleinen Sohn, der seine Schuhe anzieht und eine Schultasche trägt, zum Abschied. Die Tür steht offen und man sieht einen sonnigen Morgen draußen. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne das einzigartige japanische Ritual des Verabschiedens beim Verlassen des Hauses ('Ittekimasu' - Ich gehe und komme wieder) und die dazugehörige Antwort der Familie ('Itterasshai' - Pass auf dich auf/Bis später)."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Vor den anderen gehen (Osaki ni Shitsurei shimasu - お先に失礼します)",
        "keywords": "Osaki ni shitsurei shimasu, お先に失礼します, Otsukaresama deshita, お疲れ様でした, Büro, Feier, früher gehen, Rücksicht",
        "image_concept": "Eine Büroszene am späten Nachmittag. Eine junge Frau mit ihrer Tasche verbeugt sich leicht vor ihren Kollegen, die noch an ihren Schreibtischen sitzen und ihr freundlich zunicken und winken. Die Atmosphäre ist kollegial und respektvoll. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne die wichtige Floskel 'Osaki ni shitsurei shimasu', um dich höflich zu entschuldigen, wenn du einen Ort (wie das Büro oder eine Feier) vor den anderen verlässt. Lerne auch die typische Antwort darauf: 'Otsukaresama deshita'."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Abschied für längere Zeit (Chōki no Wakare - 長期の別れ)",
        "keywords": "O-genki de, お元気で, Ki o tsukete, 気をつけて, Pass auf dich auf, Mach's gut, Reise, Umzug, emotional",
        "image_concept": "Eine emotionale, aber hoffnungsvolle Szene an einem Flughafen-Gate. Eine junge Frau umarmt einen jungen Mann mit einem Rucksack zum Abschied. Beide haben einen leicht wehmütigen, aber zuversichtlichen Gesichtsausdruck. Durch das große Fenster im Hintergrund sieht man die Tragfläche eines Flugzeugs. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne Ausdrücke für Situationen, in denen du jemanden für eine längere Zeit nicht sehen wirst. Verstehe die herzliche Bedeutung von 'O-genki de' (Bleib gesund/Pass auf dich auf) und 'Ki o tsukete' (Sei vorsichtig/Gute Reise)."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Zusammenfassung: Wann sagt man was? (Mondai & Matome - 問題＆まとめ)",
        "keywords": "Zusammenfassung, Situation, Kontext, Übung, Rollenspiel, Anwendungsbeispiele, Übersicht",
        "image_concept": "Eine geteilte Bildkomposition (Split-Screen). Auf der linken Seite eine informelle Szene: zwei Freunde in Freizeitkleidung in einem Café, die sich lachend zum Abschied winken. Auf der rechten Seite eine formelle Szene: ein Mitarbeiter, der sich vor seinem Chef am Ausgang eines Büros verbeugt. Dies visualisiert den Kontrast. Niedlicher Manga/Anime-Stil mit klaren Linien, kawaii-Ästhetik, hellen Farben und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Wende dein neues Wissen an! Diese Seite bietet eine übersichtliche Tabelle und kleine Szenarien, um zu üben, die richtige Verabschiedungsfloskel für jede Situation auszuwählen – vom schnellen 'Tschüss' unter Freunden bis zum formellen Abschied vom Chef."
    }
]
