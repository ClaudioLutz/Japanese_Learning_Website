...
| **3**  | **Set default project + zone**<br/>`gcloud config set project …` / `set compute/zone …`            | Laptop               | ✅ Done (`jpl-website-bill-20251130`, `europe-west6-c`) ([Google Cloud][1], [Google Cloud][2])       |                     |
