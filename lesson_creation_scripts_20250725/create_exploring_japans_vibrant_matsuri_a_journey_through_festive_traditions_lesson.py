#!/usr/bin/env python3
"""
This script creates a comprehensive Exploring Japan's Vibrant Matsuri: A Journey Through Festive Traditions lesson organized into pages.
...
# --- Configuration ---
LESSON_TITLE = "Exploring Japan's Vibrant Matsuri: A Journey Through Festive Traditions"
LESSON_DIFFICULTY = "Intermediate"
LESSON_DESCRIPTION = "Dive into the colorful world of Japanese festivals, learning essential vocabulary and grammar while uncovering the rich cultural significance behind these vibrant celebrations. From traditional dances to delicious street food, this lesson offers a taste of Japan's unique festive spirit."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Introduction to Matsuri - まつり入門 (Matsuri Nyūmon)",
        "keywords": "matsuri, festival, types, origins, overview",
        "image_concept": "A cheerful montage of various festival elements: a glimpse of a decorated mikoshi, colorful festival lanterns, a fan being used, traditional Japanese sweets on a tray, and fireworks exploding in the night sky. Cute manga/anime art style with clean lines and cultural authenticity. No text.",
        "content_focus": "Introduces the concept of matsuri, different types of festivals, and their historical origins."
    },
    {
        "page_number": 3,
        "title": "Summer Festivals - 夏祭り (Natsu Matsuri)",
        "keywords": "natsu matsuri, summer, fireworks, yukata, bon odori",
        "image_concept": "A young person in a yukata enjoying a summer festival, holding a handheld fan and watching fireworks explode over a cityscape. Cute manga/anime art style with clean lines and cultural authenticity. No text.",
        "content_focus": "Focuses on summer festivals, including Obon, fireworks displays, and the tradition of wearing yukata."
    },
    {
        "page_number": 4,
        "title": "Autumn Festivals - 秋祭り (Aki Matsuri)",
        "keywords": "aki matsuri, autumn, harvest, moon viewing, food stalls",
        "image_concept": "A lively autumn festival scene with various food stalls, people enjoying seasonal treats like dango, and a full moon in the background. Cute manga/anime art style with clean lines and cultural authenticity. No text.",
        "content_focus": "Explores autumn festivals related to harvest celebrations, moon viewing, and the prevalence of food stalls."
    },
    {
        "page_number": 5,
        "title": "Religious Festivals - 神事 (Shinji)",
        "keywords": "shinji, religious, shrine, mikoshi, rituals, purification",
        "image_concept": "A vibrant mikoshi being carried through a crowd, surrounded by people in festive attire, with a majestic shrine gate in the background. Cute manga/anime art style with clean lines and cultural authenticity. No text.",
        "content_focus": "Examines the religious aspects of matsuri, including shrine rituals, mikoshi processions, and purification ceremonies."
    },
    {
        "page_number": 6,
        "title": "Festival Food - 祭り屋台 (Matsuri Yatai)",
        "keywords": "yatai, food stalls, takoyaki, yakisoba, ramune, traditional snacks",
        "image_concept": "An assortment of delicious festival food: takoyaki, yakisoba, cotton candy, and ramune soda, arranged attractively on a table. Cute manga/anime art style with clean lines and cultural authenticity. No text.",
        "content_focus": "Introduces common festival foods and related vocabulary, allowing students to describe and order popular snacks."
    },
    {
        "page_number": 7,
        "title": "Festival Games - 祭りゲーム (Matsuri Gēmu)",
        "keywords": "games, goldfish scooping, target practice, prizes, fun",
        "image_concept": "A child trying to scoop goldfish at a festival stall, with other game stalls and prizes visible in the background. Cute manga/anime art style with clean lines and cultural authenticity. No text.",
        "content_focus": "Explores traditional festival games like goldfish scooping and target practice, using related vocabulary and phrases."
    },
    {
        "page_number": 8,
        "title": "Experiencing a Matsuri - 祭り体験 (Matsuri Taiken)",
        "keywords": "planning, etiquette, conversation, practical tips, participation",
        "image_concept": "A group of friends happily taking a selfie at a festival, surrounded by festive decorations and activities. Cute manga/anime art style with clean lines and cultural authenticity. No text.",
        "content_focus": "Provides practical tips for attending a matsuri, covering etiquette, useful phrases, and planning a visit."
    }
]
...
def create_lesson(app):
    ...
    with app.app_context():
        ...
        overview_image_concept = "Vibrant overview scene representing Exploring Japan's Vibrant Matsuri: A Journey Through Festive Traditions - showing the main themes and cultural elements of this lesson in a harmonious composition. Style: cute manga/anime art style with clean lines and cultural authenticity. IMPORTANT: No text, writing, signs, or characters should be visible in the image."
        ...
        if "error" not in image_result:
            ...
            if file_path:
                ...
                image_content = LessonContent(
                    lesson_id=lesson.id,
                    content_type="image",
                    title="Exploring Japan's Vibrant Matsuri: A Journey Through Festive Traditions - Lesson Overview",
        ...
        intro_topic = f"Comprehensive introduction to {LESSON_TITLE}. Explain what students will learn in this lesson about unique japanese festivals (matsuri), the cultural significance and practical applications. Include learning objectives and how this knowledge will help students understand Japanese culture and daily life better."
        intro_keywords = "matsuri, festival, tradition, culture, Japan, celebration, food, dance, music, shrine, mikoshi, yukata, fireworks, obon, tanabata"
        ...
        if "error" not in intro_result:
            intro_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Welcome to Exploring Japan's Vibrant Matsuri: A Journey Through Festive Traditions",
        ...
        conclusion_topic = "Conclusion for Exploring Japan's Vibrant Matsuri: A Journey Through Festive Traditions lesson. Summarize key learnings from this lesson, their importance in understanding Japanese culture and daily life, and encourage continued practice and application of this knowledge."
        conclusion_keywords = "matsuri, festival, tradition, culture, Japan, celebration, food, dance, music, shrine, mikoshi, yukata, fireworks, obon, tanabata, cultural understanding, conclusion"
        ...
        if "error" not in conclusion_result:
            conclusion_content = LessonContent(
                lesson_id=lesson.id,
                content_type="text",
                title="Exploring Japan's Vibrant Matsuri: A Journey Through Festive Traditions - Lesson Conclusion",
            ...
            if isinstance(options, str):
                try:
                    ...
                    final_quiz_content = LessonContent(
                        lesson_id=lesson.id,
                        content_type="interactive",
                        title="Exploring Japan's Vibrant Matsuri: A Journey Through Festive Traditions - Comprehensive Final Quiz",
                        content_text="Test your overall knowledge of exploring japan's vibrant matsuri: a journey through festive traditions",
                        is_interactive=True,
                        order_index=content_order_index,
                        page_number=final_page_number,
                        generated_by_ai=True
