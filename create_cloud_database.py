#!/usr/bin/env python3
"""
Direct Database Creation Script for Google Cloud PostgreSQL
Bypasses Alembic migration issues by creating exact schema from models
"""
...
class DatabaseCreator:
    ...
    def create_user_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating User table")
    ...
    def create_kana_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating Kana table")
    ...
    def create_kanji_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating Kanji table")
    ...
    def create_vocabulary_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating Vocabulary table")
    ...
    def create_grammar_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating Grammar table")
    ...
    def create_lesson_category_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating LessonCategory table")
    ...
    def create_lesson_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating Lesson table")
    ...
    def create_lesson_prerequisite_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating LessonPrerequisite table")
    ...
    def create_lesson_page_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating LessonPage table")
    ...
    def create_lesson_content_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating LessonContent table")
    ...
    def create_quiz_question_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating QuizQuestion table")
    ...
    def create_quiz_option_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating QuizOption table")
    ...
    def create_user_quiz_answer_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating UserQuizAnswer table")
    ...
    def create_user_lesson_progress_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating UserLessonProgress table")
    ...
    def create_lesson_purchase_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating LessonPurchase table")
    ...
    def create_course_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating Course table")
    ...
    def create_course_lessons_table(self):
        ...
        """
        return self.execute_sql(sql, "Creating course_lessons association table")
    ...
    def create_indexes(self):
        ...
        for sql, description in indexes:
            self.execute_sql(sql, f"Creating {description}")
    ...
    def create_sample_categories(self):
        ...
        for name, description, color in categories:
            ...
            """
            try:
                self.cursor.execute(sql, (name, description, color))
...
def main():
    ...
    print("🚀 Japanese Learning Website - Database Creator")
    print("=" * 50)
    ...
    DB_CONFIG = {
        ...
        'username': 'app_user',
        'password': 'Dg34.67MDt',  # Consider using environment variable
        'port': 5432
    }
    ...
    if success:
        ...
        print("\nNext steps:")
        print("1. Update your Flask app's DATABASE_URL to point to this database")
        print("2. Test your application connection")
        print("3. Import any existing data if needed")
        print("\nAdmin user created:")
