...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Begrüßungen und grundlegende Phrasen im Japanischen\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Begrüßungen und grundlegende Phrasen im Japanischen"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Lerne die wichtigsten japanischen Begrüßungen und Höflichkeitsfloskeln für jede Situation. Von 'Konnichiwa' bis zur korrekten Verbeugung – dieser Kurs macht dich fit für deine ersten Gespräche in Japan."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Begrüßungen je nach Tageszeit (Aisatsu - あいさつ)",
        "keywords": "Ohayou gozaimasu, Konnichiwa, Konbanwa, Morgen, Tag, Abend, Begrüßung, おはようございます, こんにちは, こんばんは",
        "image_concept": "Ein niedlicher Manga-Charakter steht vor einem Fenster. Draußen geht die Sonne auf, was den Morgen symbolisiert. Der Charakter lächelt freundlich und winkt leicht. Stil: niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die drei grundlegenden japanischen Begrüßungen für Morgen, Tag und Abend lernen und verstehen, wann welche Begrüßung angemessen ist. Einführung in die formelle (mit 'gozaimasu') und informelle Form."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Sich vorstellen (Jikoshoukai - 自己紹介)",
        "keywords": "Hajimemashite, Watashi no namae wa... desu, Yoroshiku onegaishimasu, Jikoshoukai, Name, Vorstellung, はじめまして, 私の名前は...です, よろしくお願いします",
        "image_concept": "Zwei Manga-Charaktere, ein europäisch aussehender Junge und ein japanisches Mädchen, treffen sich zum ersten Mal in einem Klassenzimmer. Sie verbeugen sich leicht voreinander und lächeln. Stil: niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Standardphrasen für eine Selbstvorstellung lernen. Die Bedeutung und Anwendung von 'Hajimemashite' (zum ersten Mal treffen) und 'Yoroshiku onegaishimasu' (wörtl. 'bitte seien Sie gut zu mir') verstehen."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Verabschiedungen (Wakare no Aisatsu - 別れのあいさつ)",
        "keywords": "Sayounara, Jaa ne, Mata ashita, Oyasumi nasai, Verabschiedung, Auf Wiedersehen, Gute Nacht, さようなら, じゃあね, また明日, おやすみなさい",
        "image_concept": "Ein Manga-Charakter steht an einem Schultor und winkt seinen Freunden, die weggehen. Die Sonne geht unter und taucht die Szene in warmes, oranges Licht. Stil: niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Verschiedene Arten der Verabschiedung lernen und deren Nuancen verstehen: 'Sayounara' (eher endgültig), 'Jaa ne' (informell), 'Mata ashita' (bis morgen) und 'Oyasumi nasai' (gute Nacht)."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Danke sagen (Kansha - 感謝)",
        "keywords": "Arigatou gozaimasu, Doumo, Arigatou, Dou itashimashite, Danke, Dankbarkeit, Gern geschehen, ありがとうございます, どうも, どういたしまして",
        "image_concept": "Ein Manga-Charakter erhält ein kleines, in Stoff gewickeltes Geschenk (Furoshiki) von einem älteren Charakter und verbeugt sich dankbar. Beide lächeln freundlich. Stil: niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die verschiedenen Stufen der Dankbarkeit ausdrücken, von informell ('Arigatou') bis sehr formell ('Doumo arigatou gozaimasu'). Auch die passende Antwort 'Dou itashimashite' (Gern geschehen) wird gelehrt."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Entschuldigung & Aufmerksamkeit (Shazai & Chuumoku - 謝罪 & 注目)",
        "keywords": "Sumimasen, Gomen nasai, Shitsurei shimasu, Entschuldigung, Verzeihung, Aufmerksamkeit, すみません, ごめんなさい, 失礼します",
        "image_concept": "Ein Manga-Charakter bittet in einem Restaurant einen Kellner um Aufmerksamkeit, indem er die Hand leicht hebt und sich leicht nach vorne beugt. Der Kellner wendet sich ihm freundlich zu. Stil: niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die vielseitige Verwendung von 'Sumimasen' (Entschuldigung, um Aufmerksamkeit zu bitten, als kleines Dankeschön) verstehen. Abgrenzung zu 'Gomen nasai' (persönliche Entschuldigung) und 'Shitsurei shimasu' (formelle Entschuldigung beim Betreten/Verlassen eines Raumes)."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Die Kunst der Verbeugung (Ojigi - お辞儀)",
        "keywords": "Ojigi, Eshaku, Keirei, Saikeirei, Verbeugung, Respekt, Kultur, Höflichkeit, お辞儀, 会釈, 敬礼, 最敬礼",
        "image_concept": "Drei Silhouetten eines Manga-Charakters nebeneinander, die die drei verschiedenen Verbeugungswinkel zeigen (15 Grad, 30 Grad, 45 Grad). Der Hintergrund ist neutral und minimalistisch, um den Fokus auf die Körperhaltung zu legen. Stil: niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Einführung in die kulturelle Bedeutung der Verbeugung. Erlernen der drei Haupttypen: die leichte Verbeugung (Eshaku, 15°), die formelle Verbeugung (Keirei, 30°) und die tiefste Verbeugung (Saikeirei, 45°), inklusive Anwendungsbeispielen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Anwendung in Mini-Dialogen (Kaiwa no Renshuu - 会話の練習)",
        "keywords": "Kaiwa, Renshuu, formell, informell, Dialog, Anwendung, Gespräch, 会話, 練習, 丁寧語, ため口",
        "image_concept": "Eine Split-Screen-Darstellung. Auf der linken Seite unterhalten sich zwei Manga-Freunde lässig in einem Park. Auf der rechten Seite spricht ein Manga-Student formell und mit einer leichten Verbeugung mit seinem Professor in einem Büro. Stil: niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Das Gelernte in kurzen, praktischen Dialogen anwenden. Ein formeller Dialog (z.B. Treffen mit einem Lehrer) und ein informeller Dialog (z.B. Treffen mit einem Freund) werden gegenübergestellt, um die Unterschiede im Sprachgebrauch zu verdeutlichen."
    }
]
