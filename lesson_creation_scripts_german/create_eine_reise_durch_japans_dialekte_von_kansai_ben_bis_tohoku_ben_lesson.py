...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Eine Reise durch Japans Dialekte: Von Kansai-ben bis Tohoku-ben\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Eine Reise durch Japans Dialekte: Von Kansai-ben bis Tohoku-ben"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Entdecke die faszinierende sprachliche Vielfalt Japans jenseits des Standard-Tokioter-Dialekts. Diese Lektion führt dich in berühmte Regionaldialekte wie den energiegeladenen Kansai-ben und den charmanten Hakata-ben ein und zeigt dir, wie Sprache die lokale Identität prägt."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Was ist ein Dialekt? (Hōgen to wa?・方言とは？)",
        "keywords": "Hogen, 方言, Hyojungo, 標準語, Standardjapanisch, gemeinsame Sprache, Kyotsugo, 共通語, Dialektkarte, regionale Vielfalt",
        "image_concept": "Eine stilisierte, niedliche Karte von Japan im Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. Die Hauptinseln sind klar erkennbar. Die Regionen Kanto, Kansai, Kyushu und Tohoku sind in unterschiedlichen, sanften Farben hervorgehoben. Kleine, symbolische Icons (z.B. der Tokyo Tower für Kanto, das Osaka-Schloss für Kansai) sind in den Regionen platziert. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Einführung in die Konzepte von 'Hogen' (Dialekt) und 'Hyojungo' (Standardjapanisch). Die Schüler lernen, warum es eine Standardsprache gibt und wie sich die Dialekte über die Regionen Japans verteilen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Der Kansai-Dialekt (Kansai-ben・関西弁)",
        "keywords": "Kansai-ben, 関西弁, Osaka, Kyoto, Ookini, おおきに, Nande ya nen, なんでやねん, Akan, あかん, typische Ausdrücke",
        "image_concept": "Ein fröhlicher, energiegeladener männlicher Charakter im niedlichen Manga/Anime-Stil, der typisch für Osaka sein könnte (z.B. mit einem Takoyaki-Stand im Hintergrund). Er lacht herzlich und macht eine offene, einladende Geste. Die Szene ist lebhaft und farbenfroh. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Vorstellung des bekanntesten Dialekts, Kansai-ben. Die Schüler lernen erste typische Vokabeln und Ausdrücke wie 'ookini' (danke) und 'akan' (nicht gut/unmöglich) und verstehen den Klang und die Energie dieses Dialekts."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Grammatik des Kansai-ben (Kansai-ben no Bunpō・関西弁の文法)",
        "keywords": "ya, や, da, だ, hen, へん, nai, ない, Verneinung, Kopula, Grammatikunterschiede",
        "image_concept": "Zwei Anime-Charaktere, ein Junge und ein Mädchen, im niedlichen Manga/Anime-Stil stehen sich gegenüber. Der Junge (aus Tokio) sieht verwirrt aus und kratzt sich am Kopf. Das Mädchen (aus Kansai) spricht mit ausdrucksstarker Gestik und einem selbstbewussten Lächeln. Die Szene spielt in einem Schulkorridor. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Vertiefung in die Grammatik des Kansai-ben. Der Fokus liegt auf zwei zentralen Unterschieden zur Standardsprache: die Kopula 'ya' anstelle von 'da' und die Verneinungsform '-hen' anstelle von '-nai'."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Der Hakata-Dialekt (Hakata-ben・博多弁)",
        "keywords": "Hakata-ben, 博多弁, Fukuoka, Kyushu, ~to?, ～と？, ~ken, ～けん, Yatai, Essensstand, charmant",
        "image_concept": "Eine freundliche junge Frau im niedlichen Manga/Anime-Stil sitzt an einem 'Yatai' (mobiler Essensstand) in einer nächtlichen Szene. Vor ihr steht eine dampfende Schüssel Hakata-Ramen. Sie schaut den Betrachter freundlich an, als ob sie eine Frage stellt. Die Lichter der Stadt sind im Hintergrund verschwommen. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Einführung in den Hakata-ben aus Fukuoka (Kyushu). Die Schüler lernen die charakteristischen Satzendungen kennen, insbesondere die fragende Form '-to?' und die begründende Form '-ken', die dem Dialekt seinen besonderen Charme verleihen."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Der Tohoku-Dialekt (Tōhoku-ben・東北弁)",
        "keywords": "Tohoku-ben, 東北弁, Zūzū-ben, ずうずう弁, Nordjapan, Aussprache, Vokale, ländlich, Akita, Aomori",
        "image_concept": "Ein älterer, gutmütiger Mann im niedlichen Manga/Anime-Stil, gekleidet in traditioneller Arbeitskleidung (z.B. für die Landwirtschaft), steht auf einem Reisfeld vor einer malerischen, ländlichen Kulisse mit Bergen in der Ferne. Es könnte leicht verschneit sein, um die nördliche Region anzudeuten. Er hat ein warmes, freundliches Lächeln. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Ein Blick auf den Tohoku-ben aus dem Norden Japans. Die Schüler lernen dessen Ruf als 'schwer verständlich' (Zūzū-ben) und einige seiner phonetischen Besonderheiten kennen, wie die Tendenz, bestimmte Vokale zusammenzuziehen."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Dialekte im Vergleich (Hōgen no Hikaku・方言の比較)",
        "keywords": "Vergleich, Gegenüberstellung, Standard, Kansai, Hakata, Tohoku, alltägliche Sätze, Kommunikation, Missverständnis",
        "image_concept": "Eine humorvolle Szene mit vier Charakteren im niedlichen Manga/Anime-Stil. Ein Charakter (der Tokyo-Tourist) hält eine Karte und sieht völlig verwirrt aus. Um ihn herum stehen die drei regionalen Charaktere aus den vorherigen Bildern (Kansai, Hakata, Tohoku), die alle gleichzeitig auf ihn einreden und wild gestikulieren. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Eine vergleichende Übersicht. Die Schüler sehen einfache Sätze wie 'Was machst du?' oder 'Ich weiß nicht' in Standardjapanisch und den drei vorgestellten Dialekten nebeneinander, um die Unterschiede direkt zu erkennen."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Dialekte im modernen Japan (Gendai Nihon no Hōgen・現代日本の⽅⾔)",
        "keywords": "Moderne, Popkultur, Anime, Manga, Manzai, Komödie, regionale Identität, Stolz, Vielfalt",
        "image_concept": "Eine Gruppe von fünf verschiedenen, modernen jungen Leuten im niedlichen Manga/Anime-Stil unterhält sich fröhlich in einem Park in einer japanischen Stadt. Sie tragen unterschiedliche modische Kleidung, die ihre individuellen Persönlichkeiten widerspiegelt. Die Gruppe ist divers und repräsentiert die Einheit in der Vielfalt des modernen Japan. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Abschluss und kultureller Kontext. Die Schüler diskutieren die Rolle von Dialekten im heutigen Japan – von ihrer Verwendung in Anime und Manzai-Komödie bis hin zu ihrer Bedeutung als Ausdruck von lokalem Stolz und Identität."
    }
]
