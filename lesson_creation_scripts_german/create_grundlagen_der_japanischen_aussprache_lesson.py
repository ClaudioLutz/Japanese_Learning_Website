...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Grundlagen der japanischen Aussprache\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Grundlagen der japanischen Aussprache"
LESSON_DIFFICULTY = "Anfänger"
LESSON_DESCRIPTION = "Tauche ein in die Welt der japanischen Laute! Diese Lektion führt dich durch Hiragana, Katakana und die Feinheiten der Aussprache, mit speziellem Fokus auf typischen Stolpersteinen für Deutschsprachige, um eine authentische und klare Betonung zu entwickeln."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Die fünf Grundvokale (Goin - 母音)",
        "keywords": "Vokale, a, i, u, e, o, Goin, 母音, Aussprache, Mundform, ungerundetes U",
        "image_concept": "Eine freundliche Manga-Lehrerin im Kimono zeigt auf eine stilisierte Darstellung der fünf korrekten Mundformen für die Vokale a, i, u, e, o. Der Hintergrund ist ein ruhiger japanischer Garten. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne die fünf reinen und kurzen japanischen Vokale (a, i, u, e, o). Der Fokus liegt auf der korrekten Mundform und dem Unterschied zu deutschen Vokalen, insbesondere dem ungerundeten 'u'-Laut."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die Silbentafel: Gojūon (Gojūon - 五十音)",
        "keywords": "Hiragana, ひらがな, Gojūon, 五十音, Silben, Konsonanten, k-Reihe, s-Reihe, t-Reihe, n-Reihe",
        "image_concept": "Zwei japanische Schüler in Schuluniform, ein Junge und ein Mädchen, sitzen auf Tatami-Matten und üben Shodō (Kalligraphie) mit Pinsel und Tusche. Der Fokus liegt auf der konzentrierten Lernatmosphäre. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Einführung in das Konzept der japanischen Silbenschrift anhand der Hiragana-Grundtafel Gojūon. Du lernst die Struktur von Konsonant-Vokal-Kombinationen (z.B. ka, ki, ku, ke, ko) und übst die Aussprache der ersten Reihen."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Stimmhafte & P-Laute (Dakuon & Handakuon - 濁音・半濁音)",
        "keywords": "Dakuon, 濁音, Handakuon, 半濁音, Tenten, Maru, Stimmhaftigkeit, ga, za, da, ba, pa",
        "image_concept": "Eine Nahaufnahme einer traditionellen japanischen Taiko-Trommel. Eine Hand mit einem Trommelstock ist kurz davor, die Trommel zu schlagen, was die Kraft und Stimmhaftigkeit der Dakuon-Laute symbolisiert. Im Hintergrund ist eine unscharfe Festivalszene angedeutet. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Lerne, wie kleine Markierungen – Tenten (゛) und Maru (゜) – die Aussprache von Silben verändern. Wir üben den Unterschied zwischen stimmlosen (k, s, t, h) und stimmhaften Lauten (g, z, d, b) sowie den P-Lauten."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Deutsche Stolpersteine I: R, F/H und N (Nigate na Oto I - 苦手な音 I)",
        "keywords": "R-Laut, らりるれろ, F-Laut, ふ, H-Laut, はひふへほ, N-Laut, ん, Aussprachetraining",
        "image_concept": "Ein Manga-Charakter mit leicht aufgeblähten Wangen pustet sanft eine Kerzenflamme auf einem Geburtstagskuchen aus. Dies illustriert die korrekte Mundbewegung für den Laut 'fu'. Die Szene ist fröhlich und spielt in einem gemütlichen Zimmer. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite widmet sich den für Deutschsprachige schwierigsten Lauten: dem japanischen 'r' (eine Mischung aus r, l, d), dem 'fu'-Laut (wie beim Auspusten einer Kerze) und dem finalen 'n' (ん), das je nach Kontext anders klingt."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Deutsche Stolpersteine II: Langvokale & Doppelkonsonanten (Nigate na Oto II - 苦手な音 II)",
        "keywords": "Langvokale, Chōon, 長音, Doppelkonsonanten, Sokuon, 促音, kleines tsu, っ, Wortbedeutung",
        "image_concept": "Ein Manga-Mädchen in traditioneller Kleidung steht neben ihrer freundlichen Großmutter. Das Mädchen (*obasan* - Tante) ist jung, die Großmutter (*obāsan*) ist sichtlich älter. Sie lächeln sich an und verdeutlichen so den Bedeutungsunterschied durch Vokallänge. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Verstehe den kritischen Unterschied zwischen kurzen und langen Vokalen (z.B. Yuki 'Schnee' vs. Yūki 'Mut'). Lerne außerdem, wie das kleine 'tsu' (っ) einen Konsonanten verdoppelt und eine kurze Sprechpause erzeugt, was die Bedeutung von Wörtern fundamental ändert."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Katakana und Lehnwörter (Katakana & Gairaigo - カタカナ・外来語)",
        "keywords": "Katakana, カタカナ, Gairaigo, 外来語, Lehnwörter, Ausspracheanpassung, Computer, Bier, Deutschland",
        "image_concept": "Ein junger Japaner sitzt in einem modernen, hellen Café in Tokio. Er arbeitet an einem Laptop und trinkt einen Kaffee. Dies visualisiert den Kontext von Lehnwörtern (Laptop, Kaffee) im modernen japanischen Alltag. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Anwendung der gelernten Ausspracheregeln auf Katakana, die Schrift für Fremdwörter. Du lernst, wie deutsche und englische Wörter an das japanische Lautsystem angepasst werden (z.B. 'Bier' wird zu ビール 'bīru')."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Der Tonhöhenakzent (Pichi Akusento - ピッチアクセント)",
        "keywords": "Tonhöhenakzent, Pitch Accent, ピッチアクセント, Heiban, Odaka, Wortpaare, hashi, ame",
        "image_concept": "Eine stilisierte Landschaft zeigt nebeneinander: Essstäbchen, die auf einer Reisschale liegen (tiefe-hohe Tonhöhe) und eine elegante rote Brücke, die über einen Fluss führt (hohe-tiefe Tonhöhe). Dies visualisiert, wie dasselbe Wort 'hashi' je nach Tonhöhe unterschiedliche Dinge bedeutet. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Eine Einführung in den japanischen Tonhöhenakzent, der sich vom deutschen Betonungsakzent unterscheidet. Anhand einfacher Beispiele (z.B. hashi 'Brücke' vs. hashi 'Essstäbchen') lernst du, wie die Tonhöhe die Wortbedeutung beeinflussen kann."
    }
]
