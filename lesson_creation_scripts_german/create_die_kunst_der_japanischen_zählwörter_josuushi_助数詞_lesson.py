...
LESSON_DESCRIPTION = "Meistere die faszinierende Welt der japanischen Zählwörter! Lerne, wie man verschiedene Objekte, Menschen und Tiere korrekt zählt und verleihe deinem Japanisch mehr Natürlichkeit und Präzision."
...
CONTENT_PAGES = [
    {
        ...
        "keywords": "Josuushi, Zählwörter, Einführung, japanische Grammatik, Zählsystem, 数え方 (kazoekata)",
        "image_concept": "Eine freundliche japanische Lehrerin (Sensei) im Manga-Stil steht vor einer leeren Tafel, auf der statt Text verschiedene Icons abgebildet sind: ein Apfel, ein Mensch, ein Buch, ein Stift, ein Auto. Sie zeigt mit einem Zeigestab auf die Icons, um das Konzept der Kategorisierung zu verdeutlichen. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erklärung des Konzepts der Zählwörter (Josuushi) und warum sie im Japanischen unerlässlich sind. Die Grundstruktur 'Zahl + Zähleinheitswort' wird vorgestellt und ihre Bedeutung für die natürliche Sprache hervorgehoben."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Der Universalzähler (Hitotsu, Futatsu... - 一つ、二つ...)",
        "keywords": "つ (tsu), Universalzähler, Hitotsu, Futatsu, Zählen von 1 bis 10, allgemeine Objekte, japanische Zahlen",
        "image_concept": "Eine Theke in einem japanischen Laden. Ein Kunde (europäischer Austauschstudent im Anime-Stil) zeigt auf verschiedene Gegenstände: einen Apfel (symbolisiert 'hitotsu'), zwei Onigiri (symbolisiert 'futatsu') und drei Mochi-Bällchen (symbolisiert 'mittsu'). Der Verkäufer lächelt freundlich. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erlernen der Zählweise mit 〜つ (tsu) für die Zahlen 1 bis 10. Dies ist ein nativer japanischer Zählstil, der für allgemeine Objekte verwendet wird, besonders wenn man das spezifische Zähleinheitswort nicht kennt."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Menschen zählen (Hitori, Futari, Sannin... - 一人、二人、三人...)",
        "keywords": "人 (nin), 人 (ri), Hitori, Futari, Menschen zählen, Familie, Freunde, Ausnahmen",
        "image_concept": "Eine Gruppe von Freunden im Manga-Stil unter einem Kirschblütenbaum. Eine Person steht etwas abseits (symbolisiert 'hitori'), ein Paar sitzt zusammen auf einer Decke (symbolisiert 'futari'), und eine Dreiergruppe lacht im Hintergrund (symbolisiert 'sannin'). Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Wie man Personen mit dem Zähleinheitswort 〜人 (nin) zählt. Besonderes Augenmerk auf die wichtigen und häufigen Ausnahmen für eine Person (一人, hitori) und zwei Personen (二人, futari)."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Die drei großen Objekt-Zähler (Hon, Mai, Ko - 本、枚、個)",
        "keywords": "本 (hon), 枚 (mai), 個 (ko), lange Objekte, flache Objekte, kleine Objekte, Kategorisierung",
        "image_concept": "Ein ordentlicher Schreibtisch aus der Vogelperspektive. Darauf liegen klar getrennt: eine Gruppe von drei Stiften (本), eine Gruppe von fünf Blättern Papier (枚) und eine Gruppe von zwei Radiergummis (個). Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Einführung in die drei häufigsten Zählwörter für Objekte: 本 (hon) für lange, zylindrische Dinge (Stifte, Flaschen), 枚 (mai) für flache, dünne Dinge (Papier, Teller) und 個 (ko) für kleine, kompakte Dinge (Äpfel, Radiergummis)."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Achtung, Lautwandel! (On'in Henka - 音韻変化)",
        "keywords": "Rendaku, Lautwandel, ippon, sanbon, roppon, happon, Aussprache, 匹 (hiki, piki, biki)",
        "image_concept": "Eine Nahaufnahme von einer Hand, die eine einzelne Glasflasche japanischer Limonade hält (symbolisiert 'ippon'). Im Hintergrund stehen weitere Flaschen auf einem Regal, mit deutlichem Abstand, um die Zahlen 3 (sanbon) und 6 (roppon) zu visualisieren, ohne Zahlen zu schreiben. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erklärung des Phänomens des Lautwandels (Rendaku/On'in Henka), bei dem sich der Anfangslaut eines Zählers je nach vorangehender Zahl ändert. Detaillierte Beispiele mit 本 (hon -> pon/bon) und 匹 (hiki -> piki/biki)."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Tiere, Technik und bedruckte Seiten (Hiki, Dai, Satsu - 匹、台、冊)",
        "keywords": "匹 (hiki), 頭 (tō), 台 (dai), 冊 (satsu), kleine Tiere, große Tiere, Autos, Maschinen, Bücher, Magazine",
        "image_concept": "Eine Szene, die verschiedene Kategorien zeigt. Links schläft eine Katze (一匹, ippiki). In der Mitte, auf einer Straße im Hintergrund, steht ein kleines Auto (一台, ichidai). Rechts, auf einem Tisch im Vordergrund, liegt ein Stapel von drei Büchern (三冊, sansatsu). Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erweiterung des Vokabulars mit spezifischeren Zählwörtern: 匹 (hiki) für kleine Tiere (Katzen, Hunde), 頭 (tō) für große Tiere (Pferde, Elefanten), 台 (dai) für Maschinen und Fahrzeuge und 冊 (satsu) für gebundene Druckerzeugnisse wie Bücher und Hefte."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Fragen stellen: Wie viele? (Ikutsu? Nan-nin? - いくつ？何人？)",
        "keywords": "Fragewörter, いくつ (ikutsu), 何 (nan/nani), 何人 (nannin), 何本 (nanbon), 何枚 (nanmai), Konversation",
        "image_concept": "Eine Szene in einem japanischen Café. Ein deutscher Tourist im Anime-Stil zeigt auf eine Vitrine mit verschiedenen Kuchenstücken und fragt die japanische Bedienung etwas. Über dem Kopf des Touristen ist eine Denkblase mit einem großen Fragezeichen und Icons von Kuchen. Über dem Kopf der Bedienung ist eine Denkblase mit drei Fingern, die die Zahl drei anzeigen. Niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Erlernen der richtigen Fragewörter, um nach der Anzahl zu fragen. Kombination von 何 (nan) mit den gelernten Zählwörtern (z.B. 何人, 何本) und die Verwendung von いくつ (ikutsu) als allgemeines Fragewort für das 'tsu'-System."
    }
]
