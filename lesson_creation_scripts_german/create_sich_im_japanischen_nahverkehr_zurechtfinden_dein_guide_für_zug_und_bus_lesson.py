...
# -*- coding: utf-8 -*-
"""
This script creates a comprehensive Japanese lesson titled \"Sich im japanischen Nahverkehr zurechtfinden: Dein Guide für Zug und Bus\" for German-speaking learners.
"""
import os
import sys
import json
...
# --- Configuration ---
LESSON_TITLE = "Sich im japanischen Nahverkehr zurechtfinden: Dein Guide für Zug und Bus"
LESSON_DIFFICULTY = "Mittelstufe"
LESSON_DESCRIPTION = "Lerne, wie du in Japan souverän mit Zügen und Bussen fährst. Diese Lektion zeigt dir, wie du Fahrkarten kaufst, nach dem richtigen Gleis fragst und wichtige Durchsagen verstehst, um deine Reise stressfrei zu gestalten."

# Lesson content pages configuration (explanation pages only)
CONTENT_PAGES = [
    {
        "page_number": 2,
        "title": "Seite 1 - Grundlagen: Wichtige Verkehrsmittel und Vokabeln (Kiso: Jūyō na Kōtsūkikan to Tango)",
        "keywords": "Zug, 電車, densha, Bus, バス, basu, U-Bahn, 地下鉄, chikatetsu, Bahnhof, 駅, eki, Haltestelle, バス停, basutei, Verkehrsmittel, 交通機関, kōtsūkikan",
        "image_concept": "Ein freundlicher ausländischer Tourist, ein junger Mann mit Rucksack, steht vor einer großen, stilisierten und vereinfachten Karte eines städtischen Verkehrsnetzes. Auf der Karte sind farbige Linien für Züge und U-Bahnen sowie Symbole für Busse zu sehen, die verschiedene Stadtteile verbinden. Der Stil ist ein niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen die wichtigsten Begriffe für die gängigsten öffentlichen Verkehrsmittel in Japan sowie die Bezeichnungen für Bahnhöfe und Haltestellen. Dies bildet die Grundlage für alle weiteren Lektionen."
    },
    {
        "page_number": 3,
        "title": "Seite 2 - Die IC-Karte: Dein digitaler Schlüssel (IC Kādo: Anata no Dejitaru na Kagi)",
        "keywords": "IC-Karte, ICカード, aishii kādo, aufladen, チャージする, chāji suru, Guthaben, 残高, zandaka, Suica, Pasmo, Fahrkartenschranke, 改札口, kaisatsuguchi",
        "image_concept": "Eine Nahaufnahme der Hand einer Person, die eine generische IC-Karte (mit einem niedlichen Maskottchen, z.B. einem Vogel oder Bären) an den leuchtenden Sensor einer Fahrkartenschranke hält. Die Schranke ist gerade dabei, sich zu öffnen. Die Szene ist hell und modern. Der Stil ist ein niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite erklärt die Funktionsweise der wiederaufladbaren IC-Karten wie Suica oder Pasmo. Die Lernenden erfahren, wie man eine solche Karte erwirbt, Guthaben auflädt (chāji suru) und sie an den Fahrkartenschranken benutzt."
    },
    {
        "page_number": 4,
        "title": "Seite 3 - Fahrkarten am Automaten kaufen (Kenbaiki de Kippu o Kau)",
        "keywords": "Fahrkartenautomat, 券売機, kenbaiki, Fahrkarte, 切符, kippu, Fahrpreis, 運賃, unchin, Bargeld, 現金, genkin, Zielbahnhof, 目的地, mokutekichi",
        "image_concept": "Ein Lernender steht etwas ratlos, aber neugierig vor einem japanischen Fahrkartenautomaten. Neben ihm steht ein freundlicher Bahnhofsmitarbeiter in Uniform und zeigt mit einem Lächeln auf die große Tariftafel über den Automaten, die nur aus farbigen Linien und Punkten besteht. Der Stil ist ein niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Anleitung zum Kauf einer Einzelfahrkarte an einem japanischen Fahrkartenautomaten. Die Lernenden üben die notwendigen Schritte und Vokabeln, um den richtigen Fahrpreis auf der Tariftafel zu finden und die Fahrkarte zu kaufen."
    },
    {
        "page_number": 5,
        "title": "Seite 4 - Orientierung am Bahnhof: Das richtige Gleis finden (Eki de no Hōkō: Tadashii Bansen o Mitsukeru)",
        "keywords": "Gleis, 番線, bansen, Bahnsteig, ホーム, hōmu, Richtung, 方面, hōmen, Eingang, 入口, iriguchi, Ausgang, 出口, deguchi, Zugtyp, 種別, shubetsu",
        "image_concept": "Zwei Freunde stehen auf einem belebten, aber sauberen japanischen Bahnsteig. Ein Zug fährt gerade ein. Einer der Freunde zeigt auf den ankommenden Zug, während der andere ihm mit einem erleichterten und verständnisvollen Gesichtsausdruck zunickt. Der Stil ist ein niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Studierenden lernen, sich in einem japanischen Bahnhof zurechtzufinden. Es werden Sätze geübt, um nach dem richtigen Gleis zu fragen (z.B. „Yamanote-sen wa nan-ban-sen desu ka?“) und die Bedeutung von Zugtypen wie Lokal-, Eil- und Expresszug erklärt."
    },
    {
        "page_number": 6,
        "title": "Seite 5 - Etikette in Zug und Bus (Densha to Basu no Manā)",
        "keywords": "Manieren, マナー, manā, Vorzugssitz, 優先席, yūsen-seki, Ruhe, 静かに, shizuka ni, anstehen, 並ぶ, narabu, telefonieren, 電話する, denwa suru",
        "image_concept": "Das Innere eines hellen, sauberen Zugabteils. Mehrere Passagiere sitzen ruhig da. Ein junger Mann bietet einer älteren Dame seinen Platz an, die sich mit einem Lächeln bedankt. Eine andere Person liest ein Buch, eine weitere schaut aus dem Fenster. Die Atmosphäre ist friedlich und respektvoll. Der Stil ist ein niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Diese Seite behandelt die wichtigen kulturellen Verhaltensregeln im öffentlichen Nahverkehr. Themen sind das geordnete Anstehen am Bahnsteig, das Stummschalten des Handys, die Vermeidung lauter Gespräche und die Funktion der Vorzugssitze (yūsen-seki)."
    },
    {
        "page_number": 7,
        "title": "Seite 6 - Wichtige Durchsagen verstehen (Anaunsu o Rikai Suru)",
        "keywords": "Durchsage, アナウンス, anaunsu, Nächster Halt, 次は, tsugi wa, Tür, ドア, doa, schließt, 閉まります, shimarimasu, Achtung, ご注意ください, go-chūi kudasai, dieser Zug, この電車, kono densha",
        "image_concept": "Eine Passagierin sitzt am Fenster eines Zuges und lauscht konzentriert. Sie hat eine Hand leicht ans Ohr gelegt, ihr Blick ist nach oben in Richtung der (sichtbaren) Innenlautsprecher des Zuges gerichtet. Draußen zieht eine unscharfe städtische Landschaft vorbei. Der Stil ist ein niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "Die Lernenden trainieren ihr Hörverständnis, indem sie Schlüsselphrasen aus typischen Durchsagen in Zügen und Bahnhöfen kennenlernen. Dies hilft, Haltestellen nicht zu verpassen und auf wichtige Hinweise wie sich schließende Türen zu achten."
    },
    {
        "page_number": 8,
        "title": "Seite 7 - Nach dem Weg fragen: Das Gelernte anwenden (Michi o Tazuneru: Naratta Koto o Tsukau)",
        "keywords": "Entschuldigung, すみません, sumimasen, Wo ist...?, 〜はどこですか, wa doko desu ka, geradeaus, まっすぐ, massugu, rechts, 右, migi, links, 左, hidari, danke, ありがとうございます, arigatō gozaimasu",
        "image_concept": "Ein Tourist fragt eine einheimische Person auf einer belebten Straße nach dem Weg. Der Tourist verbeugt sich leicht, während er spricht. Die angesprochene Person lächelt freundlich und zeigt mit der Hand in eine Richtung. Im Hintergrund ist der stilisierte Eingang einer U-Bahn-Station zu erkennen. Der Stil ist ein niedlicher Manga/Anime-Stil mit klaren Linien und kultureller Authentizität. WICHTIG: Kein Text, keine Schrift, keine Schilder oder Zeichen sollten im Bild sichtbar sein.",
        "content_focus": "In dieser abschließenden Lektion wird alles Gelernte in einer Konversationsübung zusammengefügt. Die Studierenden üben einen kompletten Dialog, in dem sie eine Person auf der Straße höflich ansprechen, nach dem Weg zum nächsten Bahnhof fragen und die erhaltene Wegbeschreibung verstehen."
    }
]
